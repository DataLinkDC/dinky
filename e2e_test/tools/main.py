...
if __name__ == '__main__':
    ...
    flink_jat_sql_task_path = "dinky_task/flink_jar_sql"
    for file_name in traverse_files(flink_jat_sql_task_path):
        sql = open(os.path.join(flink_jat_sql_task_path, file_name)).read()
        task_name = file_name.split(".")[0]
