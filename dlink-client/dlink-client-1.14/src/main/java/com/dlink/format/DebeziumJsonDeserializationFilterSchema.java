...
import com.dlink.format.DebeziumJsonDecodingFilterFormat.ReadableMetadata;
 ...
 */
@Internal
public final class DebeziumJsonDeserializationFilterSchema implements DeserializationSchema<RowData> {
    ...
    public DebeziumJsonDeserializationFilterSchema(
    ...
    public void deserialize(byte[] message, Collector<RowData> out) throws IOException {
        ...
        try {
            ...
            System.out.println(tablePattern
                    .matcher(jsonDeserializer.deserializeToJsonNode(message).get("source").get("table").asText())
                    .matches());
            if(database != null) {
                if (!databasePattern
                        .matcher(jsonDeserializer.deserializeToJsonNode(message).get("source").get("db").asText())
                        .matches()) {
                    return;
                }
            }
    ...
    public boolean equals(Object o) {
        ...
        DebeziumJsonDeserializationFilterSchema that = (DebeziumJsonDeserializationFilterSchema) o;
