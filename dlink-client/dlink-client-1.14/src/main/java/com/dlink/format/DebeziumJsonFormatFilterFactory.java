...
import static com.dlink.format.DebeziumJsonFormatFilterOptions.DATABASE_INCLUDE;
import static com.dlink.format.DebeziumJsonFormatFilterOptions.TABLE_INCLUDE;
import static org.apache.flink.formats.json.JsonFormatOptions.ENCODE_DECIMAL_AS_PLAIN_NUMBER;
import static org.apache.flink.formats.json.debezium.DebeziumJsonFormatOptions.*;
 ...
 */
@Internal
public class DebeziumJsonFormatFilterFactory
        implements DeserializationFormatFactory, SerializationFormatFactory {

    public static final String IDENTIFIER = "debezium-json-filter";
    ...
    public DecodingFormat<DeserializationSchema<RowData>> createDecodingFormat(
        ...
        return new DebeziumJsonDecodingFilterFormat(schemaInclude, database, table, ignoreParseErrors, timestampFormat);
    }
    ...
    public EncodingFormat<SerializationSchema<RowData>> createEncodingFormat(
        ...
        return new EncodingFormat<SerializationSchema<RowData>>() {
            ...
            public SerializationSchema<RowData> createRuntimeEncoder(
                ...
                return new DebeziumJsonSerializationFilterSchema(
                        rowType,
                        timestampFormat,
                        mapNullKeyMode,
                        mapNullKeyLiteral,
