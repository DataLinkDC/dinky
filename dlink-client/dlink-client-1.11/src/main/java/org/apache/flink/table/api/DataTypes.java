...
public final class DataTypes {
    ...
    public static final class Resolution {
        ...
        private static final Map<List<IntervalUnit>, BiFunction<Integer, Integer, LogicalType>> resolutionMapping =
                new HashMap<>();
