...
public class FlinkKubeClientFactory {
    ...
    public static FlinkKubeClient fromConfiguration(Configuration flinkConfig, String useCase) {
        ...
        return new Fabric8FlinkKubeClient(
                flinkConfig, client, FlinkKubeClientFactory::createThreadPoolForAsyncIO);
    }
