...
public class JobConfig {
    ...
    public void buildGatewayConfig(Map<String, Object> config) {
        ...
        if (config.containsKey("userJarPath") && Asserts.isNotNull(config.get("userJarPath"))) {
            appConfig.setUserJarPath(config.get("userJarPath").toString());
            if (config.containsKey("userJarMainAppClass") && Asserts.isNotNull(config.get("userJarMainAppClass"))) {
                appConfig.setUserJarMainAppClass(config.get("userJarMainAppClass").toString());
            }
            if (config.containsKey("userJarParas") && Asserts.isNotNull(config.get("userJarParas"))) {
                appConfig.setUserJarParas(config.get("userJarParas").toString().split(" "));
            }
            gatewayConfig.setAppConfig(appConfig);
        }
        if (config.containsKey("flinkConfig") && Asserts.isNotNull(config.get("flinkConfig"))) {
