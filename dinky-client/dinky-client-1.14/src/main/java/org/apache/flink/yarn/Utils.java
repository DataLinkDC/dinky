...
public final class Utils {
    ...
    public static void setTokensFor(
            ContainerLaunchContext amContainer, List<Path> paths, Configuration conf, boolean obtainingDelegationTokens)
            throws IOException {
        ...
        if (UserGroupInformation.isSecurityEnabled()) {
            ...
            try {
                ...
                try {
                    ...
                    token = (Token<?>) Class.forName("org.apache.hadoop.hbase.security.token.TokenUtil")
                    ...
                    Closeable connectionFactory =
                            (Closeable) Class.forName("org.apache.hadoop.hbase.client.ConnectionFactory")
    ...
    public static void addToEnvironment(Map<String, String> environment, String variable, String value) {
        ...
        if (val == null) {
            ...
            val = val + YarnClusterDescriptor.pathSeparator + value;
        }
    ...
    public static List<Path> getQualifiedRemoteSharedPaths(
        ...
        return getRemoteSharedPaths(configuration, pathStr -> {
