    ...
    private ApplicationReport startAppMaster(
        ...
        if (userJarInclusion == YarnConfigOptions.UserJarInclusion.FIRST) {
            for (String userClassPath : userClassPaths) {
                classPathBuilder.append(userClassPath).append(PATH_SEPARATOR);
            }
        }
        for (String classPath : systemClassPaths) {
            classPathBuilder.append(classPath).append(PATH_SEPARATOR);
        }

        // Setup jar for ApplicationMaster
        final YarnLocalResourceDescriptor localResourceDescFlinkJar = fileUploader.uploadFlinkDist(flinkJarPath);
        classPathBuilder.append(localResourceDescFlinkJar.getResourceKey()).append(PATH_SEPARATOR);
        ...
        if (jobGraph != null) {
            ...
            try {
                ...
                classPathBuilder.append(jobGraphFilename).append(PATH_SEPARATOR);
            } catch (Exception e) {
        ...
        try {
            ...
            fileUploader.registerSingleLocalResource(
                    ...
                    true,
                    true);
            classPathBuilder.append(flinkConfigFileName).append(PATH_SEPARATOR);
        } finally {
