 ...
 */
public class CreateAggTableOperation extends AbstractOperation implements ExtendOperation {
    ...
    public Optional<? extends TableResult> execute(CustomTableEnvironment tEnv) {
        ...
        tEnv.createTemporaryView(aggTable.getName(), sink);
    ...
    public static class AggTable {
        ...
        public static AggTable build(String statement, Map<String, List<String>> map) {
            return new AggTable(
                    statement,
