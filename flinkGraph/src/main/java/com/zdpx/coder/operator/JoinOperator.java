...
public class JoinOperator extends Operator {
    ...
    protected void execute() {
        ...
        List<FieldFunction> ffsPrimary = Operator.getFieldFunctions(primaryTableName, Operator.getNestMapValue(parameters,
                "/primaryInput"));
        List<FieldFunction> ffsSecond = Operator.getFieldFunctions(secondTableName, Operator.getNestMapValue(parameters, "/secondInput"));
