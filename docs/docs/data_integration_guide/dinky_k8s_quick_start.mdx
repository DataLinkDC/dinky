...
![IMG](http://www.aiwenmo.com/dinky/docs/test/k8s-new-config.png)类型选择`Kubernetes Native`或者`Kubernetes Operator` 目前阶段仍推荐Kubernetes Native方式，operator还在beta中
...
![IMG](http://www.aiwenmo.com/dinky/docs/test/k8s-config-list.png)
...
![IMG](http://www.aiwenmo.com/dinky/docs/test/k8s-task-demo.png)## 提交 kubernetes session 任务
