...
├── jar
│   ├── Dockerfile
│   ├── dlink-app-1.11-${VERSION}-jar-with-dependencies.jar -- 适配 Flink1.11.x application
│   ├── dlink-app-1.12-${VERSION}-jar-with-dependencies.jar -- 适配 Flink1.12.x application
...
│   │   ├── dinky-connector-jdbc-1.11-${VERSION}.jar -- dlink 的 jdbc 连接器增强实现
│   │   └── dlink-client-1.11-${VERSION}.jar
│   ├── flink1.12  -- 适配 Flink1.12.x
│   ├── dinky-connector-jdbc-1.12-${VERSION}.jar -- dlink 的 jdbc 连接器增强实现
│   │   └── dlink-client-1.12-${VERSION}.jar
