...
public class EmailSenderTest {
    ...
    public static void initEmailConfig() {
        ...
        emailConfig.put(EmailConstants.NAME_MAIL_SENDER, "aliyun.jishubu@visionacademy.cn");
        emailConfig.put(EmailConstants.NAME_MAIL_USER, "aliyun.jishubu@visionacademy.cn");
        emailConfig.put(EmailConstants.NAME_MAIL_PASSWD, "5i$6%tV!NG%5uQq8");
        ...
        emailConfig.put(EmailConstants.NAME_PLUGIN_DEFAULT_EMAIL_RECEIVERS, "mingye.zhu@visionacademy.cn,z17729752675@163.com");
        emailConfig.put(EmailConstants.NAME_PLUGIN_DEFAULT_EMAIL_RECEIVERCCS, "934230207@qq.com");
