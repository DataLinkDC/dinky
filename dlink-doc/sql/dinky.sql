...
CREATE TABLE `dlink_cluster` (
                                 ...
                                 `enabled` tinyint(1) NOT NULL DEFAULT '1' COMMENT 'is enable',
                                 `application_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Job Manager Host',
                                 `resource_manager_addr` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Job Manager Host',
                                 `create_time` datetime DEFAULT NULL COMMENT 'create time',
                                 `update_time` datetime DEFAULT NULL COMMENT 'update time',
                                 PRIMARY KEY (`id`) USING BTREE,
