...
export const ThemeCloud =() => {
  return (
    <>
      <svg className="absolute left-[8px] top-[7px]" width="16" height="14" viewBox="0 0 89 77" fill="none"
           xmlns="http://www.w3.org/2000/svg">
        <path d="M25 10L31.7523 28.2477L50 35L31.7523 41.7523L25 60L18.2477 41.7523L0 35L18.2477 28.2477L25 10Z"
              fill="#C6D0D1"/>
        <path
          d="M71.5 42L76.2266 54.7734L89 59.5L76.2266 64.2266L71.5 77L66.7734 64.2266L54 59.5L66.7734 54.7734L71.5 42Z"
          fill="#C6D0D1"/>
        <path d="M61 0L63.7009 7.29909L71 10L63.7009 12.7009L61 20L58.2991 12.7009L51 10L58.2991 7.29909L61 0Z"
              fill="#C6D0D1"/>
      </svg>
    </>
  );
...
export const ThemeStar =() => {
  return (
    <>
      <svg className="absolute right-[10px] top-[10px]" width="15" height="8" viewBox="0 0 104 54" fill="none"
           xmlns="http://www.w3.org/2000/svg">
        <path
