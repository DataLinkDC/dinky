...
const TemplateProFrom: React.FC<TemplateFormProps> = (props) => {
  ...
  const renderCodeEdit = () => {
    ...
    return <>
      ...
      <ProForm.Group>
        ...
        >
          <Select onSelect={handleCodeTypeChange}
                  style={{width: 280}}
        ...
        <ProFormSelect
          ...
          rules={[{required: true, message: l("rc.template.functionTypePlaceholder")}]}
      ...
      <ProForm.Group>
        <ProForm.Item
          name="templateCode"
          label={l("rc.template.templateCodeLabel", "", {language: codeLanguage})}
          rules={[{required: true, message: l("rc.template.templateCodePlaceholder")}]}
        >
          <CodeEdit
            {...CodeEditProps}
            code={codeValue}
  ...
  return <>
    <ProForm
      form={form}
      initialValues={{...values, codeType: values.codeType || CODE_TYPE.JAVA}}
      submitter={false}
    >
      {renderCodeEdit()}
    </ProForm>
