...
export const ALERT_TYPE_LIST_OPTIONS: DefaultOptionType[] = [
  {
    label: <Space align={'baseline'} size={5}><DingTalkSvg size={16} /> {l('rc.ai.dingTalk')}</Space>,
    value: ALERT_TYPE.DINGTALK
  },
  {
    label: <Space align={'baseline'} size={5}><WeChatSvg size={16} /> {l('rc.ai.wechat')}</Space>,
    value: ALERT_TYPE.WECHAT
  },
  {
    label: <Space align={'baseline'} size={5}><FeiShuSvg size={16} /> {l('rc.ai.feishu')}</Space>,
    value: ALERT_TYPE.FEISHU
  },
  {
    label: <Space align={'baseline'} size={5}><EmailSvg size={16} /> {l('rc.ai.email')}</Space>,
    value: ALERT_TYPE.EMAIL
  },
  {
    label: <Space align={'baseline'} size={5}><SmsSvg size={16} /> {l('rc.ai.sms')}</Space>,
...
export const MANU_FRACTURES = [
  {
    label: <Space align={'baseline'} size={5}><AliYunSmsSvg size={16} /> {l('rc.ai.mf.alibaba')}</Space>,
    value: SMS_TYPE.ALIBABA,
    key: l('rc.ai.mf.alibaba')
  },
  {
    label: <Space align={'baseline'} size={5}><TencentSmsSvg size={16} /> {l('rc.ai.mf.tencent')}</Space>,
