...
const DocumentForm: React.FC<DocumentFormProps> = (props) => {
    ...
    useEffect(() => {
         ...
         */
        VERSIONS.map((item) => {
            return versionOptions.push(<Option value={item.value}>{item.text}</Option>)
        })
        ...
        DOCUMENT_CATEGORY.map((item) => {
            return categoryOptions.push(<Option value={item.value}>{item.value}</Option>)
        })
        ...
        DOCUMENT_SUBTYPE.map((item) => {
            return subTypeOptions.push(<Option value={item.value}>{item.value}</Option>)
        })
        ...
        DOCUMENT_FUNCTION_TYPE.map((item) => {
            return typeOptions.push(<Option value={item.value}>{item.value}</Option>)
        })
