...
const Project: React.FC = (props: connect) => {
    ...
    useEffect(() => {
        setProjectState(prevState => ({
            ...prevState,
            menuItems: prevState.isLeaf ? JOB_RIGHT_MENU(prevState.isCut && prevState.cutId !== undefined) : FOLDER_RIGHT_MENU(prevState.isCut && prevState.cutId !== undefined)
        }));
    ...
    const handleRightClick = (info: any) => {
        ...
        setProjectState(prevState => ({
            ...prevState,
            isLeaf: isLeaf,
            menuItems: isLeaf ? JOB_RIGHT_MENU(prevState.isCut && prevState.cutId !== undefined) : FOLDER_RIGHT_MENU(prevState.isCut && prevState.cutId !== undefined),
            contextMenuOpen: true,
            contextMenuPosition: {
                ...prevState.contextMenuPosition, top: event.clientY + 5, left: event.clientX + 10
            },
            selectedKeys: [key],
    ...
    const handleSubmit = async (values: Catalogue) => {
        ...
        const result = await handleAddOrUpdate(options.url, {
                ...values,
    ...
    return (
        <div style={{paddingInline: 5}}>
            ...
            <RightContextMenu
                ...
                openChange={() => setProjectState(prevState => ({...prevState, contextMenuOpen: false}))}
