...
interface TableTransferProps extends TransferProps<UserBaseInfo.Role> {
  dataSource: UserBaseInfo.Role[];
  leftColumns: ColumnsType<UserBaseInfo.Role>;
  rightColumns: ColumnsType<UserBaseInfo.Role>;
}
...
const TableTransferFrom = (props: TableTransferFromProps) => {
  ...
  const leftTableColumns: ColumnsType<UserBaseInfo.Role> = [
    {
      dataIndex: 'roleCode',
  ...
  const rightTableColumns: ColumnsType<UserBaseInfo.Role> = [
    {
      dataIndex: 'roleCode',
      title: l('role.roleCode'),
    },
