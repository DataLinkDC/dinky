...
export const LoadUser = () => {
  ...
  return (
    <>
      ...
      >
        <Input.Search placeholder={l('sys.ldap.settings.keyword')} style={{ marginBottom: 8 }} enterButton loading={loading} onSearch={(value) => setKeyword(value)} />
        <Table<UserBaseInfo.User>
          ...
          dataSource={users.filter(user => user.username.indexOf(keyword) !== -1 || user.nickname?.indexOf(keyword) !== -1)
          }
          rowKey={'username'}
        />
      </ModalForm>
