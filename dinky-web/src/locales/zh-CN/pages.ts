...
export default {
  ...
  'rc.ai.create': '创建告警实例',
  'rc.ai.modify': '修改告警实例',
  'rc.ai.deleteConfirm': '确定删除选中的报警实例吗？',
  ...
  'rc.ai.senderPleaseHolder': '请输入邮件服务器发送者sender',
  ...
  'rc.ai.sender': '发送者sender昵称',
  'rc.ai.enableSmtpAuth': '是否开启邮箱验证',
  'rc.ai.emailUser': '邮箱用户名',
  'rc.ai.emailPassword': '邮箱密码',
  'rc.ai.starttlsEnable': '是否开启tls证书验证',
  'rc.ai.sslEnable': '是否开启SSL验证',
