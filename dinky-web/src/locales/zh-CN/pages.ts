...
export default {
  ...
  'about.communityRules.4':
    '群提问题请礼貌并且说明【版本、执行模式、操作描述、截图】。',
  'about.communityRules.5':
    ' 登记谁在使用 Dinky，可进入企业用户群提供技术支持。',
  ...
  'menu.edit': '修改菜单',
  'menu.tips.1':
    '修改菜单: 点击左侧树状图中的想要修改的节点, 在此处渲染修改表单',
  ...
  'rc.cc.hadoopConfigPathPlaceholder':
    '请输入 hadoop 配置文件路径 ,值如 /etc/hadoop/conf！',
  ...
  'rc.cc.flinkConfigPathPlaceholder':
    '请输入 flink-conf.yaml 路径！值如 /opt/module/flink/conf ',
  ...
  'rc.cc.sqlSubmitJarPathHelp':
    '请输入 Jar 文件路径! eg: hdfs:///dlink/jar/dlink-app.jar',
  ...
  'rc.cc.spDir': '保存点路径',
  'rc.cc.spDirHelp':
    '请输入保存点路径! 此参数配置项为: tate.savepoints.dir  eg: hdfs:///dinky/sp',
  'rc.cc.ckpDir': '检查点路径',
  'rc.cc.ckpDirHelp':
  ...
  'rc.cc.docker.fileHelp':
    'Docker 镜像文件! eg: /opt/module/dinky/docker/Dockerfile',
  ...
  'rc.cc.k8s.imageHelp':
    'Flink 镜像地址! eg: registry.cn-hangzhou.aliyuncs.com/flink/flink:1.17.0',
  ...
  'sys.setting.ds.tooltip':
    '海豚调度插件设置，可以让您把dinky任务丝滑推到海豚调度器工作流上',
  ...
  'sys.env.settings.dinkyAddr.note':
    '该地址必须与Dinky Application后台url中配置的地址相同',
  ...
  'sys.ldap.settings.url.note':
    'ldap认证服务地址，例如：ldap://192.168.111.1:389 ',
  ...
  'sys.ldap.settings.baseDn.note':
    'Dinky会在此基础dn下进行用户搜索,例如：ou=users,dc=dinky,dc=com',
  ...
  'catalog.name.tip':
    '此名称可作为 FlinkSql 任务的 JobName ([配置项: pipeline.name])',
  'catalog.type': '作业类型',
  'catalog.type.placeholder': '请选择作业类型',
  'catalog.type.tip':
    '作业类型决定了作业的执行方式, 请谨慎选择, 一旦选择后不可修改',
