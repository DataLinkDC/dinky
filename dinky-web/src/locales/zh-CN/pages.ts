...
export default {
  ...
  'rc.cc.k8s.version': 'Flink 版本',
  'rc.cc.k8s.unsupportBatch': '不支持批任务',
  'rc.cc.submit.type': '部署方式',
  'rc.cc.jar.path': '镜像内Jar路径',
  'rc.cc.jar.class': '启动类',
  'rc.cc.jar.args': '启动参数',
  'rc.cc.help.k8s.namespace': 'K8s 命名空间',
  'rc.cc.help.k8s.image': 'Flink 镜像地址',
  'rc.cc.help.k8s.jmcpu': 'JobManager cpu配置',
  'rc.cc.help.k8s.tmcpu': 'TaskManager cpu配置',
  'rc.cc.help.k8s.configfile': '默认~/.kube/config， 填写kube文件路径，可用作远程连接',
  'rc.cc.help.k8s.account': 'k8s 提交使用的账号，默认default',
  'rc.cc.help.k8s.defaultTemplate': '可选，默认JobManager，TaskManager 的template配置!',
  'rc.cc.help.k8s.jobManagerTemplate': '可选，JobManager 的template配置! 会覆盖kubernetes.pod-template配置',
  'rc.cc.help.k8s.taskManagerTemplate': '可选，TaskManager 的template配置!会覆盖kubernetes.pod-template配置',
  'rc.cc.help.k8s.jobManagerMemory': '可选，JobManager 的内存配置',
  'rc.cc.help.k8s.taskManagerMemory': '可选，taskManagerMemory 的内存配置',
