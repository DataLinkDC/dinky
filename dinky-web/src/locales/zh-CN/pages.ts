...
export default {
  ...
  'rc.ci.rm': 'ResourceManager 地址',
  'rc.ci.rm.tips': '添加 Hadoop 集群的 ResourceManager 的地址。',
  'rc.ci.rmPlaceholder': '请输入 ResourceManager 地址!',
  'rc.ci.aid': 'ApplicationId',
  'rc.ci.aid.tips': '添加 Yarn 中的 ApplicationId。',
  'rc.ci.aidPlaceholder': '请输入 ApplicationId!',
