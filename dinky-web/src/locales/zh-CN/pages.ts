...
export default {
  ...
  'rc.gp.modify': '修改项目',
  'rc.gp.delete': '删除项目',
  'rc.gp.deleteConfirm': '确定删除该项目吗？',
  'rc.gp.namePlaceholder': '请输入名称!',
  'rc.gp.urlPlaceholder': '请输入项目地址!',
  'rc.gp.branchesPlaceholder': '请选择分支!',
  ...
  'rc.gp.build.step.0': '环境检查',
  'rc.gp.build.step.1': '克隆项目',
  'rc.gp.build.step.2': '编译构建',
  'rc.gp.build.step.3': '获取 Jar 包',
  'rc.gp.build.step.4': '分析 UDF',
  'rc.gp.build.step.5': '完成',
