...
export default {
  ...
  'rc.cc.name': '集群配置名称',
  'rc.cc.type': '类型',
  'rc.cc.isAvailable': '是否可用',
  'rc.cc.available': '可用',
  'rc.cc.notAvailable': '不可用',

  'rc.cc.hadoopConfigPath': 'Hadoop 配置文件路径',
  'rc.cc.flinkConfigPath': 'Flink 配置文件路径',
  'rc.cc.libPath': 'lib 路径',
  'rc.cc.sqlSubmitJarPath': 'Jar 文件路径',
  'rc.cc.FlinkSQLJarMainParameter': 'Jar 的主类入参',
  'rc.cc.FlinkSQLJarMainClass': 'Jar 的主类',
  'rc.cc.create': '创建集群',
  'rc.cc.modify': '修改集群',
  'rc.cc.delete': '删除集群配置',
  'rc.cc.deleteConfirm': '确定删除该集群配置吗？',
  'rc.cc.start': '启动 Session 集群',
  'rc.cc.startConfirm': '确定通过该集群配置启动 Session 集群吗？',

  'rc.cc.baseConfig': '基本配置',
  'rc.cc.otherConfig': '其他配置',
  'rc.cc.addDefineConfig': '添加一个自定义项',
  'rc.cc.typePlaceholder': '请选择集群类型!',
  'rc.cc.aliasPlaceholder': '请输入别名!',
  'rc.cc.namePlaceholder': '请输入名称!',
  ...
  'rc.cc.defineConfig.highPriority': '自定义配置（高优先级）',
  ...
  'rc.cc.appConfig': 'App 配置',
  'rc.cc.kubernets.version': 'Flink 版本',
  'rc.cc.kubernets.unsupportBatch': '不支持批任务',
  'rc.cc.submit.type': '部署方式',
  'rc.cc.jar.path': '镜像内Jar路径',
  'rc.cc.jar.class': '启动类',
  'rc.cc.jar.args': '启动参数',
  'rc.cc.help.kubernets.namespace': 'kubernets命名空间',
  'rc.cc.help.kubernets.image': 'Flink镜像地址',
  'rc.cc.help.kubernets.jmcpu': 'jobmanager cpu配置',
  'rc.cc.help.kubernets.tmcpu': 'taskmanager cpu配置',
  'rc.cc.help.kubernetes.configfile': '默认~/.kube/config， 填写kube文件路径，可用作远程连接',
  'rc.cc.help.kubernets.account': 'kubernets 提交使用的账号，默认default',
  'rc.cc.help.kubernets.defaultTemplate': '可选，默认JobManager，TaskManager 的template配置!',
  'rc.cc.help.kubernets.jobManagerTemplate': '可选，JobManager 的template配置! 会覆盖kubernetes.pod-template配置',
  'rc.cc.help.kubernets.taskManagerTemplate': '可选，TaskManager 的template配置!会覆盖kubernetes.pod-template配置',
  'rc.cc.help.kubernets.jobManagerMemory': '可选，JobManager 的内存配置',
  'rc.cc.help.kubernets.taskManagerMemory': '可选，taskManagerMemory 的内存配置',
