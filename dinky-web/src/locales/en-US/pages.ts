...
export default {
  ...
  'datastudio.sqlTask.flinkJar.tip': 'The code editor on the left is the FlinkSql pre-statement, and the current form item is the EXECUTE JAR WITH syntax',
  ...
  'datastudio.sqlTask.flinkJar.mainClass.tip': 'Please enter the running program running class (mainClass)',
  ...
  'datastudio.sqlTask.flinkJar.allowNonRestoredState':  'Ignore undeclared state (allowNonRestoredState)',
  /**
   *
   * devops
   *
