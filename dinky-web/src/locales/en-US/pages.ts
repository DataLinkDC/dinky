...
export default {
  ...
  //-------------------------------- setting center --------------------------------
  //setting
  'sys.env.settings.pythonHome': 'Python environment variables',
  'sys.env.settings.pythonHome.note': 'Python environment variables',
  ...
  'sys.dolphinscheduler.settings.enable': 'Whether to enable',
  'sys.dolphinscheduler.settings.enable.note': 'Whether it is enabled or not, the relevant functions of DolphinScheduler can only be used after it is enabled, please ensure that the relevant configuration of DolphinScheduler is correct',
