...
export default {
  ...
  'rc.ci.rm': 'ResourceManager Address',
  'rc.ci.rm.tips': 'Add the address of the ResourceManager of the Hadoop cluster.',
  'rc.ci.rmPlaceholder': 'Please enter the ResourceManager HA address!',
  'rc.ci.aid': 'ApplicationId',
  'rc.ci.aid.tips': 'Add the ApplicationId in Yarn.',
  'rc.ci.aidPlaceholder': 'Please enter the ApplicationId!',
