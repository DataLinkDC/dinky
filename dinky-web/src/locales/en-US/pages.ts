...
export default {
  ...
  'datastudio.middle.terminal.websocket.tip': 'In general, no modifications are required. If you have custom Nginx configurations, please edit this address.',
  'datastudio.middle.terminal.cluster': 'Flink Cluster',
  'datastudio.middle.terminal.cluster.tip': 'It is necessary to pre-register the corresponding cluster in the registry. Only manually registered clusters will be displayed.',
  'datastudio.middle.terminal.fontSize': 'Font Size',
  'datastudio.middle.terminal.backspaceAsCtrlH': 'Backspace As CtrlH',
  'datastudio.middle.terminal.backspaceAsCtrlH.tip': 'If issues with display arise following a rollback deletion, modify this ',
