...
public class DorisSinkOptions {
    ...
    public static final ConfigOption<Long> DORIS_EXEC_MEM_LIMIT =
            ConfigOptions.key("doris.exec.mem.limit")
                    ...
                    .withDescription(
                            "Memory limit for a single query. The default is 2GB, in bytes.");
    ...
    public static final ConfigOption<Integer> DORIS_REQUEST_QUERY_TIMEOUT_S =
            ConfigOptions.key("doris.request.query.timeout.s")
                    ...
                    .defaultValue(3600)
                    .withDescription(
                            "Query the timeout time of doris, the default is 1 hour, -1 means no timeout limit.");
    ...
    public static final ConfigOption<Integer> DORIS_REQUEST_TABLET_SIZE =
