...
import org.dinky.metadata.convert.SqlToPaimonPredicateConverter;
...
public class SqlToPaimonPredicateConverterTest {
    ...
    @BeforeEach
    public void setUp() {
        rowType = new RowType(Arrays.asList(
    ...
    public void testConvertSqlWhereToPaimonPredicate() {
        ...
        Predicate predicate = SqlToPaimonPredicateConverter.convertSqlWhereToPaimonPredicate(rowType, plainSelect);
        assertNotNull(predicate);

        PredicateBuilder builder = new PredicateBuilder(rowType);

        // Validate each part of the predicate
        Predicate expectedPredicate = PredicateBuilder.and(
                builder.equal(0, "a"),
                ...
                builder.equal(12, Timestamp.fromLocalDateTime(LocalDateTime.parse("2022-01-01T12:00:00.123"))),
                builder.equal(13, DateTimeUtils.toInternal(LocalTime.parse("12:00:00.123"))));
    ...
    public void testConvertSqlWhereToPaimonPredicateWithAnd() {
        ...
        PredicateBuilder builder = new PredicateBuilder(rowType);
        Predicate expectedPredicate = PredicateBuilder.and(builder.greaterThan(7, 3), builder.lessThan(10, 6.6d));
    ...
    public void testConvertSqlWhereToPaimonPredicateWithOr() {
        ...
        PredicateBuilder builder = new PredicateBuilder(rowType);
        Predicate expectedPredicate = PredicateBuilder.or(builder.greaterThan(7, 3), builder.lessThan(10, 6.6d));
    ...
    public void testConvertSqlSelectToPaimonProjectionArrayWithALL() {
        ...
        PlainSelect plainSelect = convertToPlainSelect(query);
        int[] projectionIndex =
                SqlToPaimonPredicateConverter.convertSqlSelectToPaimonProjectionIndex(fieldNames, plainSelect);
