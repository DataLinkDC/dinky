...
public interface PhoenixConstant {
    ...
    /** 不指定schema列信息模板SQL */
    String QUERY_COLUMNS_SQL_DEFAULT =
            " select COLUMN_NAME,COLUMN_FAMILY,DATA_TYPE,KEY_SEQ,NULLABLE, '' as CHARACTER_SET_NAME,"
    ...
    /** 查询schema模板SQL */
    String QUERY_SCHEMA_SQL =
            " select distinct(TABLE_SCHEM) as TABLE_SCHEM from SYSTEM.CATALOG where TABLE_SCHEM is not null and TABLE_SCHEM <> 'SYSTEM' ";
    ...
    String QUERY_TABLE_BY_SCHEMA_SQL =
            QUERY_TABLE_BY_SCHEMA_SQL_DEFAULT + "  AND TABLE_SCHEM = '%s' ";
