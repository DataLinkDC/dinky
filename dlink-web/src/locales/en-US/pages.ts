...
export default {
  ...
  'pages.datastudio.label.jobConfig': 'Job Configuration',
  'pages.datastudio.label.jobConfig.cluster': 'Flink cluster',
  'pages.datastudio.label.jobConfig.cluster.tip': 'Select Flink cluster',
  'pages.datastudio.label.jobConfig.clusterConfig': 'Flink cluster configuration',
  'pages.datastudio.label.jobConfig.clusterConfig.tip1': 'Select Flink cluster configuration for remote submission tasks in [{type}] mode',
  'pages.datastudio.label.jobConfig.clusterConfig.tip2': 'Select Flink cluster configuration',
  ...
  'pages.datastudio.label.jobConfig.parallelism': 'Task parallelism',
  'pages.datastudio.label.jobConfig.parallelism.tip': 'Set the parallelism of Flink tasks, the minimum is 1',
  'pages.datastudio.label.jobConfig.insert': 'Insert statement set',
  ...
  'pages.datastudio.label.jobConfig.other': 'Other Configuration',
  'pages.datastudio.label.jobConfig.other.tip': 'Other configuration items will be applied to the execution environment, such as pipeline.name',
  'pages.datastudio.label.jobConfig.addConfig': 'Add configuration item',
  'pages.datastudio.label.jobConfig.addConfig.params': 'parameters',
  'pages.datastudio.label.jobConfig.addConfig.value': 'value',

  'pages.datastudio.label.execConfig': 'Execution Configuration',
  'pages.datastudio.label.execConfig.selectDatabase': 'Select data source',
  ...
  'pages.datastudio.label.execConfig.changelog': 'print stream',
  ...
  'pages.datastudio.label.version.diff': 'version comparison',
  ...
  'pages.datastudio.label.jobInfo': 'Job Information',
  ...
  'pages.datastudio.label.udfInfo': 'UDF information',
  'pages.datastudio.label.udfInfo.classname': 'class name',
  'pages.datastudio.label.udfInfo.auto': 'Automatic recognition',
  ...
  'pages.devops.lable.allonline': 'One-Click-Online',
  'pages.devops.lable.alloffline': 'One-Click-Offline',
  ...
  'pages.devops.lable.pleaseSelect': 'Please Select',

  'pages.devops.lable.online.list': 'Online Detail List',
  'pages.devops.lable.offline.list': 'Offline Detail List',
  'pages.devops.lable.line.name': 'Name',
  'pages.devops.lable.line.status': 'Status',
  'pages.devops.lable.line.code': 'Result',
  'pages.devops.lable.line.message': 'Message',
  'pages.devops.lable.line.piontConfig': 'Point Config Selection',
  ...
  'pages.flinkColumns.type': 'Type',
  'pages.flinkColumns.key': 'Primary Key',
  'pages.flinkColumns.key.true': 'Primary Key',
  'pages.flinkColumns.key.other': 'Other',
  'pages.flinkColumns.isnull': 'Is Null',
  'pages.flinkColumns.isnotnull': 'Is Not Null',
