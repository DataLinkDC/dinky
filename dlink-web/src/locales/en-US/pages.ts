...
export default {
  ...
  'pages.metadate.NoDatabaseSelected': 'No database selected',
  'pages.metadate.Application': 'Application',
  'pages.metadate.TableInfo': 'Table Info',
  'pages.metadate.Description': 'Description',
  'pages.metadate.DataSearch': 'Data Search',
  'pages.metadate.GenerateSQL': 'Generate SQL',
  'pages.metadate.FieldInformation': 'Field information',
