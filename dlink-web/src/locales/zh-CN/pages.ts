...
export default {
  ...
  'pages.registerCenter.clusterManagement': '集群实例管理',
  'pages.registerCenter.cluster.instanceName': '实例名称',
  'pages.registerCenter.cluster.alias': '别名',
  'pages.registerCenter.cluster.type': '类型',
  'pages.registerCenter.cluster.jobManagerAddress': 'JobManger 地址',
  'pages.registerCenter.cluster.version': '版本',
  'pages.registerCenter.cluster.jobManagerHaAddress': 'JobManger 高可用地址',
  'pages.registerCenter.cluster.instanceId': '实例 Id',
  'pages.registerCenter.cluster.create': '创建集群',
  'pages.registerCenter.cluster.modify': '修改集群',
  'pages.registerCenter.cluster.delete': '删除 Flink 实例',
  'pages.registerCenter.cluster.deleteConfirm': '确定删除该 Flink 实例吗？',
  'pages.registerCenter.cluster.recycle': '回收 Flink 实例',
  'pages.registerCenter.cluster.recycleConfirm': '确定回收所有自动创建且过期的 Flink 实例吗？',
  'pages.registerCenter.cluster.recycle.success' : '成功回收{total}个 Flink 实例',
  'pages.registerCenter.cluster.enable': '启用 Flink 实例',
  'pages.registerCenter.cluster.enableConfirm': '您确定要启用此 Flink 实例吗？',
  'pages.registerCenter.cluster.disable': '禁用 Flink 实例',
  'pages.registerCenter.cluster.disableConfirm': '您确定要禁用此 Flink 实例吗？',
  'pages.registerCenter.cluster.disableTotalOf': '被禁用的 Flink 实例共 {total} 个',
  'pages.registerCenter.cluster.jobManagerHaAddress.validate.slash': '不符合规则! 不能包含/',
  'pages.registerCenter.cluster.jobManagerHaAddress.validate.port': '不符合规则! 端口号区间[0-65535]',
  'pages.registerCenter.cluster.jobManagerHaAddressPlaceholderText': '添加 Flink 集群的 JobManager 的 RestApi 地址。当 HA 模式时，地址间用英文逗号分隔，例如：192.168.123.101:8081,192.168.123.102:8081,192.168.123.103:8081',
  'pages.registerCenter.cluster.jobManagerHaAddressPlaceholder': '请输入 JobManager HA 地址!',
  'pages.registerCenter.cluster.typePlaceholder': '请选择集群类型!',
  ...
  'pages.registerCenter.clusterConfig.id': '集群配置ID',
  'pages.registerCenter.clusterConfig.type': '类型',
  'pages.registerCenter.clusterConfig.hadoopConfigPath': 'Hadoop 配置文件路径',
  'pages.registerCenter.clusterConfig.flinkConfigPath': 'Flink 配置文件路径',
  'pages.registerCenter.clusterConfig.libPath': 'lib 路径',
  'pages.registerCenter.clusterConfig.isAvailable': '是否可用',
  'pages.registerCenter.clusterConfig.available': '可用',
  'pages.registerCenter.clusterConfig.notAvailable': '不可用',
  'pages.registerCenter.clusterConfig.create': '创建集群',
  'pages.registerCenter.clusterConfig.modify': '修改集群',
  'pages.registerCenter.clusterConfig.delete': '删除集群配置',
  'pages.registerCenter.clusterConfig.deleteConfirm': '确定删除该集群配置吗？',
  'pages.registerCenter.clusterConfig.enable': '启用集群配置',
  'pages.registerCenter.clusterConfig.enableConfirm': '您确定要启用此集群配置吗？',
  'pages.registerCenter.clusterConfig.disable': '禁用集群配置',
  'pages.registerCenter.clusterConfig.disableConfirm': '您确定要禁用此集群配置吗？',
  'pages.registerCenter.clusterConfig.disableTotalOf': '被禁用的集群配置共 {total} 个',
  'pages.registerCenter.clusterConfig.baseConfig': '基本配置',
  'pages.registerCenter.clusterConfig.otherConfig': '其他配置',
  'pages.registerCenter.clusterConfig.addDefineConfig': '添加一个自定义项',
  'pages.registerCenter.clusterConfig.typePlaceholder': '请选择集群类型!',
  'pages.registerCenter.clusterConfig.aliasPlaceholder': '请输入别名!',
  'pages.registerCenter.clusterConfig.namePlaceholder': '请输入名称!',
  'pages.registerCenter.clusterConfig.hadoopConfigPathPlaceholder': '请输入 hadoop 配置文件路径 ,值如 /etc/hadoop/conf！',
  'pages.registerCenter.clusterConfig.hadoopConfigPathHelp': '指定配置文件路径（末尾无/），需要包含以下文件：core-site.xml,hdfs-site.xml,yarn-site.xml ！',
  'pages.registerCenter.clusterConfig.defineConfig.highPriority': '自定义配置（高优先级）',
  'pages.registerCenter.clusterConfig.flinkConfig': 'Flink 配置',
  'pages.registerCenter.clusterConfig.hadoopConfig': 'Hadoop 配置',
  'pages.registerCenter.clusterConfig.k8sConfig': 'Kubernetes 配置',
  'pages.registerCenter.clusterConfig.libPathPlaceholder': '请输入 lib 的 hdfs 路径！值如 hdfs:///flink/lib',
  'pages.registerCenter.clusterConfig.libPathHelp': '指定 lib 的 hdfs 路径（末尾无/），需要包含 Flink 运行时的依赖',
  ...
  'pages.registerCenter.alert.instance.create': '创建告警实例',
  'pages.registerCenter.alert.instance.modify': '修改告警实例',
  ...
  'pages.registerCenter.alert.instance.proxyPleaseHolder': '请输入代理主机',
  'pages.registerCenter.alert.instance.portPleaseHolder': '请输入代理端口',
  'pages.registerCenter.alert.instance.userPleaseHolder': '请输入代理用户',
  'pages.registerCenter.alert.instance.atUsersPleaseHolder': '请输入被@用户ID(需要飞书后台的用户ID),多个逗号隔开!',
  'pages.registerCenter.alert.instance.passwordPleaseHolder': '请输入密码',
  'pages.registerCenter.alert.instance.atMobilesPleaseHolder': '请输入@手机号 多个使用英文逗号分开 ',
  'pages.registerCenter.alert.instance.msgtypePleaseHolder': '请选择消息发送类型',
  'pages.registerCenter.alert.instance.corpIdPleaseHolder': '请输入 企业Id',
  ...
  'pages.registerCenter.alert.instance.isEnableProxy': '是否启用代理',
  'pages.registerCenter.alert.instance.proxy': '代理',
  'pages.registerCenter.alert.instance.port': '端口',
  'pages.registerCenter.alert.instance.user': '用户名',
  'pages.registerCenter.alert.instance.password': '密码',
  'pages.registerCenter.alert.instance.isAtAll': '是否@全部',
  'pages.registerCenter.alert.instance.corpId': '企业Id',
  'pages.registerCenter.alert.instance.atMobiles': '@手机号',
  ...
  'pages.registerCenter.alert.instance.text': '普通文本',
  'pages.registerCenter.alert.instance.post': '富文本',
  ...
  'pages.registerCenter.alert.group.chooseAlertInstanceIds': '请选择报警组实例',
  'pages.registerCenter.alert.group.inputName': '请输入告警组名称',
  'pages.registerCenter.alert.group.create': '创建告警组',
  'pages.registerCenter.alert.group.modify': '修改告警组',
  ...
  'pages.registerCenter.db.Management': '数据源',
  'pages.registerCenter.db.name': '名称',
  'pages.registerCenter.db.alias': '别名',
  'pages.registerCenter.db.groupName': '分组类型',
  'pages.registerCenter.db.url': '数据库连接 URL',
  'pages.registerCenter.db.username': '用户名',
  'pages.registerCenter.db.password': '密码',
  'pages.registerCenter.db.flinkConfig': 'Flink 连接配置',
  'pages.registerCenter.db.flinkTemplate': 'Flink 连接模板',
  'pages.registerCenter.db.create': '创建数据源',
  'pages.registerCenter.db.modify': '修改数据源',
  'pages.registerCenter.db.delete': '删除数据源',
  'pages.registerCenter.db.deleteConfirm': '确定删除该数据源{dbName}吗？',
  'pages.registerCenter.db.aliasPlaceholder': '请输入别名!',
  'pages.registerCenter.db.namePlaceholder': '请输入名称!',
  ...
  'pages.registerCenter.db.backup': '备份',
  'pages.registerCenter.db.other': '其他',
  'pages.registerCenter.db.no': '序号',
  'pages.registerCenter.db.columnName': '字段名称',
  'pages.registerCenter.db.comment': '注释',
  'pages.registerCenter.db.type': '类型',
  'pages.registerCenter.db.primarykey': '主键',
  'pages.registerCenter.db.autoIncrement': '自增',
  'pages.registerCenter.db.isNull': '非空',
  'pages.registerCenter.db.null': '可为空',
  'pages.registerCenter.db.default': '默认值',
  'pages.registerCenter.db.precision': '精度',
  'pages.registerCenter.db.decimalDigits': '小数范围',
  'pages.registerCenter.db.character': '字符集',
  'pages.registerCenter.db.collationRule': '排序规则',
  'pages.registerCenter.db.javaType': 'Java 类型',

  'pages.registerCenter.doc.Management': '文档管理',
  'pages.registerCenter.doc.name': '名称',
  'pages.registerCenter.doc.id': '文档 ID',
  'pages.registerCenter.doc.category': '文档类型',
  'pages.registerCenter.doc.functionType': '函数类型',
  'pages.registerCenter.doc.subFunctionType': '子类型',
  'pages.registerCenter.doc.description': '描述',
  'pages.registerCenter.doc.fillValue': '填充值',
  'pages.registerCenter.doc.version': '版本',
  'pages.registerCenter.doc.create': '创建文档',
  'pages.registerCenter.doc.modify': '修改文档',
  'pages.registerCenter.doc.delete': '删除文档',
  'pages.registerCenter.doc.deleteConfirm': '确定删除选中的文档吗？',
  'pages.registerCenter.doc.enable': '启用文档',
  'pages.registerCenter.doc.enableConfirm': '确定启用选中的文档吗？',
  'pages.registerCenter.doc.disable': '禁用文档',
  'pages.registerCenter.doc.disableConfirm': '确定禁用选中的文档吗？',
  'pages.registerCenter.doc.disableTotalOf': '被禁用的文档共 {total} 个',
  'pages.registerCenter.doc.namePlaceholder': '请输入名称!',
  'pages.registerCenter.doc.versionPlaceholder': '请选择该文档所属版本!',
  'pages.registerCenter.doc.enabledPlaceholder': '请选择是否启用!',
  'pages.registerCenter.doc.fillValuePlaceholder': '请输入填充值,编辑器内使用名称触发提示 eg: 如果希望在函数LTRIM(parms)中输入参数 则语法为: LTRIM(${1:})  此时的1代表第一个光标 如需多个 数字+1即可 tab键切换光标 ; 如不需要参数则直接输入期望填充值',
  'pages.registerCenter.doc.fillValueHelp': '请输入填充值',
  'pages.registerCenter.doc.descriptionPlaceholder': '请输入文档描述信息!',
  'pages.registerCenter.doc.typePlaceholder': '请选择该文档所属函数类型!',
