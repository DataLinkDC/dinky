...
export default {
  ...
  'pages.datastudio.editor.exec': '执行当前的 SQL',
  ...
  'pages.devops.jobstatus.RECONNECTING': '重连中',
  ...
  'pages.datastudio.label.jobInfo': '作业信息',
  ...
  'pages.datastudio.label.udfInfo': 'UDF信息',
  'pages.datastudio.label.udfInfo.classname': '类名',
  'pages.datastudio.label.udfInfo.auto': '自动识别',
  ...
  'pages.rc.cluster.resourceManagerAddr': 'Resource Manager 地址',
  ...
  'pages.rc.cluster.stop': '停止 Flink 实例',
  'pages.rc.cluster.deleteConfirm': '确定删除该 Flink 实例吗？',
  'pages.rc.cluster.stopConfirm': '确定停止该 Flink 实例吗？',
