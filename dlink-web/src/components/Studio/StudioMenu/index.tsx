...
const StudioMenu = (props: any) => {
  ...
  const toReleaseTask = () => {
    Modal.confirm({
      ...
      content: l('pages.datastudio.editor.release.jobConfirm', '', {
        jobName: current.task.jobName,
      }),
      okText: l('button.confirm'),
      cancelText: l('button.cancel'),
      onOk: async () => {
        ...
        res.then((result) => {
          if (result.code == CODE.SUCCESS) {
            ...
            message.success(
              l('pages.datastudio.editor.release.job.success', '', {
                jobName: current.task.jobName,
              }),
            );
          } else {
            message.error(
              l('pages.datastudio.editor.release.job.error', '', { jobName: current.task.jobName }),
            );
          }
        });
      },
    ...
    Modal.confirm({
      ...
      onOk: async () => {
        ...
        res.then((result) => {
          ...
          if (result.code == CODE.SUCCESS) {
            message.success(
              l('pages.datastudio.editor.edit.job.success', '', { jobName: current.task.jobName }),
            );
          }
        });
      },
  ...
  const toOnLineTask = () => {
    Modal.confirm({
      ...
      content: l('pages.datastudio.editor.online.jobConfirm', '', {
        jobName: current.task.jobName,
      }),
      okText: l('button.confirm'),
      cancelText: l('button.cancel'),
      onOk: async () => {
        ...
        res.then((result) => {
          if (result.code === CODE.SUCCESS) {
            ...
            message.success(
              l('pages.datastudio.editor.online.job.success', '', {
                jobName: current.task.jobName,
              }),
            );
          } else {
      ...
      onOk: async () => {
        ...
        res.then((result) => {
          if (result.code === CODE.SUCCESS) {
            ...
            message.success(
              l('pages.datastudio.editor.stop.job.success', '', { jobName: current.task.jobName }),
            );
          } else {
            message.error(
  ...
  const toOffLineTask = (type: string) => {
    Modal.confirm({
      ...
      content: l('pages.datastudio.editor.offline.jobConfirm', '', {
        jobName: current.task.jobName,
      }),
      okText: l('button.confirm'),
      cancelText: l('button.cancel'),
      onOk: async () => {
        ...
        res.then((result) => {
          if (result.code === CODE.SUCCESS) {
            ...
            props.changeTaskJobInstance(current.task.id, 0);
            message.success(
              l('pages.datastudio.editor.offline.job.success', '', {
                jobName: current.task.jobName,
              }),
            );
          } else {
  ...
  const toCancelTask = () => {
    Modal.confirm({
      ...
      content: l('pages.datastudio.editor.delete.jobConfirm', '', {
        jobName: current.task.jobName,
      }),
      okText: l('button.confirm'),
      cancelText: l('button.cancel'),
      onOk: async () => {
        ...
        res.then((result) => {
          if (result.code === CODE.SUCCESS) {
            ...
            message.success(
              l('pages.datastudio.editor.delete.job.success', '', {
                jobName: current.task.jobName,
              }),
            );
          } else {
          ...
          {current?.task ? (
            <Col span={12}>
              ...
              <Tooltip title={l('pages.datastudio.editor.help')}>
                <Button type="text" icon={<QuestionCircleTwoTone />} onClick={showHelp} />
              </Tooltip>
            </Col>
          ) : (
            <Col span={8}>
