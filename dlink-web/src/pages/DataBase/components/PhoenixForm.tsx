...
const PhoenixForm: React.FC<PhoenixFormProps> = (props) => {
    ...
    return (
      <>
        ...
        <Form.Item
          ...
          label="url"
        >
          <TextArea placeholder="jdbc:phoenix://{host}:{port}" allowClear
        ...
        <Form.Item
          ...
          label="Flink With 模板"
        >
          <TextArea placeholder="'connector' = 'Phoenix',..." allowClear
                    autoSize={{minRows: 3, maxRows: 10}}/>
        </Form.Item>
        <Form.Item
          name="note"
