    ...
    private String checkUseIngress() {
        ...
        if (MapUtils.isNotEmpty(ingressConfig)) {
            boolean ingressEnable = Boolean.parseBoolean(ingressConfig
                    .getOrDefault(DinkyKubernetsConstants.DINKY_K8S_INGRESS_ENABLED_KEY, "false")
                    .toString());
            String ingressDomain = ingressConfig
                    .getOrDefault(DinkyKubernetsConstants.DINKY_K8S_INGRESS_DOMAIN_KEY, StringUtils.EMPTY)
                    .toString();
