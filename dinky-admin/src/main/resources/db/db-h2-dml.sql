...
The async timeout for the asynchronous operation to complete.', 'Set ''table.exec.async-lookup.timeout''=''3 min'';',
        '1.14', 0, 1, '2022-01-20 15:00:00', '2023-12-27 23:58:09', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
...
VALUES (5, 'Variable', 'FLINK_OPTIONS', '', 'set table.exec.mini-batch.enabled',
        ...
        'Set ''table.exec.mini-batch.enabled''=''false'';', '1.14', 0, 1, '2022-01-20 15:00:00', '2023-12-27 23:58:09',
        null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (6, 'Variable', 'FLINK_OPTIONS', '', 'set table.exec.mini-batch.size',
        ...
        'Set ''table.exec.mini-batch.size''=''-1'';', '1.14', 0, 1, '2022-01-20 15:00:00', '2023-12-27 23:58:09', null,
        null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
...
Possible values:
"ERROR"
"DROP"', 'Set ''table.exec.sink.not-null-enforcer''=''ERROR'';', '1.14', 0, 1, '2022-01-20 15:00:00',
        '2023-12-27 23:58:09', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
...
"NONE"
"FORCE"
"AUTO"', 'Set ''table.exec.sink.upsert-materialize''=''AUTO'';', '1.14', 0, 1, '2022-01-20 15:00:00',
        '2023-12-27 23:58:09', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (10, 'Module', 'SQL_TEMPLATE', 'FlinkSql', 'create.table.kafka', 'kafka快速建表格式', 'CREATE TABLE Kafka_Table (
  ...
  ''format'' = ''csv''
);', '1.14', 0, 1, '2022-01-20 16:59:18', '2023-12-28 00:02:57', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
...
VALUES (12, 'Module', 'SQL_TEMPLATE', 'FlinkSql', 'create.table.jdbc', 'JDBC建表语句', 'CREATE TABLE JDBC_table (
  ...
  PRIMARY KEY (id) NOT ENFORCED
   ...
   ''username'' = ''root'',
   ''password'' = ''123456''
);', '1.14', 0, 1, '2022-01-20 17:15:26', '2023-12-28 00:02:57', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
...
VALUES (14, 'Operator', 'SQL_TEMPLATE', 'FlinkSql', 'use.catalog.hive', '使用hive的catalog', 'USE CATALOG hive;',
        '1.14', 0, 1, '2022-01-20 17:22:53', '2023-12-28 00:03:53', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
...
VALUES (16, 'Variable', 'FLINK_OPTIONS', '', 'set dialect.hive', '使用hive方言', 'Set table.sql-dialect=hive;', '1.14',
        0, 1, '2022-01-20 17:25:37', '2023-12-28 00:04:44', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (17, 'Variable', 'FLINK_OPTIONS', '', 'set dialect.default', '使用default方言', 'Set table.sql-dialect=default;',
        '1.14', 0, 1, '2022-01-20 17:26:19', '2023-12-28 00:04:44', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
...
VALUES (25, 'Function', 'FUN_UDF', 'COMPARE_FUNCTION', 'value1 <= value2',
        ...
        1, '2021-02-22 14:39:40', '2023-12-28 00:08:58', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (26, 'Function', 'FUN_UDF', 'COMPARE_FUNCTION', 'value IS NULL', '如果value为NULL，则返回TRUE 。', '${1:} IS NULL',
        '1.12', 2, 1, '2021-02-22 14:40:39', '2023-12-28 00:08:58', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (27, 'Function', 'FUN_UDF', 'COMPARE_FUNCTION', 'value IS NOT NULL', '如果value不为NULL，则返回TRUE 。',
        '${1:}  IS NOT NULL', '1.12', 0, 1, '2021-02-22 14:41:26', '2023-12-28 00:08:58', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
...
VALUES (31, 'Function', 'FUN_UDF', 'COMPARE_FUNCTION',
        ...
        '${1:} NOT BETWEEN ${2:} AND ${3:}', '1.12', 0, 1, '2021-02-22 14:44:26', '2023-12-28 00:08:58', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (32, 'Function', 'FUN_UDF', 'COMPARE_FUNCTION', 'string1 LIKE string2 [ ESCAPE char ]',
        ...
        0, 1, '2021-02-22 14:44:26', '2023-12-28 00:08:58', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (33, 'Function', 'FUN_UDF', 'COMPARE_FUNCTION', 'string1 NOT LIKE string2 [ ESCAPE char ]',
        ...
        '1.12', 0, 1, '2021-02-22 14:44:26', '2023-12-28 00:08:58', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (34, 'Function', 'FUN_UDF', 'COMPARE_FUNCTION', 'string1 SIMILAR TO string2 [ ESCAPE char ]',
        ...
        '${1:} SIMILAR TO ${2:}', '1.12', 0, 1, '2021-02-22 14:44:26', '2023-12-28 00:08:58', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (35, 'Function', 'FUN_UDF', 'COMPARE_FUNCTION', 'string1 NOT SIMILAR TO string2 [ ESCAPE char ]',
        ...
        '${1:} NOT SIMILAR TO ${2:}', '1.12', 0, 1, '2021-02-22 14:44:26', '2023-12-28 00:08:58', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
...
如果value1为NULL，则始终返回UNKNOWN 。', '${1:} IN (${2:} )', '1.12', 0, 1, '2021-02-22 14:44:26', '2023-12-28 00:08:58',
        null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
...
VALUES (49, 'Function', 'FUN_UDF', 'LOGICAL_FUNCTION', 'boolean IS NOT UNKNOWN',
        ...
        1, '2021-02-22 14:44:26', '2023-12-28 00:08:58', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
...
VALUES (52, 'Function', 'FUN_UDF', 'ARITHMETIC_FUNCTIONS', 'numeric1 + numeric2', '返回NUMERIC1加NUMERIC2。',
        '${1:}  + ${2:} ', '1.12', 0, 1, '2021-02-22 14:44:26', '2023-12-28 00:08:58', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
...
VALUES (57, 'Function', 'FUN_UDF', 'ARITHMETIC_FUNCTIONS', 'POWER(numeric1, numeric2)', '返回NUMERIC1的NUMERIC2 次幂。',
        'POWER(${1:} , ${2:})', '1.12', 0, 1, '2021-02-22 14:44:26', '2023-12-28 00:08:58', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
...
VALUES (75, 'Function', 'FUN_UDF', 'ARITHMETIC_FUNCTIONS', 'ATAN2(numeric1, numeric2)',
        '返回坐标的反正切（NUMERIC1，NUMERIC2）。', 'ATAN2(${1:}, ${2:})', '1.12', 0, 1, '2021-02-22 15:29:35',
        '2023-12-28 00:08:58', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
...
VALUES (77, 'Function', 'FUN_UDF', 'ARITHMETIC_FUNCTIONS', 'DEGREES(numeric)', '返回弧度NUMERIC的度数表示形式',
        'DEGREES(${1:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2023-12-28 00:08:58', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (78, 'Function', 'FUN_UDF', 'ARITHMETIC_FUNCTIONS', 'RADIANS(numeric)', '返回度数NUMERIC的弧度表示。',
        'RADIANS(${1:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2023-12-28 00:08:58', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
...
VALUES (80, 'Function', 'FUN_UDF', 'ARITHMETIC_FUNCTIONS', 'ROUND(numeric, integer)',
        '返回一个数字，四舍五入为NUMERIC的INT小数位。', 'ROUND(${1:} , ${2:})', '1.12', 0, 1, '2021-02-22 15:29:35',
        '2023-12-28 00:08:58', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
...
VALUES (83, 'Function', 'FUN_UDF', 'ARITHMETIC_FUNCTIONS', 'RAND()', '返回介于0.0（含）和1.0（不含）之间的伪随机双精度值。',
        'RAND()', '1.12', 0, 1, '2021-02-22 15:29:35', '2023-12-28 00:08:58', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (84, 'Function', 'FUN_UDF', 'ARITHMETIC_FUNCTIONS', 'RAND(integer)', '返回带有初始种子INTEGER的介于0.0（含）和1.0（不含）之间的伪随机双精度值。

如果两个RAND函数具有相同的初始种子，它们将返回相同的数字序列。', 'RAND(${1:})', '1.12', 0, 1, '2021-02-22 15:29:35',
        '2023-12-28 00:08:58', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
...
例如，4.bin()返回“ 100”并12.bin()返回“ 1100”。', 'BIN(${1:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2023-12-28 00:08:58',
        null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
...
注意：当前，NUMERIC1必须大于0，而NUMERIC2必须大于1。', 'LOG(${1:})', '1.12', 0, 1, '2021-02-22 15:29:35',
        '2023-12-28 00:08:58', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
...
注意：当前，NUMERIC1必须大于0，而NUMERIC2必须大于1。', 'LOG(${1:}, ${2:})', '1.12', 0, 1, '2021-02-22 15:29:35',
        '2023-12-28 00:08:58', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (94, 'Function', 'FUN_UDF', 'ARITHMETIC_FUNCTIONS', 'CEIL(numeric)',
        '将NUMERIC向上舍入，并返回大于或等于NUMERIC的最小整数。', 'CEIL(${1:})', '1.12', 0, 1, '2021-02-22 15:29:35',
        '2023-12-28 00:08:58', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
...
VALUES (96, 'Function', 'FUN_UDF', 'STRING_FUNCTIONS', 'string1 || string2', '返回string1和string2的连接。',
        '${1:} || ${2:}', '1.12', 0, 1, '2021-02-22 15:29:35', '2023-12-28 00:08:58', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
...
如果在STRING2中找不到STRING1，则返回0 。', 'POSITION(${1:} IN ${2:})', '1.12', 0, 1, '2021-02-22 15:29:35',
        '2023-12-28 00:08:58', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
...
VALUES (105, 'Function', 'FUN_UDF', 'STRING_FUNCTIONS',
        ...
        'OVERLAY(${1:} PLACING ${2:} FROM ${3:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2023-12-28 00:08:58', null,
        null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (106, 'Function', 'FUN_UDF', 'STRING_FUNCTIONS', 'SUBSTRING(string FROM integer1 [ FOR integer2 ])',
        ...
        1, '2021-02-22 15:29:35', '2023-12-28 00:08:58', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
...
VALUES (130, 'Function', 'FUN_UDF', 'STRING_FUNCTIONS', 'CHAR_LENGTH(string)', '返回STRING中的字符数。',
        'CHAR_LENGTH(${1:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2023-12-28 00:08:58', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (131, 'Function', 'FUN_UDF', 'STRING_FUNCTIONS', 'CHARACTER_LENGTH(string)', '返回STRING中的字符数。',
        'CHARACTER_LENGTH(${1:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2023-12-28 00:08:58', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (132, 'Function', 'FUN_UDF', 'TIME_FUNCTION', 'DATE string', '返回以“ yyyy-MM-dd”形式从STRING解析的SQL日期。',
        'DATE(${1:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2023-12-28 00:08:59', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (133, 'Function', 'FUN_UDF', 'TIME_FUNCTION', 'TIME string', '返回以“ HH：mm：ss”的形式从STRING解析的SQL时间。',
        'TIME(${1:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2023-12-28 00:08:59', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
...
VALUES (135, 'Function', 'FUN_UDF', 'TIME_FUNCTION', 'INTERVAL string range',
        ...
        'INTERVAL ${1:} range', '1.12', 0, 1, '2021-02-22 15:29:35', '2023-12-28 00:08:59', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
...
VALUES (138, 'Function', 'FUN_UDF', 'TIME_FUNCTION', 'CURRENT_TIMESTAMP', '返回UTC时区内的当前SQL时间戳。',
        'CURRENT_TIMESTAMP', '1.12', 0, 1, '2021-02-22 15:29:35', '2023-12-28 00:08:59', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (139, 'Function', 'FUN_UDF', 'TIME_FUNCTION', 'LOCALTIME', '返回本地时区的当前SQL时间。', 'LOCALTIME', '1.12', 0,
        1, '2021-02-22 15:29:35', '2023-12-28 00:08:59', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
...
VALUES (142, 'Function', 'FUN_UDF', 'TIME_FUNCTION', 'YEAR(date)',
        '返回SQL date日期的年份。等价于EXTRACT(YEAR FROM date)。', 'YEAR(${1:})', '1.12', 0, 1, '2021-02-22 15:29:35',
        '2023-12-28 00:08:59', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
...
VALUES (145, 'Function', 'FUN_UDF', 'TIME_FUNCTION', 'WEEK(date)',
        ...
        0, 1, '2021-02-22 15:46:48', '2023-12-28 00:08:59', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
...
VALUES (149, 'Function', 'FUN_UDF', 'TIME_FUNCTION', 'HOUR(timestamp)',
        ...
        '1.12', 0, 1, '2021-02-22 15:46:48', '2023-12-28 00:08:59', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
...
VALUES (151, 'Function', 'FUN_UDF', 'TIME_FUNCTION', 'SECOND(timestamp)',
        ...
        1, '2021-02-22 15:46:48', '2023-12-28 00:08:59', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
...
VALUES (154, 'Function', 'FUN_UDF', 'TIME_FUNCTION', '(timepoint1, temporal1) OVERLAPS (timepoint2, temporal2)',
        ...
        '(${1:} , ${1:}) OVERLAPS (${2:} , ${2:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2023-12-28 00:08:59', null,
        null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (155, 'Function', 'FUN_UDF', 'TIME_FUNCTION', 'DATE_FORMAT(timestamp, string)',
        ...
        'DATE_FORMAT(${1:}, ''yyyy-MM-dd'')', '1.12', 0, 1, '2021-02-22 15:46:48', '2023-12-28 00:08:59', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (156, 'Function', 'FUN_UDF', 'TIME_FUNCTION', 'TIMESTAMPADD(timeintervalunit, interval, timepoint)',
        ...
        'TIMESTAMPADD(${1:} , ${2:} , ${3:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2023-12-28 00:08:59', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (157, 'Function', 'FUN_UDF', 'TIME_FUNCTION', 'TIMESTAMPDIFF(timepointunit, timepoint1, timepoint2)',
        ...
        'TIMESTAMPDIFF(${1:} , ${2:} , ${3:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2023-12-28 00:08:59', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
...
VALUES (164, 'Function', 'FUN_UDF', 'TIME_FUNCTION', 'NOW()', '返回UTC时区内的当前SQL时间戳。仅在blink planner中支持。',
        'NOW()', '1.12', 0, 1, '2021-02-22 15:46:48', '2023-12-28 00:08:59', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
...
VALUES (173, 'Function', 'FUN_UDF', 'TYPE_CONVER_FUNCTION', 'CAST(value AS type)', '返回一个要转换为type类型的新值。',
        'CAST(${1:} AS ${2:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2023-12-28 00:08:59', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (174, 'Function', 'FUN_UDF', 'COLLECTION_FUNCTION', 'CARDINALITY(array)', '返回数组中元素的数量。',
        'CARDINALITY(${1:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2023-12-28 00:08:59', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
...
VALUES (178, 'Function', 'FUN_UDF', 'COLLECTION_FUNCTION', 'map ‘[’ value ‘]’', '返回map中key value指定的值。',
        'map[${1:}]', '1.12', 0, 1, '2021-02-22 15:46:48', '2023-12-28 00:08:59', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
...
(value1 [, value2]*)', '返回从值列表(value1, value2，…)创建的行。', '(${1:})', '1.12', 0, 1, '2021-02-22 15:46:48',
        '2023-12-28 00:08:59', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (182, 'Function', 'FUN_UDF', 'VALUE_CONSTRUCTION_FUNCTION', 'explicit ROW constructor
ROW(value1 [, value2]*)', '返回从值列表(value1, value2，…)创建的行。', 'ROW(${1:}) ', '1.12', 0, 1, '2021-02-22 15:46:48',
        '2023-12-28 00:08:59', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
...
VALUES (184, 'Function', 'FUN_UDF', 'VALUE_ACCESS_FUNCTION', 'tableName.compositeType.*',
        ...
        'tableName.compositeType.*', '1.12', 0, 1, '2021-02-22 15:46:48', '2023-12-28 00:08:59', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (185, 'Function', 'FUN_UDF', 'GROUP_FUNCTION', 'GROUP_ID()', '返回唯一标识分组键组合的整数', 'GROUP_ID()',
        '1.12', 0, 1, '2021-02-22 15:46:48', '2023-12-28 00:09:00', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
...
VALUES (189, 'Function', 'FUN_UDF', 'HASH_FUNCTION', 'SHA224(string)',
        ...
        0, 1, '2021-02-22 15:46:48', '2023-12-28 00:09:00', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
...
VALUES (193, 'Function', 'FUN_UDF', 'HASH_FUNCTION', 'SHA2(string, hashLength)',
        ...
        'SHA2(${1:}, ${2:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2023-12-28 00:09:00', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
...
VALUES (196, 'Function', 'FUN_UDF', 'AGGREGATE_FUNCTION', 'AVG([ ALL | DISTINCT ] expression)',
        ...
        'AVG(${1:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2023-12-28 00:09:00', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (197, 'Function', 'FUN_UDF', 'AGGREGATE_FUNCTION', 'SUM([ ALL | DISTINCT ] expression)',
        ...
        1, '2021-02-22 15:46:48', '2023-12-28 00:09:00', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
...
VALUES (200, 'Function', 'FUN_UDF', 'AGGREGATE_FUNCTION', 'STDDEV_POP([ ALL | DISTINCT ] expression)',
        ...
        'STDDEV_POP(${1:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2023-12-28 00:09:00', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (201, 'Function', 'FUN_UDF', 'AGGREGATE_FUNCTION', 'STDDEV_SAMP([ ALL | DISTINCT ] expression)',
        ...
        'STDDEV_SAMP(${1:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2023-12-28 00:09:00', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (202, 'Function', 'FUN_UDF', 'AGGREGATE_FUNCTION', 'VAR_POP([ ALL | DISTINCT ] expression)',
        ...
        'VAR_POP(${1:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2023-12-28 00:09:00', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (203, 'Function', 'FUN_UDF', 'AGGREGATE_FUNCTION', 'VAR_SAMP([ ALL | DISTINCT ] expression)',
        ...
        'VAR_SAMP(${1:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2023-12-28 00:09:00', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (204, 'Function', 'FUN_UDF', 'AGGREGATE_FUNCTION', 'COLLECT([ ALL | DISTINCT ] expression)',
        ...
        'COLLECT(${1:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2023-12-28 00:09:00', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
...
VALUES (217, 'Function', 'FUN_UDF', 'TABLE_AGGREGATE_FUNCTION', 'TO_MAP(string1,object2[, string3])',
        ...
        'TO_MAP(${1:})', '1.12', 8, 1, '2021-05-20 19:59:22', '2023-12-28 00:10:10', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
...
VALUES (234, 'Reference', 'FUN_UDF', 'OTHER_FUNCTION', 'ADD JAR', 'ADD JAR', 'ADD JAR ${1:}; -- str path ',
        'All Versions', 0, 1, '2023-10-31 16:19:52', '2023-12-28 00:02:02', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
...
VALUES (236, 'Function', 'Other', 'Other', 'SHOW FRAGMENT var1', 'SHOW FRAGMENT var1', 'SHOW FRAGMENT ${1:};',
        'All Versions', 0, 1, '2023-10-31 16:21:23', '2023-12-28 09:57:54', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
...
VALUES (239, 'Reference', 'FUN_UDF', 'OTHER_FUNCTION', 'PRINT tablename', 'PRINT table data', 'PRINT ${1:}',
        'All Versions', 0, 1, '2023-10-31 16:30:22', '2023-12-28 00:09:39', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
...
AS SELECT id, name, age FROM source_table WHERE mod(id, 10) = 0;', 'All Versions', 0, 1, '2023-10-31 16:37:33',
...
AS SELECT id, name, age FROM source_table WHERE mod(id, 10) = 0;', 'All Versions', 0, 1, '2023-10-31 16:41:46',
        '2023-12-28 00:02:57', null, null);
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
...
INSERT INTO dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (245, 'Property', 'FLINK_OPTIONS', '', 'checkpoint config', 'checkpoint config', '-- 声明一些调优参数 (checkpoint 等相关配置)
