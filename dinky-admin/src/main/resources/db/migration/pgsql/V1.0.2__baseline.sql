...
CREATE TABLE IF NOT EXISTS public.dinky_alert_group
(
...
COMMENT
    ON COLUMN public.dinky_alert_group.id IS 'id';
COMMENT
    ON COLUMN public.dinky_alert_group.name IS 'alert group name';
COMMENT
    ON COLUMN public.dinky_alert_group.tenant_id IS 'tenant id';
COMMENT
    ON COLUMN public.dinky_alert_group.alert_instance_ids IS 'Alert instance IDS';
COMMENT
    ON COLUMN public.dinky_alert_group.note IS 'note';
COMMENT
    ON COLUMN public.dinky_alert_group.enabled IS 'is enable';
COMMENT
    ON COLUMN public.dinky_alert_group.create_time IS 'create time';
COMMENT
    ON COLUMN public.dinky_alert_group.update_time IS 'update time';
COMMENT
    ON COLUMN public.dinky_alert_group.creator IS 'creator user id';
COMMENT
    ON COLUMN public.dinky_alert_group.updater IS 'updater user id';
COMMENT
    ON TABLE public.dinky_alert_group IS 'Alert group';

CREATE OR REPLACE TRIGGER set_update_time_dinky_alert_group
    BEFORE UPDATE
    ON public.dinky_alert_group
    FOR EACH ROW
EXECUTE FUNCTION trigger_set_timestamp();


-- ----------------------------
-- Table structure for public.dinky_alert_history
-- ----------------------------


CREATE TABLE IF NOT EXISTS public.dinky_alert_history
(
    id              SERIAL PRIMARY KEY NOT NULL,
    tenant_id       INT                NOT NULL DEFAULT 1,
...
COMMENT
    ON COLUMN public.dinky_alert_history.id IS 'id';
COMMENT
    ON COLUMN public.dinky_alert_history.tenant_id IS 'tenant id';
COMMENT
    ON COLUMN public.dinky_alert_history.alert_group_id IS 'Alert group ID';
COMMENT
    ON COLUMN public.dinky_alert_history.job_instance_id IS 'job instance ID';
COMMENT
    ON COLUMN public.dinky_alert_history.title IS 'alert title';
COMMENT
    ON COLUMN public.dinky_alert_history.content IS 'content description';
COMMENT
    ON COLUMN public.dinky_alert_history.status IS 'alert status';
COMMENT
    ON COLUMN public.dinky_alert_history.log IS 'log';
COMMENT
    ON COLUMN public.dinky_alert_history.create_time IS 'create time';
COMMENT
    ON COLUMN public.dinky_alert_history.update_time IS 'update time';
COMMENT
    ON TABLE public.dinky_alert_history IS 'Alert history';

CREATE OR REPLACE TRIGGER set_update_time_dinky_alert_history
    BEFORE UPDATE
    ON public.dinky_alert_history
    FOR EACH ROW
EXECUTE FUNCTION trigger_set_timestamp();
...
CREATE TABLE IF NOT EXISTS public.dinky_alert_instance
(
    id          SERIAL PRIMARY KEY NOT NULL,
    name        VARCHAR(50)        NOT NULL,
    tenant_id   INT                NOT NULL DEFAULT 1,
...
COMMENT
    ON COLUMN public.dinky_alert_instance.id IS 'id';
COMMENT
    ON COLUMN public.dinky_alert_instance.name IS 'alert instance name';
COMMENT
    ON COLUMN public.dinky_alert_instance.tenant_id IS 'tenant id';
COMMENT
    ON COLUMN public.dinky_alert_instance.type IS 'alert instance type such as: DingTalk,Wechat(Webhook,app) Feishu ,email';
COMMENT
    ON COLUMN public.dinky_alert_instance.params IS 'configuration';
COMMENT
    ON COLUMN public.dinky_alert_instance.enabled IS 'is enable';
COMMENT
    ON COLUMN public.dinky_alert_instance.create_time IS 'create time';
COMMENT
    ON COLUMN public.dinky_alert_instance.update_time IS 'update time';
COMMENT
    ON COLUMN public.dinky_alert_instance.creator IS 'creator user id';
COMMENT
    ON COLUMN public.dinky_alert_instance.updater IS 'updater user id';
COMMENT
    ON TABLE public.dinky_alert_instance IS 'Alert instance';


CREATE OR REPLACE TRIGGER set_update_time_dinky_alert_instance
    BEFORE UPDATE
    ON public.dinky_alert_instance
    FOR EACH ROW
EXECUTE FUNCTION trigger_set_timestamp();


-- ----------------------------
-- Table structure for public.dinky_catalogue
-- ----------------------------


CREATE TABLE IF NOT EXISTS public.dinky_catalogue
(
    id          SERIAL PRIMARY KEY NOT NULL,
    tenant_id   INT                NOT NULL DEFAULT 1,
...
COMMENT
    ON COLUMN public.dinky_catalogue.id IS 'ID';
COMMENT
    ON COLUMN public.dinky_catalogue.tenant_id IS 'tenant id';
COMMENT
    ON COLUMN public.dinky_catalogue.task_id IS 'Job ID';
COMMENT
    ON COLUMN public.dinky_catalogue.name IS 'Job Name';
COMMENT
    ON COLUMN public.dinky_catalogue.type IS 'Job Type';
COMMENT
    ON COLUMN public.dinky_catalogue.parent_id IS 'parent ID';
COMMENT
    ON COLUMN public.dinky_catalogue.enabled IS 'is enable';
COMMENT
    ON COLUMN public.dinky_catalogue.is_leaf IS 'is leaf node';
COMMENT
    ON COLUMN public.dinky_catalogue.create_time IS 'create time';
COMMENT
    ON COLUMN public.dinky_catalogue.update_time IS 'update time';
COMMENT
    ON COLUMN public.dinky_catalogue.creator IS 'creator user id';
COMMENT
    ON COLUMN public.dinky_catalogue.updater IS 'updater user id';
COMMENT
    ON TABLE public.dinky_catalogue IS 'catalogue';


CREATE OR REPLACE TRIGGER set_update_time_dinky_catalogue
    BEFORE UPDATE
    ON public.dinky_catalogue
    FOR EACH ROW
EXECUTE FUNCTION trigger_set_timestamp();


-- ----------------------------
-- Table structure for public.dinky_cluster
-- ----------------------------

CREATE TABLE IF NOT EXISTS public.dinky_cluster
(
    id                       SERIAL PRIMARY KEY NOT NULL,
    tenant_id                INT                NOT NULL DEFAULT 1,
    ...
    status                   INT                         DEFAULT NULL,
    note                     VARCHAR(255)                DEFAULT NULL,
    auto_registers           BOOLEAN                     DEFAULT FALSE,
...
CREATE UNIQUE INDEX IF NOT EXISTS cluster_un_idx1 ON public.dinky_cluster (name, tenant_id);

COMMENT
    ON COLUMN public.dinky_cluster.id IS 'ID';
COMMENT
    ON COLUMN public.dinky_cluster.tenant_id IS 'tenant id';
COMMENT
    ON COLUMN public.dinky_cluster.name IS 'cluster instance name';
COMMENT
    ON COLUMN public.dinky_cluster.alias IS 'cluster instance alias';
COMMENT
    ON COLUMN public.dinky_cluster.type IS 'cluster types';
COMMENT
    ON COLUMN public.dinky_cluster.hosts IS 'cluster hosts';
COMMENT
    ON COLUMN public.dinky_cluster.job_manager_host IS 'Job Manager Host';
COMMENT
    ON COLUMN public.dinky_cluster.version IS 'version';
COMMENT
    ON COLUMN public.dinky_cluster.status IS 'cluster status';
COMMENT
    ON COLUMN public.dinky_cluster.note IS 'note';
COMMENT
    ON COLUMN public.dinky_cluster.auto_registers IS 'is auto registration';
COMMENT
    ON COLUMN public.dinky_cluster.cluster_configuration_id IS 'cluster configuration id';
COMMENT
    ON COLUMN public.dinky_cluster.task_id IS 'task ID';
COMMENT
    ON COLUMN public.dinky_cluster.enabled IS 'is enable';
COMMENT
    ON COLUMN public.dinky_cluster.create_time IS 'create time';
COMMENT
    ON COLUMN public.dinky_cluster.update_time IS 'update time';
COMMENT
    ON COLUMN public.dinky_cluster.creator IS 'creator user id';
COMMENT
    ON COLUMN public.dinky_cluster.updater IS 'updater user id';
COMMENT
    ON TABLE public.dinky_cluster IS 'cluster instance management';


CREATE OR REPLACE TRIGGER set_update_time_dinky_cluster
    BEFORE UPDATE
    ON public.dinky_cluster
    FOR EACH ROW
EXECUTE FUNCTION trigger_set_timestamp();

-- ----------------------------
-- Table structure for public.dinky_cluster_configuration
-- ----------------------------

CREATE TABLE IF NOT EXISTS public.dinky_cluster_configuration
(
    id           SERIAL PRIMARY KEY NOT NULL,
    tenant_id    INT                NOT NULL DEFAULT 1,
    name         VARCHAR(255)       NOT NULL,
...
CREATE UNIQUE INDEX IF NOT EXISTS cluster_configuration_un_idx1 ON public.dinky_cluster_configuration (name, tenant_id);

COMMENT
    ON TABLE public.dinky_cluster_configuration IS 'cluster configuration management';
COMMENT
    ON COLUMN public.dinky_cluster_configuration.id IS 'ID';
COMMENT
    ON COLUMN public.dinky_cluster_configuration.tenant_id IS 'tenant id';
COMMENT
    ON COLUMN public.dinky_cluster_configuration.name IS 'cluster configuration name';
COMMENT
    ON COLUMN public.dinky_cluster_configuration.type IS 'cluster type';
COMMENT
    ON COLUMN public.dinky_cluster_configuration.config_json IS 'json of configuration';
COMMENT
    ON COLUMN public.dinky_cluster_configuration.is_available IS 'is available';
COMMENT
    ON COLUMN public.dinky_cluster_configuration.note IS 'note';
COMMENT
    ON COLUMN public.dinky_cluster_configuration.enabled IS 'is enable';
COMMENT
    ON COLUMN public.dinky_cluster_configuration.create_time IS 'create time';
COMMENT
    ON COLUMN public.dinky_cluster_configuration.update_time IS 'update time';
COMMENT
    ON COLUMN public.dinky_cluster_configuration.creator IS 'creator user id';
COMMENT
    ON COLUMN public.dinky_cluster_configuration.updater IS 'updater user id';


CREATE OR REPLACE TRIGGER set_update_time_dinky_cluster_configuration
    BEFORE UPDATE
    ON public.dinky_cluster_configuration
    FOR EACH ROW
...
-- ----------------------------
-- Table structure for public.dinky_database
-- ----------------------------

CREATE TABLE IF NOT EXISTS public.dinky_database
(
    id             SERIAL PRIMARY KEY NOT NULL,
    tenant_id      INT                NOT NULL DEFAULT 1,
...
CREATE UNIQUE INDEX IF NOT EXISTS  database_un_idx1 ON public.dinky_database (name, tenant_id);

COMMENT
    ON TABLE public.dinky_database IS 'database management';
COMMENT
    ON COLUMN public.dinky_database.id IS 'ID';
COMMENT
    ON COLUMN public.dinky_database.tenant_id IS 'tenant id';
COMMENT
    ON COLUMN public.dinky_database.name IS 'database name';
COMMENT
    ON COLUMN public.dinky_database.group_name IS 'database belong group name';
COMMENT
    ON COLUMN public.dinky_database.type IS 'database type';
COMMENT
    ON COLUMN public.dinky_database.connect_config IS 'connect config';
COMMENT
    ON COLUMN public.dinky_database.note IS 'note';
COMMENT
    ON COLUMN public.dinky_database.flink_config IS 'Flink configuration';
COMMENT
    ON COLUMN public.dinky_database.flink_template IS 'Flink template';
COMMENT
    ON COLUMN public.dinky_database.db_version IS 'version，such as: 11g of oracle ，2.2.3 of hbase';
COMMENT
    ON COLUMN public.dinky_database.status IS 'heartbeat status';
COMMENT
    ON COLUMN public.dinky_database.health_time IS 'last heartbeat time of trigger';
COMMENT
    ON COLUMN public.dinky_database.heartbeat_time IS 'last heartbeat time';
COMMENT
    ON COLUMN public.dinky_database.enabled IS 'is enable';
COMMENT
    ON COLUMN public.dinky_database.create_time IS 'create time';
COMMENT
    ON COLUMN public.dinky_database.update_time IS 'update time';
COMMENT
    ON COLUMN public.dinky_database.creator IS 'creator user id';
COMMENT
    ON COLUMN public.dinky_database.updater IS 'updater user id';



CREATE OR REPLACE TRIGGER set_update_time_dinky_database
    BEFORE UPDATE
    ON public.dinky_database
    FOR EACH ROW
EXECUTE FUNCTION trigger_set_timestamp();
...
-- ----------------------------
-- Table structure for public.dinky_flink_document
-- ----------------------------

CREATE TABLE IF NOT EXISTS public.dinky_flink_document
(
    id          SERIAL PRIMARY KEY NOT NULL,
...
COMMENT
    ON TABLE public.dinky_flink_document IS 'flink document management';
COMMENT
    ON COLUMN public.dinky_flink_document.id IS 'id';
COMMENT
    ON COLUMN public.dinky_flink_document.category IS 'document category';
COMMENT
    ON COLUMN public.dinky_flink_document.type IS 'document type';
COMMENT
    ON COLUMN public.dinky_flink_document.subtype IS 'document subtype';
COMMENT
    ON COLUMN public.dinky_flink_document.name IS 'document name';
COMMENT
    ON COLUMN public.dinky_flink_document.description IS 'document description';
COMMENT
    ON COLUMN public.dinky_flink_document.fill_value IS 'fill value';
COMMENT
    ON COLUMN public.dinky_flink_document.version IS 'document version such as:(flink1.12, flink1.13, flink1.14, flink1.15, flink1.16, flink1.17, flink1.18)';
COMMENT
    ON COLUMN public.dinky_flink_document.like_num IS 'like number';
COMMENT
    ON COLUMN public.dinky_flink_document.enabled IS 'is enable';
COMMENT
    ON COLUMN public.dinky_flink_document.create_time IS 'create time';
COMMENT
    ON COLUMN public.dinky_flink_document.update_time IS 'update time';
COMMENT
    ON COLUMN public.dinky_flink_document.creator IS 'creator user id';
COMMENT
    ON COLUMN public.dinky_flink_document.updater IS 'updater user id';



CREATE OR REPLACE TRIGGER set_update_time_dinky_flink_document
    BEFORE UPDATE
    ON public.dinky_flink_document
    FOR EACH ROW
EXECUTE FUNCTION trigger_set_timestamp();

--
-- Data for Name: public.dinky_flink_document; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
VALUES (1, 'Variable', 'FLINK_OPTIONS', '', 'set table.exec.async-lookup.buffer-capacity', '异步查找连接可以触发的最大异步操作的操作数。
The max number of async i/o operation that the async lookup join can trigger.',
        'Set ''table.exec.async-lookup.buffer-capacity''=''100'';', '1.14', 0, true, '2022-01-20 15:00:00',
        '2023-12-27 23:58:09', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (2, 'Variable', 'FLINK_OPTIONS', '', 'set table.exec.async-lookup.timeout', '异步操作完成的超时时间。
The async timeout for the asynchronous operation to complete.', 'Set ''table.exec.async-lookup.timeout''=''3 min'';',
        '1.14', 0, true, '2022-01-20 15:00:00', '2023-12-27 23:58:09', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (3, 'Variable', 'FLINK_OPTIONS', '', 'set table.exec.disabled-operators', '禁用指定operators，用逗号分隔
Mainly for testing. A comma-separated list of operator names, each name represents a kind of disabled operator. Operators that can be disabled include "NestedLoopJoin", "ShuffleHashJoin", "BroadcastHashJoin", "SortMergeJoin", "HashAgg", "SortAgg". By default no operator is disabled.',
        'Set ''table.exec.disabled-operators''=''SortMergeJoin'';', '1.14', 0, true, '2022-01-20 15:00:00',
        '2023-12-27 23:58:09', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (4, 'Variable', 'FLINK_OPTIONS', '', 'set table.exec.mini-batch.allow-latency',
        ...
        'Set ''table.exec.mini-batch.allow-latency''=''-1 ms'';', '1.14', 0, true, '2022-01-20 15:00:00',
        '2023-12-27 23:58:09', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (5, 'Variable', 'FLINK_OPTIONS', '', 'set table.exec.mini-batch.enabled',
        ...
        'Set ''table.exec.mini-batch.enabled''=''false'';', '1.14', 0, true, '2022-01-20 15:00:00',
        '2023-12-27 23:58:09', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (6, 'Variable', 'FLINK_OPTIONS', '', 'set table.exec.mini-batch.size',
        ...
        'Set ''table.exec.mini-batch.size''=''-1'';', '1.14', 0, true, '2022-01-20 15:00:00', '2023-12-27 23:58:09',
        NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (7, 'Variable', 'FLINK_OPTIONS', '', 'set table.exec.resource.default-parallelism', '设置所有Operator的默认并行度。
Sets default parallelism for all operators (such as aggregate, join, filter) to run with parallel instances. This config has a higher priority than parallelism of StreamExecutionEnvironment (actually, this config overrides the parallelism of StreamExecutionEnvironment). A value of -1 indicates that no default parallelism is set, then it will fallback to use the parallelism of StreamExecutionEnvironment.',
        'Set ''table.exec.resource.default-parallelism''=''1'';', '1.14', 0, true, '2022-01-20 15:00:00',
        '2023-12-27 23:58:09', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (8, 'Variable', 'FLINK_OPTIONS', '', 'set table.exec.sink.not-null-enforcer', '对表的NOT NULL列约束强制执行不能将空值插入到表中。Flink支持“error”（默认）和“drop”强制行为
...
Possible values:
"ERROR"
"DROP"', 'Set ''table.exec.sink.not-null-enforcer''=''ERROR'';', '1.14', 0, true, '2022-01-20 15:00:00',
        '2023-12-27 23:58:09', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (9, 'Variable', 'FLINK_OPTIONS', '', 'set table.exec.sink.upsert-materialize', '由于分布式系统中 Shuffle 导致 ChangeLog 数据混乱，Sink 接收到的数据可能不是全局 upsert 的顺序。因此，在 upsert sink 之前添加 upsert materialize 运算符。它接收上游的变更日志记录并为下游生成一个 upsert 视图。默认情况下，当唯一键出现分布式无序时，会添加具体化操作符。您也可以选择不实现（NONE）或强制实现（FORCE）。
Possible values:
"NONE"
"FORCE"
"AUTO"', 'Set ''table.exec.sink.upsert-materialize''=''AUTO'';', '1.14', 0, true, '2022-01-20 15:00:00',
        '2023-12-27 23:58:09', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (10, 'Module', 'SQL_TEMPLATE', 'FlinkSql', 'create.table.kafka', 'kafka快速建表格式', 'CREATE TABLE Kafka_Table (
...
--可选: ''key.fields-prefix'' = ''k_'',', '1.14', 0, true, '2022-01-20 16:59:18', '2023-12-28 00:02:57', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (11, 'Module', 'SQL_TEMPLATE', 'FlinkSql', 'create.table.doris', 'Doris快速建表', 'CREATE TABLE doris_table (
    cid INT,
    sid INT,
    name STRING,
    cls STRING,
...
''username'' = ''root'',
''password''=''''
);', '1.14', 0, true, '2022-01-20 17:08:00', '2023-12-28 00:02:57', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (12, 'Module', 'SQL_TEMPLATE', 'FlinkSql', 'create.table.jdbc', 'JDBC建表语句', 'CREATE TABLE JDBC_table (
  id BIGINT,
  name STRING,
  age INT,
  status BOOLEAN,
...
--可选: ''lookup.cache.ttl''=''1000s'',', '1.14', 0, true, '2022-01-20 17:15:26', '2023-12-28 00:02:57', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
...
);', '1.14', 0, true, '2022-01-20 17:18:54', '2023-12-28 00:03:53', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (14, 'Operator', 'SQL_TEMPLATE', 'FlinkSql', 'use.catalog.hive', '使用hive的catalog', 'USE CATALOG hive;',
        '1.14', 0, true, '2022-01-20 17:22:53', '2023-12-28 00:03:53', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (15, 'Operator', 'SQL_TEMPLATE', 'FlinkSql', 'use.catalog.default', '使用default的catalog',
        'USE CATALOG default_catalog;', '1.14', 0, true, '2022-01-20 17:23:48', '2023-12-28 00:03:53', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (16, 'Variable', 'FLINK_OPTIONS', '', 'set dialect.hive', '使用hive方言', 'Set table.sql-dialect=hive;', '1.14',
        0, true, '2022-01-20 17:25:37', '2023-12-28 00:04:44', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (17, 'Variable', 'FLINK_OPTIONS', '', 'set dialect.default', '使用default方言', 'Set table.sql-dialect=default;',
        '1.14', 0, true, '2022-01-20 17:26:19', '2023-12-28 00:04:44', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (40, 'Function', 'FUN_UDF', 'COMPARE_FUNCTION', 'value NOT IN (sub-query)',
        '如果value不存在于子查询中，则返回TRUE。', '${1:} NOT IN (${2:})', '1.12', 0, true, '2021-02-22 14:44:26',
        '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (41, 'Function', 'FUN_UDF', 'LOGICAL_FUNCTION', 'boolean1 OR boolean2', '如果BOOLEAN1为TRUE或BOOLEAN2为TRUE，则返回TRUE。支持三值逻辑。

例如，true || Null(Types.BOOLEAN)返回TRUE。', '${1:} OR ${2:}', '1.12', 0, true, '2021-02-22 14:44:26',
        '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (18, 'Module', 'SQL_TEMPLATE', 'FlinkSql', 'create.stream.table.hive', '创建流式HIVE表', 'CREATE CATALOG hive WITH ( --创建hive的catalog
    ''type'' = ''hive'',
...
);', '1.14', 0, true, '2022-01-20 17:34:06', '2023-12-28 00:02:57', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (19, 'Module', 'SQL_TEMPLATE', 'FlinkSql', 'create.table.mysql_cdc', '创建Mysql_CDC表', 'CREATE TABLE mysql_cdc_table(
    cid INT,
    sid INT,
    cls STRING,
    score INT,
...
''table-name'' = ''mysql_cdc_table'');', '1.14', 0, true, '2022-01-20 17:49:14', '2023-12-28 00:02:57', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (20, 'Module', 'SQL_TEMPLATE', 'FlinkSql', 'create.table.hudi', '创建hudi表', 'CREATE TABLE hudi_table
(
...
);', '1.14', 0, true, '2022-01-20 17:56:50', '2023-12-28 00:02:57', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (21, 'Function', 'FUN_UDF', 'COMPARE_FUNCTION', 'value1 <> value2',
        '如果value1不等于value2 返回true; 如果value1或value2为NULL，则返回UNKNOWN 。', '${1:} <> ${2:}', '1.12', 4, true,
        '2021-02-22 10:05:38', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (22, 'Function', 'FUN_UDF', 'COMPARE_FUNCTION', 'value1 > value2',
        '如果value1大于value2 返回true; 如果value1或value2为NULL，则返回UNKNOWN 。', '${1:} > ${2:}', '1.12', 2, true,
        '2021-02-22 14:37:58', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (23, 'Function', 'FUN_UDF', 'COMPARE_FUNCTION', 'value1 >= value2',
        '如果value1大于或等于value2 返回true; 如果value1或value2为NULL，则返回UNKNOWN 。', '${1:} >= ${2:}', '1.12', 2,
        true, '2021-02-22 14:38:52', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (24, 'Function', 'FUN_UDF', 'COMPARE_FUNCTION', 'value1 < value2',
        '如果value1小于value2 返回true; 如果value1或value2为NULL，则返回UNKNOWN 。', '${1:} < ${2:}', '1.12', 0, true,
...
VALUES (25, 'Function', 'FUN_UDF', 'COMPARE_FUNCTION', 'value1 <= value2',
        ...
        true, '2021-02-22 14:39:40', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (26, 'Function', 'FUN_UDF', 'COMPARE_FUNCTION', 'value IS NULL', '如果value为NULL，则返回TRUE 。', '${1:} IS NULL',
        '1.12', 2, true, '2021-02-22 14:40:39', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (27, 'Function', 'FUN_UDF', 'COMPARE_FUNCTION', 'value IS NOT NULL', '如果value不为NULL，则返回TRUE 。',
        '${1:}  IS NOT NULL', '1.12', 0, true, '2021-02-22 14:41:26', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (28, 'Function', 'FUN_UDF', 'COMPARE_FUNCTION', 'value1 IS DISTINCT FROM value2',
        '如果两个值不相等则返回TRUE。NULL值在这里被视为相同的值。', '${1:} IS DISTINCT FROM ${2:}', '1.12', 0, true,
...
VALUES (29, 'Function', 'FUN_UDF', 'COMPARE_FUNCTION', 'value1 IS NOT DISTINCT FROM value2',
        '如果两个值相等则返回TRUE。NULL值在这里被视为相同的值。', '${1:} IS NOT DISTINCT FROM ${2:}', '1.12', 0, true,
...
VALUES (30, 'Function', 'FUN_UDF', 'COMPARE_FUNCTION', 'value1 BETWEEN [ ASYMMETRIC | SYMMETRIC ] value2 AND value3',
        '如果value1大于或等于value2和小于或等于value3 返回true', '${1:} BETWEEN ${2:} AND ${3:}', '1.12', 0, true,
...
VALUES (31, 'Function', 'FUN_UDF', 'COMPARE_FUNCTION',
        ...
        '${1:} NOT BETWEEN ${2:} AND ${3:}', '1.12', 0, true, '2021-02-22 14:44:26', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (32, 'Function', 'FUN_UDF', 'COMPARE_FUNCTION', 'string1 LIKE string2 [ ESCAPE char ]',
        ...
        0, true, '2021-02-22 14:44:26', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (33, 'Function', 'FUN_UDF', 'COMPARE_FUNCTION', 'string1 NOT LIKE string2 [ ESCAPE char ]',
        ...
        '1.12', 0, true, '2021-02-22 14:44:26', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (34, 'Function', 'FUN_UDF', 'COMPARE_FUNCTION', 'string1 SIMILAR TO string2 [ ESCAPE char ]',
        ...
        '${1:} SIMILAR TO ${2:}', '1.12', 0, true, '2021-02-22 14:44:26', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (35, 'Function', 'FUN_UDF', 'COMPARE_FUNCTION', 'string1 NOT SIMILAR TO string2 [ ESCAPE char ]',
        ...
        '${1:} NOT SIMILAR TO ${2:}', '1.12', 0, true, '2021-02-22 14:44:26', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (36, 'Function', 'FUN_UDF', 'COMPARE_FUNCTION', 'value1 IN (value2 [, value3]* )', '如果value1存在于给定列表（value2，value3，...）中，则返回TRUE 。

当（value2，value3，...）包含NULL，如果可以找到该元素，则返回TRUE，否则返回UNKNOWN。

如果value1为NULL，则始终返回UNKNOWN 。', '${1:} IN (${2:} )', '1.12', 0, true, '2021-02-22 14:44:26',
        '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (37, 'Function', 'FUN_UDF', 'COMPARE_FUNCTION', 'value1 NOT IN (value2 [, value3]* )', '如果value1不存在于给定列表（value2，value3，...）中，则返回TRUE 。

当（value2，value3，...）包含NULL，如果可以找到该元素，则返回TRUE，否则返回UNKNOWN。

如果value1为NULL，则始终返回UNKNOWN 。', '${1:} NOT IN (${2:})', '1.12', 0, true, '2021-02-22 14:44:26',
        '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (38, 'Function', 'FUN_UDF', 'COMPARE_FUNCTION', 'EXISTS (sub-query)', '如果value存在于子查询中，则返回TRUE。',
        'EXISTS (${1:})', '1.12', 0, true, '2021-02-22 14:44:26', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (42, 'Function', 'FUN_UDF', 'LOGICAL_FUNCTION', 'boolean1 AND boolean2', '如果BOOLEAN1和BOOLEAN2均为TRUE，则返回TRUE。支持三值逻辑。

例如，true && Null(Types.BOOLEAN)返回未知。', '${1:} AND ${2:}', '1.12', 0, true, '2021-02-22 14:44:26',
        '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (43, 'Function', 'FUN_UDF', 'LOGICAL_FUNCTION', 'NOT boolean', '如果BOOLEAN为FALSE，则返回TRUE ；如果BOOLEAN为TRUE，则返回FALSE 。

如果BOOLEAN为UNKNOWN，则返回UNKNOWN。', 'NOT ${1:} ', '1.12', 0, true, '2021-02-22 14:44:26', '2023-12-28 00:08:58', NULL,
        NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (44, 'Function', 'FUN_UDF', 'LOGICAL_FUNCTION', 'boolean IS FALSE',
        '如果BOOLEAN为FALSE，则返回TRUE ；如果BOOLEAN为TRUE或UNKNOWN，则返回FALSE 。', '${1:}  IS FALSE', '1.12', 0, true,
        '2021-02-22 14:44:26', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (45, 'Function', 'FUN_UDF', 'LOGICAL_FUNCTION', 'boolean IS NOT FALSE',
        '如果BOOLEAN为TRUE或UNKNOWN，则返回TRUE ；如果BOOLEAN为FALSE，则返回FALSE。', '${1:}  IS NOT FALSE', '1.12', 0,
        true, '2021-02-22 14:44:26', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (46, 'Function', 'FUN_UDF', 'LOGICAL_FUNCTION', 'boolean IS TRUE',
        '如果BOOLEAN为TRUE，则返回TRUE；如果BOOLEAN为FALSE或UNKNOWN，则返回FALSE 。', '${1:}  IS TRUE', '1.12', 0, true,
        '2021-02-22 14:44:26', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (47, 'Function', 'FUN_UDF', 'LOGICAL_FUNCTION', 'boolean IS NOT TRUE',
        '如果BOOLEAN为FALSE或UNKNOWN，则返回TRUE ；如果BOOLEAN为TRUE，则返回FALSE 。', '${1:}  IS NOT TRUE', '1.12', 0,
        true, '2021-02-22 14:44:26', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (48, 'Function', 'FUN_UDF', 'LOGICAL_FUNCTION', 'boolean IS UNKNOWN',
        '如果BOOLEAN为UNKNOWN，则返回TRUE ；如果BOOLEAN为TRUE或FALSE，则返回FALSE 。', '${1:}  IS UNKNOWN', '1.12', 0, true,
        '2021-02-22 14:44:26', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
...
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (50, 'Function', 'FUN_UDF', 'ARITHMETIC_FUNCTIONS', '+ numeric', '返回NUMERIC。', '+ ${1:} ', '1.12', 0, true,
        '2021-02-22 14:44:26', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (51, 'Function', 'FUN_UDF', 'ARITHMETIC_FUNCTIONS', '- numeric', '返回负数NUMERIC。', '- ${1:} ', '1.12', 0, true,
        '2021-02-22 14:44:26', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (52, 'Function', 'FUN_UDF', 'ARITHMETIC_FUNCTIONS', 'numeric1 + numeric2', '返回NUMERIC1加NUMERIC2。',
        '${1:}  + ${2:} ', '1.12', 0, true, '2021-02-22 14:44:26', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
...
VALUES (56, 'Function', 'FUN_UDF', 'ARITHMETIC_FUNCTIONS', 'numeric1 % numeric2',
        '返回NUMERIC1除以NUMERIC2的余数（模）。仅当numeric1为负数时，结果为负数。', '${1:}  % ${2:} ', '1.12', 0, true,
        '2021-02-22 14:44:26', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (57, 'Function', 'FUN_UDF', 'ARITHMETIC_FUNCTIONS', 'POWER(numeric1, numeric2)', '返回NUMERIC1的NUMERIC2 次幂。',
        'POWER(${1:} , ${2:})', '1.12', 0, true, '2021-02-22 14:44:26', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
...
VALUES (59, 'Function', 'FUN_UDF', 'ARITHMETIC_FUNCTIONS', 'MOD(numeric1, numeric2)',
        '返回numeric1除以numeric2的余数(模)。只有当numeric1为负数时，结果才为负数', 'MOD(${1:} , ${2:} )', '1.12', 0,
        true, '2021-02-22 14:44:26', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
...
VALUES (61, 'Function', 'FUN_UDF', 'ARITHMETIC_FUNCTIONS', 'LN(numeric)', '返回NUMERIC的自然对数（以e为底）。',
        'LN(${1:})', '1.12', 0, true, '2021-02-22 15:29:35', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (62, 'Function', 'FUN_UDF', 'ARITHMETIC_FUNCTIONS', 'LOG10(numeric)', '返回NUMERIC的以10为底的对数。',
        'LOG10(${1:})', '1.12', 0, true, '2021-02-22 15:29:35', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (63, 'Function', 'FUN_UDF', 'ARITHMETIC_FUNCTIONS', 'LOG2(numeric)', '返回NUMERIC的以2为底的对数。',
        'LOG2(${1:})', '1.12', 0, true, '2021-02-22 15:29:35', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (64, 'Function', 'FUN_UDF', 'ARITHMETIC_FUNCTIONS', 'EXP(numeric)', '返回e 的 NUMERIC 次幂。', 'EXP(${1:})',
        '1.12', 0, true, '2021-02-22 15:29:35', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (65, 'Function', 'FUN_UDF', 'ARITHMETIC_FUNCTIONS', 'FLOOR(numeric)',
        '向下舍入NUMERIC，并返回小于或等于NUMERIC的最大整数。', 'FLOOR(${1:})', '1.12', 0, true, '2021-02-22 15:29:35',
        '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (66, 'Function', 'FUN_UDF', 'ARITHMETIC_FUNCTIONS', 'SIN(numeric)', '返回NUMERIC的正弦值。', 'SIN(${1:})', '1.12',
        0, true, '2021-02-22 15:29:35', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (67, 'Function', 'FUN_UDF', 'ARITHMETIC_FUNCTIONS', 'SINH(numeric)', '返回NUMERIC的双曲正弦值。

返回类型为DOUBLE。', 'SINH(${1:})', '1.12', 0, true, '2021-02-22 15:29:35', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
...
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (70, 'Function', 'FUN_UDF', 'ARITHMETIC_FUNCTIONS', 'TANH(numeric)', '返回NUMERIC的双曲正切值。

返回类型为DOUBLE。', 'TANH(${1:})', '1.12', 0, true, '2021-02-22 15:29:35', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
...
VALUES (75, 'Function', 'FUN_UDF', 'ARITHMETIC_FUNCTIONS', 'ATAN2(numeric1, numeric2)',
        '返回坐标的反正切（NUMERIC1，NUMERIC2）。', 'ATAN2(${1:}, ${2:})', '1.12', 0, true, '2021-02-22 15:29:35',
        '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (76, 'Function', 'FUN_UDF', 'ARITHMETIC_FUNCTIONS', 'COSH(numeric)', '返回NUMERIC的双曲余弦值。

返回值类型为DOUBLE。', 'COSH(${1:})', '1.12', 0, true, '2021-02-22 15:29:35', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (77, 'Function', 'FUN_UDF', 'ARITHMETIC_FUNCTIONS', 'DEGREES(numeric)', '返回弧度NUMERIC的度数表示形式',
        'DEGREES(${1:})', '1.12', 0, true, '2021-02-22 15:29:35', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (78, 'Function', 'FUN_UDF', 'ARITHMETIC_FUNCTIONS', 'RADIANS(numeric)', '返回度数NUMERIC的弧度表示。',
        'RADIANS(${1:})', '1.12', 0, true, '2021-02-22 15:29:35', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
...
VALUES (80, 'Function', 'FUN_UDF', 'ARITHMETIC_FUNCTIONS', 'ROUND(numeric, integer)',
        '返回一个数字，四舍五入为NUMERIC的INT小数位。', 'ROUND(${1:} , ${2:})', '1.12', 0, true, '2021-02-22 15:29:35',
        '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
...
VALUES (83, 'Function', 'FUN_UDF', 'ARITHMETIC_FUNCTIONS', 'RAND()', '返回介于0.0（含）和1.0（不含）之间的伪随机双精度值。',
        'RAND()', '1.12', 0, true, '2021-02-22 15:29:35', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (84, 'Function', 'FUN_UDF', 'ARITHMETIC_FUNCTIONS', 'RAND(integer)', '返回带有初始种子INTEGER的介于0.0（含）和1.0（不含）之间的伪随机双精度值。

如果两个RAND函数具有相同的初始种子，它们将返回相同的数字序列。', 'RAND(${1:})', '1.12', 0, true, '2021-02-22 15:29:35',
        '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (85, 'Function', 'FUN_UDF', 'ARITHMETIC_FUNCTIONS', 'RAND_INTEGER(integer)',
        '返回介于0（含）和INTEGER（不含）之间的伪随机整数值。', 'RAND_INTEGER(${1:})', '1.12', 0, true,
        '2021-02-22 15:29:35', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (86, 'Function', 'FUN_UDF', 'ARITHMETIC_FUNCTIONS', 'RAND_INTEGER(integer1, integer2)', '返回介于0（含）和INTEGER2（不含）之间的伪随机整数值，其初始种子为INTEGER1。

如果两个randInteger函数具有相同的初始种子和边界，它们将返回相同的数字序列。', 'RAND_INTEGER(${1:} , ${2:})', '1.12', 0,
        true, '2021-02-22 15:29:35', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (87, 'Function', 'FUN_UDF', 'ARITHMETIC_FUNCTIONS', 'UUID()', '根据RFC 4122 type 4（伪随机生成）UUID返回UUID（通用唯一标识符）字符串

（例如，“ 3d3c68f7-f608-473f-b60c-b0c44ad4cc4e”）。使用加密强度高的伪随机数生成器生成UUID。', 'UUID()', '1.12', 0, true,
        '2021-02-22 15:29:35', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (88, 'Function', 'FUN_UDF', 'ARITHMETIC_FUNCTIONS', 'BIN(integer)', '以二进制格式返回INTEGER的字符串表示形式。如果INTEGER为NULL，则返回NULL。

例如，4.bin()返回“ 100”并12.bin()返回“ 1100”。', 'BIN(${1:})', '1.12', 0, true, '2021-02-22 15:29:35',
        '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
...
例如，数字20导致“ 14”，数字100导致“ 64”，字符串“ hello，world”导致“ 68656C6C6F2C776F726C64”。', 'HEX(${1:})', '1.12', 0,
        true, '2021-02-22 15:29:35', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (90, 'Function', 'FUN_UDF', 'ARITHMETIC_FUNCTIONS', 'TRUNCATE(numeric1, integer2)',
        '返回一个小数点后被截断为integer2位的数字。', 'TRUNCATE(${1:}, ${2:})', '1.12', 0, true, '2021-02-22 15:29:35',
        '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
...
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (92, 'Function', 'FUN_UDF', 'ARITHMETIC_FUNCTIONS', 'LOG(numeric1)', '如果不带参数调用，则返回NUMERIC1的自然对数。当使用参数调用时，将NUMERIC1的对数返回到基数NUMERIC2。

注意：当前，NUMERIC1必须大于0，而NUMERIC2必须大于1。', 'LOG(${1:})', '1.12', 0, true, '2021-02-22 15:29:35',
        '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (93, 'Function', 'FUN_UDF', 'ARITHMETIC_FUNCTIONS', 'LOG(numeric1, numeric2)', '如果不带参数调用，则返回NUMERIC1的自然对数。当使用参数调用时，将NUMERIC1的对数返回到基数NUMERIC2。

注意：当前，NUMERIC1必须大于0，而NUMERIC2必须大于1。', 'LOG(${1:}, ${2:})', '1.12', 0, true, '2021-02-22 15:29:35',
        '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (94, 'Function', 'FUN_UDF', 'ARITHMETIC_FUNCTIONS', 'CEIL(numeric)',
        '将NUMERIC向上舍入，并返回大于或等于NUMERIC的最小整数。', 'CEIL(${1:})', '1.12', 0, true, '2021-02-22 15:29:35',
        '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (95, 'Function', 'FUN_UDF', 'ARITHMETIC_FUNCTIONS', 'CEILING(numeric)',
        '将NUMERIC向上舍入，并返回大于或等于NUMERIC的最小整数。', 'CEILING(${1:})', '1.12', 0, true,
        '2021-02-22 15:29:35', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (96, 'Function', 'FUN_UDF', 'STRING_FUNCTIONS', 'string1 || string2', '返回string1和string2的连接。',
        '${1:} || ${2:}', '1.12', 0, true, '2021-02-22 15:29:35', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
...
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (99, 'Function', 'FUN_UDF', 'STRING_FUNCTIONS', 'POSITION(string1 IN string2)', '返回STRING1在STRING2中第一次出现的位置（从1开始）；

如果在STRING2中找不到STRING1，则返回0 。', 'POSITION(${1:} IN ${2:})', '1.12', 0, true, '2021-02-22 15:29:35',
        '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (100, 'Function', 'FUN_UDF', 'STRING_FUNCTIONS', 'TRIM([ BOTH | LEADING | TRAILING ] string1 FROM string2)',
        '返回一个字符串，该字符串从STRING中删除前导和/或结尾字符。', 'TRIM(${1:} FROM ${2:})', '1.12', 0, true,
        '2021-02-22 15:29:35', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (101, 'Function', 'FUN_UDF', 'STRING_FUNCTIONS', 'LTRIM(string)', '返回一个字符串，该字符串从STRING除去左空格。

例如，" This is a test String.".ltrim()返回“This is a test String.”。', 'LTRIM(${1:})', '1.12', 0, true,
        '2021-02-22 15:29:35', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (102, 'Function', 'FUN_UDF', 'STRING_FUNCTIONS', 'RTRIM(string)', '返回一个字符串，该字符串从STRING中删除正确的空格。

例如，"This is a test String. ".rtrim()返回“This is a test String.”。', 'RTRIM(${1:})', '1.12', 0, true,
        '2021-02-22 15:29:35', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (103, 'Function', 'FUN_UDF', 'STRING_FUNCTIONS', 'REPEAT(string, integer)', '返回一个字符串，该字符串重复基本STRING INT次。

例如，"This is a test String.".repeat(2)返回“This is a test String.This is a test String.”。', 'REPEAT(${1:}, ${2:})',
        '1.12', 0, true, '2021-02-22 15:29:35', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (104, 'Function', 'FUN_UDF', 'STRING_FUNCTIONS', 'REGEXP_REPLACE(string1, string2, string3)', '返回字符串STRING1所有匹配正则表达式的子串STRING2连续被替换STRING3。

例如，"foobar".regexpReplace("oo|ar", "")返回“ fb”。', 'REGEXP_REPLACE(${1:} , ${2:} , ${3:} )', '1.12', 0, true,
        '2021-02-22 15:29:35', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (105, 'Function', 'FUN_UDF', 'STRING_FUNCTIONS',
        ...
        'OVERLAY(${1:} PLACING ${2:} FROM ${3:})', '1.12', 0, true, '2021-02-22 15:29:35', '2023-12-28 00:08:58', NULL,
        NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
...
VALUES (108, 'Function', 'FUN_UDF', 'STRING_FUNCTIONS', 'REGEXP_EXTRACT(string1, string2[, integer])',
        ...
        'REGEXP_EXTRACT(${1:}, ${2:})', '1.12', 0, true, '2021-02-22 15:29:35', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (109, 'Function', 'FUN_UDF', 'STRING_FUNCTIONS', 'INITCAP(string)',
        '返回一种新形式的STRING，其中每个单词的第一个字符转换为大写，其余字符转换为小写。', 'INITCAP(${1:})', '1.12', 0,
        true, '2021-02-22 15:29:35', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
...
VALUES (111, 'Function', 'FUN_UDF', 'STRING_FUNCTIONS', 'CONCAT_WS(string1, string2, string3,...)',
        '返回一个字符串，会连接STRING2，STRING3，......与分离STRING1。', 'CONCAT_WS(${1:} , ${2:} , ${3:} )', '1.12', 0,
        true, '2021-02-22 15:29:35', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
...
VALUES (114, 'Function', 'FUN_UDF', 'STRING_FUNCTIONS', 'FROM_BASE64(string)',
        '返回来自STRING的base64解码结果；如果STRING为NULL，则返回null 。', 'FROM_BASE64(${1:})', '1.12', 0, true,
        '2021-02-22 15:29:35', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (115, 'Function', 'FUN_UDF', 'STRING_FUNCTIONS', 'TO_BASE64(string)',
        '从STRING返回base64编码的结果；如果STRING为NULL，则返回NULL。', 'TO_BASE64(${1:})', '1.12', 0, true,
        '2021-02-22 15:29:35', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
...
VALUES (117, 'Function', 'FUN_UDF', 'STRING_FUNCTIONS', 'CHR(integer)',
        ...
        'CHR(${1:})', '1.12', 0, true, '2021-02-22 15:29:35', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (118, 'Function', 'FUN_UDF', 'STRING_FUNCTIONS', 'DECODE(binary, string)',
        ...
        'DECODE(${1:}, ${2:})', '1.12', 0, true, '2021-02-22 15:29:35', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (119, 'Function', 'FUN_UDF', 'STRING_FUNCTIONS', 'ENCODE(string1, string2)',
        ...
        'ENCODE(${1:}, ${2:})', '1.12', 0, true, '2021-02-22 15:29:35', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (120, 'Function', 'FUN_UDF', 'STRING_FUNCTIONS', 'INSTR(string1, string2)',
        ...
        'INSTR(${1:}, ${2:})', '1.12', 0, true, '2021-02-22 15:29:35', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (121, 'Function', 'FUN_UDF', 'STRING_FUNCTIONS', 'LEFT(string, integer)',
        ...
        'LEFT(${1:}, ${2:})', '1.12', 0, true, '2021-02-22 15:29:35', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (122, 'Function', 'FUN_UDF', 'STRING_FUNCTIONS', 'RIGHT(string, integer)',
        ...
        'RIGHT(${1:}, ${2:})', '1.12', 0, true, '2021-02-22 15:29:35', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (123, 'Function', 'FUN_UDF', 'STRING_FUNCTIONS', 'LOCATE(string1, string2[, integer])',
        ...
        'LOCATE(${1:}, ${2:})', '1.12', 0, true, '2021-02-22 15:29:35', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (124, 'Function', 'FUN_UDF', 'STRING_FUNCTIONS', 'PARSE_URL(string1, string2[, string3])',
        ...
        'PARSE_URL(${1:} , ${2:})', '1.12', 0, true, '2021-02-22 15:29:35', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (125, 'Function', 'FUN_UDF', 'STRING_FUNCTIONS', 'REGEXP(string1, string2)',
        ...
        'REGEXP(${1:}, ${2:})', '1.12', 0, true, '2021-02-22 15:29:35', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (126, 'Function', 'FUN_UDF', 'STRING_FUNCTIONS', 'REVERSE(string)',
        '返回反向字符串。如果字符串为NULL，则返回NULL仅在blink planner中支持。', 'REVERSE(${1:})', '1.12', 0, true,
        '2021-02-22 15:29:35', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (127, 'Function', 'FUN_UDF', 'STRING_FUNCTIONS', 'SPLIT_INDEX(string1, string2, integer1)',
        ...
        'SPLIT_INDEX(${1:}, ${2:} , ${3:})', '1.12', 0, true, '2021-02-22 15:29:35', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (128, 'Function', 'FUN_UDF', 'STRING_FUNCTIONS', 'STR_TO_MAP(string1[, string2, string3]])',
        ...
        'STR_TO_MAP(${1:})', '1.12', 4, true, '2021-02-22 15:29:35', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (129, 'Function', 'FUN_UDF', 'STRING_FUNCTIONS', 'SUBSTR(string[, integer1[, integer2]])',
        ...
        'SUBSTR(${1:})', '1.12', 0, true, '2021-02-22 15:29:35', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (130, 'Function', 'FUN_UDF', 'STRING_FUNCTIONS', 'CHAR_LENGTH(string)', '返回STRING中的字符数。',
        'CHAR_LENGTH(${1:})', '1.12', 0, true, '2021-02-22 15:29:35', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (131, 'Function', 'FUN_UDF', 'STRING_FUNCTIONS', 'CHARACTER_LENGTH(string)', '返回STRING中的字符数。',
        'CHARACTER_LENGTH(${1:})', '1.12', 0, true, '2021-02-22 15:29:35', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (132, 'Function', 'FUN_UDF', 'TIME_FUNCTION', 'DATE string', '返回以“ yyyy-MM-dd”形式从STRING解析的SQL日期。',
        'DATE(${1:})', '1.12', 0, true, '2021-02-22 15:29:35', '2023-12-28 00:08:59', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (133, 'Function', 'FUN_UDF', 'TIME_FUNCTION', 'TIME string', '返回以“ HH：mm：ss”的形式从STRING解析的SQL时间。',
        'TIME(${1:})', '1.12', 0, true, '2021-02-22 15:29:35', '2023-12-28 00:08:59', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (134, 'Function', 'FUN_UDF', 'TIME_FUNCTION', 'TIMESTAMP string',
        '返回从STRING解析的SQL时间戳，格式为“ yyyy-MM-dd HH：mm：ss [.SSS]”', 'TIMESTAMP(${1:})', '1.12', 0, true,
...
VALUES (135, 'Function', 'FUN_UDF', 'TIME_FUNCTION', 'INTERVAL string range',
        ...
        'INTERVAL ${1:} range', '1.12', 0, true, '2021-02-22 15:29:35', '2023-12-28 00:08:59', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (136, 'Function', 'FUN_UDF', 'TIME_FUNCTION', 'CURRENT_DATE', '返回UTC时区中的当前SQL日期。', 'CURRENT_DATE',
        '1.12', 0, true, '2021-02-22 15:29:35', '2023-12-28 00:08:59', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
...
VALUES (138, 'Function', 'FUN_UDF', 'TIME_FUNCTION', 'CURRENT_TIMESTAMP', '返回UTC时区内的当前SQL时间戳。',
        'CURRENT_TIMESTAMP', '1.12', 0, true, '2021-02-22 15:29:35', '2023-12-28 00:08:59', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (139, 'Function', 'FUN_UDF', 'TIME_FUNCTION', 'LOCALTIME', '返回本地时区的当前SQL时间。', 'LOCALTIME', '1.12', 0,
        true, '2021-02-22 15:29:35', '2023-12-28 00:08:59', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
...
VALUES (141, 'Function', 'FUN_UDF', 'TIME_FUNCTION', 'EXTRACT(timeintervalunit FROM temporal)',
        '返回从时域的timeintervalunit部分提取的长值。', 'EXTRACT(${1:} FROM ${2:})', '1.12', 0, true,
        '2021-02-22 15:29:35', '2023-12-28 00:08:59', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (142, 'Function', 'FUN_UDF', 'TIME_FUNCTION', 'YEAR(date)',
        '返回SQL date日期的年份。等价于EXTRACT(YEAR FROM date)。', 'YEAR(${1:})', '1.12', 0, true, '2021-02-22 15:29:35',
        '2023-12-28 00:08:59', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
...
VALUES (144, 'Function', 'FUN_UDF', 'TIME_FUNCTION', 'MONTH(date)',
        '返回SQL date date中的某月(1到12之间的整数)。等价于EXTRACT(MONTH FROM date)。', 'MONTH(${1:})', '1.12', 0, true,
...
VALUES (145, 'Function', 'FUN_UDF', 'TIME_FUNCTION', 'WEEK(date)',
        ...
        0, true, '2021-02-22 15:46:48', '2023-12-28 00:08:59', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (146, 'Function', 'FUN_UDF', 'TIME_FUNCTION', 'DAYOFYEAR(date)',
        '返回SQL date date中的某一天(1到366之间的整数)。相当于EXTRACT(DOY FROM date)。', 'DAYOFYEAR(${1:})', '1.12', 0,
        true, '2021-02-22 15:46:48', '2023-12-28 00:08:59', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
...
VALUES (148, 'Function', 'FUN_UDF', 'TIME_FUNCTION', 'DAYOFWEEK(date)',
        '返回星期几(1到7之间的整数;星期日= 1)从SQL日期日期。相当于提取(道指从日期)。', 'DAYOFWEEK(${1:})', '1.12', 0,
        true, '2021-02-22 15:46:48', '2023-12-28 00:08:59', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (149, 'Function', 'FUN_UDF', 'TIME_FUNCTION', 'HOUR(timestamp)',
        ...
        '1.12', 0, true, '2021-02-22 15:46:48', '2023-12-28 00:08:59', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
...
VALUES (152, 'Function', 'FUN_UDF', 'TIME_FUNCTION', 'FLOOR(timepoint TO timeintervalunit)',
        '返回一个将timepoint舍入到时间单位timeintervalunit的值。', 'FLOOR(${1:} TO ${2:})', '1.12', 0, true,
        '2021-02-22 15:46:48', '2023-12-28 00:08:59', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (153, 'Function', 'FUN_UDF', 'TIME_FUNCTION', 'CEIL(timepoint TO timeintervalunit)',
        '返回一个将timepoint舍入到时间单位timeintervalunit的值。', 'CEIL(${1:} TO ${2:})', '1.12', 0, true,
        '2021-02-22 15:46:48', '2023-12-28 00:08:59', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (154, 'Function', 'FUN_UDF', 'TIME_FUNCTION', '(timepoint1, temporal1) OVERLAPS (timepoint2, temporal2)',
        ...
        '(${1:} , ${1:}) OVERLAPS (${2:} , ${2:})', '1.12', 0, true, '2021-02-22 15:46:48', '2023-12-28 00:08:59', NULL,
        NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (155, 'Function', 'FUN_UDF', 'TIME_FUNCTION', 'DATE_FORMAT(timestamp, string)',
        ...
        'DATE_FORMAT(${1:}, ''yyyy-MM-dd'')', '1.12', 0, true, '2021-02-22 15:46:48', '2023-12-28 00:08:59', NULL,
        NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (156, 'Function', 'FUN_UDF', 'TIME_FUNCTION', 'TIMESTAMPADD(timeintervalunit, interval, timepoint)',
        ...
        'TIMESTAMPADD(${1:} , ${2:} , ${3:})', '1.12', 0, true, '2021-02-22 15:46:48', '2023-12-28 00:08:59', NULL,
        NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (39, 'Function', 'FUN_UDF', 'COMPARE_FUNCTION', 'value IN (sub-query)', '如果value存在于子查询中，则返回TRUE。',
        '${1:} IN (${2:})', '1.12', 0, true, '2021-02-22 14:44:26', '2023-12-28 00:08:58', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (157, 'Function', 'FUN_UDF', 'TIME_FUNCTION', 'TIMESTAMPDIFF(timepointunit, timepoint1, timepoint2)',
        ...
        'TIMESTAMPDIFF(${1:} , ${2:} , ${3:})', '1.12', 0, true, '2021-02-22 15:46:48', '2023-12-28 00:08:59', NULL,
        NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (158, 'Function', 'FUN_UDF', 'TIME_FUNCTION', 'CONVERT_TZ(string1, string2, string3)',
        ...
        'CONVERT_TZ(${1:} , ${2:} , ${3:})', '1.12', 0, true, '2021-02-22 15:46:48', '2023-12-28 00:08:59', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (159, 'Function', 'FUN_UDF', 'TIME_FUNCTION', 'FROM_UNIXTIME(numeric[, string])',
        ...
        'FROM_UNIXTIME(${1:} )', '1.12', 0, true, '2021-02-22 15:46:48', '2023-12-28 00:08:59', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (160, 'Function', 'FUN_UDF', 'TIME_FUNCTION', 'UNIX_TIMESTAMP()',
        '获取当前Unix时间戳(以秒为单位)。仅在blink planner中支持。', 'UNIX_TIMESTAMP()', '1.12', 0, true,
        '2021-02-22 15:46:48', '2023-12-28 00:08:59', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (161, 'Function', 'FUN_UDF', 'TIME_FUNCTION', 'UNIX_TIMESTAMP(string1[, string2])',
        ...
        'UNIX_TIMESTAMP(${1:})', '1.12', 0, true, '2021-02-22 15:46:48', '2023-12-28 00:08:59', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
...
VALUES (163, 'Function', 'FUN_UDF', 'TIME_FUNCTION', 'TO_TIMESTAMP(string1[, string2])',
        ...
        'TO_TIMESTAMP(${1:})', '1.12', 0, true, '2021-02-22 15:46:48', '2023-12-28 00:08:59', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (164, 'Function', 'FUN_UDF', 'TIME_FUNCTION', 'NOW()', '返回UTC时区内的当前SQL时间戳。仅在blink planner中支持。',
        'NOW()', '1.12', 0, true, '2021-02-22 15:46:48', '2023-12-28 00:08:59', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
...
END', '当第一个时间值包含在(valueX_1, valueX_2，…)中时，返回resultX。如果没有匹配的值，则返回resultZ，否则返回NULL。', 'CASE ${1:}
  WHEN ${2:}  THEN ${3:}
 ELSE ${4:}
END AS ${5:}', '1.12', 0, true, '2021-02-22 15:46:48', '2023-12-28 00:08:59', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
...
END', '当第一个条件满足时返回resultX。当不满足任何条件时，如果提供了resultZ则返回resultZ，否则返回NULL。', 'CASE WHEN ${1:} THEN ${2:}
   ELSE ${3:}
END AS ${4:}', '1.12', 0, true, '2021-02-22 15:46:48', '2023-12-28 00:08:59', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (167, 'Function', 'FUN_UDF', 'CONDITIONAL_FUNCTION', 'NULLIF(value1, value2)',
        '如果value1等于value2，则返回NULL;否则返回value1。', 'NULLIF(${1:}, ${2:})', '1.12', 0, true,
        '2021-02-22 15:46:48', '2023-12-28 00:08:59', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (168, 'Function', 'FUN_UDF', 'CONDITIONAL_FUNCTION', 'COALESCE(value1, value2 [, value3 ]* )',
        '返回value1, value2， ....中的第一个非空值', 'COALESCE(${1:} )', '1.12', 0, true, '2021-02-22 15:46:48',
        '2023-12-28 00:08:59', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (169, 'Function', 'FUN_UDF', 'CONDITIONAL_FUNCTION', 'IF(condition, true_value, false_value)',
        '如果条件满足则返回true值，否则返回false值。仅在blink planner中支持。', 'IF((${1:}, ${2:}, ${3:})', '1.12', 0,
        true, '2021-02-22 15:46:48', '2023-12-28 00:08:59', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
...
VALUES (173, 'Function', 'FUN_UDF', 'TYPE_CONVER_FUNCTION', 'CAST(value AS type)', '返回一个要转换为type类型的新值。',
        'CAST(${1:} AS ${2:})', '1.12', 0, true, '2021-02-22 15:46:48', '2023-12-28 00:08:59', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (174, 'Function', 'FUN_UDF', 'COLLECTION_FUNCTION', 'CARDINALITY(array)', '返回数组中元素的数量。',
        'CARDINALITY(${1:})', '1.12', 0, true, '2021-02-22 15:46:48', '2023-12-28 00:08:59', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (175, 'Function', 'FUN_UDF', 'COLLECTION_FUNCTION', 'array ‘[’ integer ‘]’',
        '返回数组中位于整数位置的元素。索引从1开始。', 'array[${1:}]', '1.12', 0, true, '2021-02-22 15:46:48',
        '2023-12-28 00:08:59', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
...
VALUES (184, 'Function', 'FUN_UDF', 'VALUE_ACCESS_FUNCTION', 'tableName.compositeType.*',
        ...
        'tableName.compositeType.*', '1.12', 0, true, '2021-02-22 15:46:48', '2023-12-28 00:08:59', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (185, 'Function', 'FUN_UDF', 'GROUP_FUNCTION', 'GROUP_ID()', '返回唯一标识分组键组合的整数', 'GROUP_ID()',
        '1.12', 0, true, '2021-02-22 15:46:48', '2023-12-28 00:09:00', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                  enabled, create_time, update_time, creator, updater)
VALUES (186, 'Function', 'FUN_UDF', 'GROUP_FUNCTION', 'GROUPING(expression1 [, expression2]* )
GROUPING_ID(expression1 [, expression2]* )', '返回给定分组表达式的位向量。', 'GROUPING(${1:})', '1.12', 0, true,
        '2021-02-22 15:46:48', '2023-12-28 00:09:00', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (187, 'Function', 'FUN_UDF', 'HASH_FUNCTION', 'MD5(string)',
        '以32位十六进制数字的字符串形式返回string的MD5哈希值;如果字符串为NULL，则返回NULL。', 'MD5(${1:})', '1.12', 0,
        true, '2021-02-22 15:46:48', '2023-12-28 00:09:00', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
...
VALUES (189, 'Function', 'FUN_UDF', 'HASH_FUNCTION', 'SHA224(string)',
        ...
        0, true, '2021-02-22 15:46:48', '2023-12-28 00:09:00', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
...
VALUES (193, 'Function', 'FUN_UDF', 'HASH_FUNCTION', 'SHA2(string, hashLength)',
        ...
        'SHA2(${1:}, ${2:})', '1.12', 0, true, '2021-02-22 15:46:48', '2023-12-28 00:09:00', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
...
COUNT(1)', '返回输入行数。', 'COUNT(${1:})', '1.12', 0, true, '2021-02-22 15:46:48', '2023-12-28 00:09:00', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (196, 'Function', 'FUN_UDF', 'AGGREGATE_FUNCTION', 'AVG([ ALL | DISTINCT ] expression)',
        ...
        'AVG(${1:})', '1.12', 0, true, '2021-02-22 15:46:48', '2023-12-28 00:09:00', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
...
VALUES (200, 'Function', 'FUN_UDF', 'AGGREGATE_FUNCTION', 'STDDEV_POP([ ALL | DISTINCT ] expression)',
        ...
        'STDDEV_POP(${1:})', '1.12', 0, true, '2021-02-22 15:46:48', '2023-12-28 00:09:00', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (201, 'Function', 'FUN_UDF', 'AGGREGATE_FUNCTION', 'STDDEV_SAMP([ ALL | DISTINCT ] expression)',
        ...
        'STDDEV_SAMP(${1:})', '1.12', 0, true, '2021-02-22 15:46:48', '2023-12-28 00:09:00', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (202, 'Function', 'FUN_UDF', 'AGGREGATE_FUNCTION', 'VAR_POP([ ALL | DISTINCT ] expression)',
        ...
        'VAR_POP(${1:})', '1.12', 0, true, '2021-02-22 15:46:48', '2023-12-28 00:09:00', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (203, 'Function', 'FUN_UDF', 'AGGREGATE_FUNCTION', 'VAR_SAMP([ ALL | DISTINCT ] expression)',
        ...
        'VAR_SAMP(${1:})', '1.12', 0, true, '2021-02-22 15:46:48', '2023-12-28 00:09:00', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (204, 'Function', 'FUN_UDF', 'AGGREGATE_FUNCTION', 'COLLECT([ ALL | DISTINCT ] expression)',
        ...
        'COLLECT(${1:})', '1.12', 0, true, '2021-02-22 15:46:48', '2023-12-28 00:09:00', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (205, 'Function', 'FUN_UDF', 'AGGREGATE_FUNCTION', 'VARIANCE([ ALL | DISTINCT ] expression)',
        'VAR_SAMP的同义词。仅在blink planner中支持。', 'VARIANCE(${1:})', '1.12', 0, true, '2021-02-22 15:46:48',
        '2023-12-28 00:09:00', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (206, 'Function', 'FUN_UDF', 'AGGREGATE_FUNCTION', 'RANK()',
        ...
        'RANK()', '1.12', 0, true, '2021-02-22 15:46:48', '2023-12-28 00:09:00', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (207, 'Function', 'FUN_UDF', 'AGGREGATE_FUNCTION', 'DENSE_RANK()',
        ...
        'DENSE_RANK()', '1.12', 0, true, '2021-02-22 15:46:48', '2023-12-28 00:09:00', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
...
VALUES (209, 'Function', 'FUN_UDF', 'AGGREGATE_FUNCTION', 'LEAD(expression [, offset] [, default] )',
        ...
        'LEAD(${1:})', '1.12', 0, true, '2021-02-22 15:46:48', '2023-12-28 00:09:00', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (210, 'Function', 'FUN_UDF', 'AGGREGATE_FUNCTION', 'LAG(expression [, offset] [, default])',
        ...
        'LAG(${1:})', '1.12', 0, true, '2021-02-22 15:46:48', '2023-12-28 00:09:00', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (211, 'Function', 'FUN_UDF', 'AGGREGATE_FUNCTION', 'FIRST_VALUE(expression)',
        '返回一组有序值中的第一个值。仅在blink planner中支持。', 'FIRST_VALUE(${1:})', '1.12', 0, true,
        '2021-02-22 15:46:48', '2023-12-28 00:09:00', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (212, 'Function', 'FUN_UDF', 'AGGREGATE_FUNCTION', 'LAST_VALUE(expression)',
        '返回一组有序值中的最后一个值。仅在blink planner中支持。', 'LAST_VALUE(${1:})', '1.12', 0, true,
        '2021-02-22 15:46:48', '2023-12-28 00:09:00', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (213, 'Function', 'FUN_UDF', 'AGGREGATE_FUNCTION', 'LISTAGG(expression [, separator])',
        ...
        'LISTAGG(${1:})', '1.12', 0, true, '2021-02-22 15:46:48', '2023-12-28 00:09:00', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (214, 'Function', 'FUN_UDF', 'COLUMN_FUNCTION', 'withColumns(…)', '选择的列', 'withColumns(${1:})', '1.12', 0,
        true, '2021-02-22 15:46:48', '2023-12-28 00:09:00', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
...
VALUES (216, 'Function', 'FUN_UDF', 'COMPARE_FUNCTION', 'value1 = value2',
        '如果value1等于value2 返回true; 如果value1或value2为NULL，则返回UNKNOWN 。', '${1:} =${2:}', '1.12', 9, true,
...
VALUES (217, 'Function', 'FUN_UDF', 'TABLE_AGGREGATE_FUNCTION', 'TO_MAP(string1,object2[, string3])',
        ...
        'TO_MAP(${1:})', '1.12', 8, true, '2021-05-20 19:59:22', '2023-12-28 00:10:10', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (218, 'Reference', 'SQL_TEMPLATE', 'FlinkCDC', 'EXECUTE CDCSOURCE print', 'Whole library synchronization print', 'EXECUTE CDCSOURCE demo_print WITH (
  ''connector'' = ''mysql-cdc'',
  ''hostname'' = ''127.0.0.1'',
  ''port'' = ''3306'',
  ''username'' = ''root'',
...
);', 'All Versions', 0, true, '2023-10-31 16:01:45', '2023-12-28 00:02:57', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (219, 'Reference', 'SQL_TEMPLATE', 'FlinkCDC', 'EXECUTE CDCSOURCE doris', 'Whole library synchronization doris', 'EXECUTE CDCSOURCE demo_print WITH (
  ''connector'' = ''mysql-cdc'',
  ''hostname'' = ''127.0.0.1'',
  ''port'' = ''3306'',
  ''username'' = ''root'',
  ...
  ''table-name'' = ''test\.student,test\.score'',
  ''sink.connector'' = ''print''
);', 'All Versions', 0, true, '2023-10-31 16:02:21', '2023-12-28 00:02:57', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
...
);', 'All Versions', 0, true, '2023-10-31 16:04:53', '2023-12-28 00:02:57', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
...
);', 'All Versions', 0, true, '2023-10-31 16:14:31', '2023-12-28 00:02:57', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
...
);', 'All Versions', 0, true, '2023-10-31 16:15:22', '2023-12-28 00:02:57', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (221, 'Reference', 'SQL_TEMPLATE', 'FlinkCDC', 'EXECUTE CDCSOURCE StarRocks ', 'The entire library is synchronized to StarRocks
...
);', 'All Versions', 0, true, '2023-10-31 16:05:50', '2023-12-28 00:02:57', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
...
);', 'All Versions', 0, true, '2023-10-31 16:07:08', '2023-12-28 00:02:57', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
...
);', 'All Versions', 0, true, '2023-10-31 16:07:47', '2023-12-28 00:02:57', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
...
);', 'All Versions', 0, true, '2023-10-31 16:08:30', '2023-12-28 00:02:57', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
...
);', 'All Versions', 0, true, '2023-10-31 16:10:13', '2023-12-28 00:02:57', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (226, 'Reference', 'SQL_TEMPLATE', 'FlinkCDC', 'EXECUTE CDCSOURCE cdc_kafka_mul',
 ...
 ''sink.connector''=''datastream-kafka'',
 ''sink.brokers''=''bigdata2:9092,bigdata3:9092,bigdata4:9092''
)', 'All Versions', 0, true, '2023-10-31 16:10:59', '2023-12-28 00:02:57', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
...
);', 'All Versions', 0, true, '2023-10-31 16:12:14', '2023-12-28 00:02:57', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (228, 'Reference', 'SQL_TEMPLATE', 'FlinkCDC', 'EXECUTE CDCSOURCE cdc_postgresql ',
 ...
 ''sink.sink.buffer-flush.max-rows'' = ''100'',
 ''sink.sink.max-retries'' = ''5''
)', 'All Versions', 0, true, '2023-10-31 16:12:54', '2023-12-28 00:02:57', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
...
);', 'All Versions', 0, true, '2023-10-31 16:13:33', '2023-12-28 00:02:57', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (232, 'Reference', 'SQL_TEMPLATE', 'FlinkCDC', 'EXECUTE CDCSOURCE mysql2public.dinky_catalog',
        'The entire library is synchronized to dinky''s built-in catalog', 'EXECUTE CDCSOURCE mysql2public.dinky_catalog WITH (
  ''connector'' = ''mysql-cdc'',
  ''hostname'' = ''127.0.0.1'',
  ''port'' = ''3306'',
  ''username'' = ''root'',
...
);', 'All Versions', 0, true, '2023-10-31 16:16:22', '2023-12-28 00:02:57', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
...
)', 'All Versions', 0, true, '2023-10-31 16:17:27', '2023-12-28 00:02:57', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (234, 'Reference', 'FUN_UDF', 'OTHER_FUNCTION', 'ADD JAR', 'ADD JAR', 'ADD JAR ${1:}; -- str path ',
        'All Versions', 0, true, '2023-10-31 16:19:52', '2023-12-28 00:02:02', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (235, 'Function', 'Other', 'Other', 'SHOW FRAGMENTS', 'SHOW FRAGMENTS', 'SHOW FRAGMENTS;', 'All Versions', 0,
        true, '2023-10-31 16:20:30', '2023-12-28 09:57:55', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (236, 'Function', 'Other', 'Other', 'SHOW FRAGMENT var1', 'SHOW FRAGMENT var1', 'SHOW FRAGMENT ${1:};',
        'All Versions', 0, true, '2023-10-31 16:21:23', '2023-12-28 09:57:54', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (237, 'Reference', 'SQL_TEMPLATE', 'FlinkCDC', 'EXECUTE CDCSOURCE demo_hudi',
 ...
 ''sink.hive_sync.table''=''${tableName}'',
 ''sink.table.prefix.schema''=''true''
);', 'All Versions', 0, true, '2023-10-31 16:24:47', '2023-12-28 00:02:57', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (238, 'Reference', 'SQL_TEMPLATE', 'FlinkJar', 'EXECUTE JAR ', 'EXECUTE JAR use sql', 'EXECUTE JAR WITH (
''uri''=''rs:///jar/flink/demo/SocketWindowWordCount.jar'',
''main-class''=''org.apache.flink.streaming.examples.socket'',
''args''='' --hostname localhost '',
''parallelism''='''',
''savepoint-path''=''''
);', 'All Versions', 0, true, '2023-10-31 16:27:53', '2023-12-28 09:57:54', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (239, 'Reference', 'FUN_UDF', 'OTHER_FUNCTION', 'PRINT tablename', 'PRINT table data', 'PRINT ${1:}',
        'All Versions', 0, true, '2023-10-31 16:30:22', '2023-12-28 00:09:39', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (240, 'Reference', 'SQL_TEMPLATE', 'FlinkSql', 'CREATE TABLE Like', 'CREATE TABLE Like source table', 'DROP TABLE IF EXISTS sink_table;
CREATE TABLE IF not EXISTS sink_table
WITH (
    ''topic'' = ''motor_vehicle_error''
)
LIKE source_table;', 'All Versions', 0, true, '2023-10-31 16:33:38', '2023-12-28 00:02:57', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
...
LIKE source_table (
    ...
    EXCLUDING ALL
    INCLUDING GENERATED
);', 'All Versions', 0, true, '2023-10-31 16:36:13', '2023-12-28 00:02:57', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (242, 'Reference', 'SQL_TEMPLATE', 'FlinkSql', 'CREATE TABLE ctas_kafka', 'CREATE TABLE ctas_kafka', 'CREATE TABLE my_ctas_table
WITH (
    ''connector'' = ''kafka''
)
AS SELECT id, name, age FROM source_table WHERE mod(id, 10) = 0;', 'All Versions', 0, true, '2023-10-31 16:37:33',
        '2023-12-28 00:02:57', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (243, 'Reference', 'SQL_TEMPLATE', 'FlinkSql', 'CREATE TABLE rtas_kafka', 'CREATE TABLE rtas_kafka', 'CREATE OR REPLACE TABLE my_ctas_table
WITH (
    ''connector'' = ''kafka''
)
AS SELECT id, name, age FROM source_table WHERE mod(id, 10) = 0;', 'All Versions', 0, true, '2023-10-31 16:41:46',
        '2023-12-28 00:02:57', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (244, 'Reference', 'SQL_TEMPLATE', 'FlinkSql', 'datagen job demo', 'datagen job demo', 'DROP TABLE IF EXISTS source_table3;
...
FROM source_table3;', 'All Versions', 0, true, '2023-11-15 15:42:16', '2023-12-28 00:02:57', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
...
set ''cluster.evenly-spread-out-slots''=''true'';', 'All Versions', 0, true, '2023-11-15 15:57:42',
        '2023-12-28 15:49:20', NULL, NULL);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
VALUES (246, 'Reference', 'SQL_TEMPLATE', 'FlinkSql', 'note template', 'note template', '-- -----------------------------------------------------------------
-- @Description(作业描述): ${1:}
-- @Creator(创建人): ${2:}
-- @Create DateTime(创建时间): ${3:}
-- -----------------------------------------------------------------

${4:}', 'All Versions', 0, true, '2023-11-17 17:03:24', '2023-12-28 12:05:20', 1, 1);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
...
EXECUTE CDCSOURCE public.dinky_paimon_auto_create_table
WITH
  (
    ''connector'' = ''mysql-cdc'',
    ''hostname'' = '''',
    ...
    ''sink.auto-create'' = ''true'',
  );', 'All Versions', 0, true, '2023-12-27 16:53:37', '2023-12-28 12:05:20', 1, 1);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
...
add CUSTOMJAR ''${1:}'';', 'All Versions', 0, true, '2023-12-28 10:50:17', '2023-12-28 15:49:40', 1, 1);
INSERT INTO public.dinky_flink_document (id, category, type, subtype, name, description, fill_value, version, like_num,
                                         enabled, create_time, update_time, creator, updater)
...
CREATE TABLE IF NOT EXISTS public.dinky_fragment
(
    id             serial PRIMARY KEY          NOT NULL,
    name           varchar(50)                 NOT NULL,
    tenant_id      int                         NOT NULL DEFAULT 1,
...
COMMENT ON COLUMN public.dinky_fragment.enabled is 'enabled';
...
CREATE OR REPLACE TRIGGER update_dinky_fragment_modtime
    BEFORE UPDATE
    ON public.dinky_fragment
    FOR EACH ROW
EXECUTE FUNCTION trigger_set_timestamp();


-- ----------------------------
-- Table structure for public.dinky_history
-- ----------------------------

CREATE TABLE IF NOT EXISTS public.dinky_history
(
    id                       SERIAL PRIMARY KEY NOT NULL,
    tenant_id                INT                NOT NULL DEFAULT 1,
...
-- Add indexes
CREATE INDEX IF NOT EXISTS  task_index ON public.dinky_history (task_id);
CREATE INDEX IF NOT EXISTS  cluster_index ON public.dinky_history (cluster_id);

-- Add comments to columns
COMMENT
    ON COLUMN public.dinky_history.id IS 'ID';
COMMENT
    ON COLUMN public.dinky_history.tenant_id IS 'tenant id';
COMMENT
    ON COLUMN public.dinky_history.cluster_id IS 'cluster ID';
COMMENT
    ON COLUMN public.dinky_history.cluster_configuration_id IS 'cluster configuration id';
COMMENT
    ON COLUMN public.dinky_history.session IS 'session';
COMMENT
    ON COLUMN public.dinky_history.job_id IS 'Job ID';
COMMENT
    ON COLUMN public.dinky_history.job_name IS 'Job Name';
COMMENT
    ON COLUMN public.dinky_history.job_manager_address IS 'Job Manager Address';
COMMENT
    ON COLUMN public.dinky_history.status IS 'status';
COMMENT
    ON COLUMN public.dinky_history.batch_model IS 'is batch model';
COMMENT
    ON COLUMN public.dinky_history.type IS 'job type';
COMMENT
    ON COLUMN public.dinky_history.statement IS 'statement set';
COMMENT
    ON COLUMN public.dinky_history.error IS 'error message';
COMMENT
    ON COLUMN public.dinky_history.result IS 'result set';
COMMENT
    ON COLUMN public.dinky_history.config_json IS 'config json';
COMMENT
    ON COLUMN public.dinky_history.start_time IS 'job start time';
COMMENT
    ON COLUMN public.dinky_history.end_time IS 'job end time';
COMMENT
    ON COLUMN public.dinky_history.task_id IS 'task ID';

-- Add comment to the table
COMMENT
    ON TABLE public.dinky_history IS 'execution history';



-- ----------------------------
-- Table structure for public.dinky_job_history
-- ----------------------------
CREATE TABLE IF NOT EXISTS public.dinky_job_history
(
    id                         SERIAL PRIMARY KEY NOT NULL,
    tenant_id                  INT                NOT NULL DEFAULT 1,
    job_json                   TEXT               NULL,
...
-- 为列添加注释
COMMENT
    ON COLUMN public.dinky_job_history.id IS 'id';
COMMENT
    ON COLUMN public.dinky_job_history.tenant_id IS 'tenant id';
COMMENT
    ON COLUMN public.dinky_job_history.job_json IS 'dinky job  json';
COMMENT
    ON COLUMN public.dinky_job_history.exceptions_json IS 'exception json ';
COMMENT
    ON COLUMN public.dinky_job_history.checkpoints_json IS 'checkpoint json';
COMMENT
    ON COLUMN public.dinky_job_history.checkpoints_config_json IS 'checkpoints config json ';
COMMENT
    ON COLUMN public.dinky_job_history.config_json IS 'config json';
COMMENT
    ON COLUMN public.dinky_job_history.cluster_json IS 'cluster json';
COMMENT
    ON COLUMN public.dinky_job_history.cluster_configuration_json IS 'cluster configuration json';
COMMENT
    ON COLUMN public.dinky_job_history.update_time IS 'update_time';
-- 为表添加注释
COMMENT
    ON TABLE public.dinky_job_history IS 'dinky_job_history';

CREATE OR REPLACE TRIGGER updatetime_dinky_job_history
    BEFORE UPDATE
    ON public.dinky_job_history
    FOR EACH ROW
EXECUTE FUNCTION trigger_set_timestamp();


-- ----------------------------
-- Table structure for public.dinky_job_instance
-- ----------------------------

CREATE TABLE IF NOT EXISTS public.dinky_job_instance
(
    id                   SERIAL PRIMARY KEY NOT NULL,
...
CREATE UNIQUE INDEX IF NOT EXISTS  job_instance_un_idx1 ON public.dinky_job_instance (tenant_id, name, task_id, history_id);

-- 添加普通索引
CREATE INDEX IF NOT EXISTS  job_instance_task_id_idx1 ON public.dinky_job_instance (task_id);

-- 为列添加注释
COMMENT
    ON COLUMN public.dinky_job_instance.id IS 'id';
COMMENT
    ON COLUMN public.dinky_job_instance.name IS 'job instance name';
COMMENT
    ON COLUMN public.dinky_job_instance.tenant_id IS 'tenant id';
COMMENT
    ON COLUMN public.dinky_job_instance.task_id IS 'task id ';
COMMENT
    ON COLUMN public.dinky_job_instance.step IS 'job history step';
COMMENT
    ON COLUMN public.dinky_job_instance.cluster_id IS 'cluster id';
COMMENT
    ON COLUMN public.dinky_job_instance.jid IS 'Flink JobId';
COMMENT
    ON COLUMN public.dinky_job_instance.status IS 'job instance status';
COMMENT
    ON COLUMN public.dinky_job_instance.history_id IS 'history id';
COMMENT
    ON COLUMN public.dinky_job_instance.create_time IS 'create_time';
COMMENT
    ON COLUMN public.dinky_job_instance.create_time IS 'create_time';
COMMENT
    ON COLUMN public.dinky_job_instance.finish_time IS 'finish_time';
COMMENT
    ON COLUMN public.dinky_job_instance.duration IS 'job duration';
COMMENT
    ON COLUMN public.dinky_job_instance.error IS 'error log';
COMMENT
    ON COLUMN public.dinky_job_instance.failed_restart_count IS 'failed restart count';
COMMENT
    ON COLUMN public.dinky_job_instance.creator IS 'creator';
COMMENT
    ON COLUMN public.dinky_job_instance.updater IS 'updater';
COMMENT
    ON COLUMN public.dinky_job_instance.operator IS 'operator uid';

-- 为表添加注释
COMMENT
    ON TABLE public.dinky_job_instance IS '工作实例';

CREATE OR REPLACE TRIGGER updatetime_dinky_job_instance
    BEFORE UPDATE
    ON public.dinky_job_instance
    FOR EACH ROW
EXECUTE FUNCTION trigger_set_timestamp();

-- ----------------------------
-- Table structure for public.dinky_role
-- ----------------------------

CREATE TABLE IF NOT EXISTS public.dinky_role
(
    id          SERIAL PRIMARY KEY NOT NULL,
...
-- 添加唯一索引
CREATE UNIQUE INDEX IF NOT EXISTS  role_un_idx1 ON public.dinky_role (role_code);

-- 为列添加注释
COMMENT
    ON COLUMN public.dinky_role.id IS 'ID';
COMMENT
    ON COLUMN public.dinky_role.tenant_id IS 'tenant id';
COMMENT
    ON COLUMN public.dinky_role.role_code IS 'role code';
COMMENT
    ON COLUMN public.dinky_role.role_name IS 'role name';
COMMENT
    ON COLUMN public.dinky_role.is_delete IS 'is delete';
COMMENT
    ON COLUMN public.dinky_role.note IS 'note';
COMMENT
    ON COLUMN public.dinky_role.create_time IS 'create_time';
COMMENT
    ON COLUMN public.dinky_role.update_time IS 'update_time';

-- 为表添加注释
COMMENT
    ON TABLE public.dinky_role IS 'dinky_role';

-- 创建触发器以在每次更新记录时设置update_time
CREATE OR REPLACE TRIGGER set_update_time_dinky_role
    BEFORE UPDATE
    ON public.dinky_role
    FOR EACH ROW
EXECUTE FUNCTION trigger_set_timestamp();

-- ----------------------------
-- Records of public.dinky_role
-- ----------------------------
INSERT INTO public.dinky_role
VALUES (1, 1, 'SuperAdmin', 'SuperAdmin', false, 'SuperAdmin of Role', '2022-12-13 05:27:19', '2022-12-13 05:27:19');


-- ----------------------------
-- Table structure for public.dinky_savepoints
-- ----------------------------

CREATE TABLE IF NOT EXISTS public.dinky_savepoints
(
    id          SERIAL PRIMARY KEY NOT NULL,
...
-- 为列添加注释
COMMENT
    ON COLUMN public.dinky_savepoints.id IS 'ID';
COMMENT
    ON COLUMN public.dinky_savepoints.task_id IS 'task id';
COMMENT
    ON COLUMN public.dinky_savepoints.tenant_id IS 'tenant id';
COMMENT
    ON COLUMN public.dinky_savepoints.name IS 'task name';
COMMENT
    ON COLUMN public.dinky_savepoints.type IS 'savepoint type';
COMMENT
    ON COLUMN public.dinky_savepoints.path IS 'savepoint path';
COMMENT
    ON COLUMN public.dinky_savepoints.create_time IS 'create_time';
COMMENT
    ON COLUMN public.dinky_savepoints.creator IS 'creator';

-- 为表添加注释
COMMENT
    ON TABLE public.dinky_savepoints IS 'dinky_savepoints';

-- Table structure for public.dinky_sys_config
CREATE TABLE IF NOT EXISTS public.dinky_sys_config
(
    id          serial PRIMARY KEY NOT NULL,
    name        varchar(255)       NOT NULL,
    value       text,
...
COMMENT
    ON COLUMN public.dinky_sys_config.id IS 'ID';
COMMENT
    ON COLUMN public.dinky_sys_config.name IS 'configuration name';
COMMENT
    ON COLUMN public.dinky_sys_config.value IS 'configuration value';
COMMENT
    ON COLUMN public.dinky_sys_config.create_time IS 'create time';
COMMENT
    ON COLUMN public.dinky_sys_config.update_time IS 'update time';
COMMENT
    ON TABLE public.dinky_sys_config IS 'system configuration';


-- 创建触发器以在每次更新记录时设置update_time
CREATE OR REPLACE TRIGGER set_update_time_dinky_sys_config
    BEFORE UPDATE
    ON public.dinky_sys_config
    FOR EACH ROW
EXECUTE FUNCTION trigger_set_timestamp();


-- Table structure for public.dinky_task
CREATE TABLE IF NOT EXISTS public.dinky_task
(
    id                       serial PRIMARY KEY not null,
    name                     varchar(255)       NOT NULL,
    tenant_id                int                NOT NULL DEFAULT 1,
...
CREATE UNIQUE INDEX IF NOT EXISTS  task_un_idx1 ON public.dinky_task (name, tenant_id);
...
COMMENT ON COLUMN public.dinky_task.create_time IS 'create_time';
COMMENT ON COLUMN public.dinky_task.update_time IS 'update_time';
COMMENT ON COLUMN public.dinky_task.version_id IS 'version id';
COMMENT ON COLUMN public.dinky_task.statement IS 'sql statement';
COMMENT ON COLUMN public.dinky_task.creator IS 'creator';
COMMENT ON COLUMN public.dinky_task.updater IS 'updater';
COMMENT ON COLUMN public.dinky_task.operator IS 'operator user id';

-- 创建触发器以在每次更新记录时设置update_time
CREATE OR REPLACE TRIGGER set_update_time_dinky_task
    BEFORE UPDATE
    ON public.dinky_task
    FOR EACH ROW
EXECUTE FUNCTION trigger_set_timestamp();


-- Table structure for public.dinky_task_version
CREATE TABLE IF NOT EXISTS public.dinky_task_version
(
    id             serial PRIMARY KEY NOT NULL,
    task_id        int                NOT NULL,
    tenant_id      int                NOT NULL DEFAULT 1,
...
CREATE UNIQUE INDEX IF NOT EXISTS  task_version_un_idx1 ON public.dinky_task_version (task_id, tenant_id, version_id);
...
-- Table structure for public.dinky_tenant
CREATE TABLE IF NOT EXISTS public.dinky_tenant
(
    id          serial PRIMARY KEY NOT NULL,
...
-- 创建触发器以在每次更新记录时设置update_time
CREATE OR REPLACE TRIGGER set_update_time_dinky_tenant
    BEFORE UPDATE
    ON public.dinky_tenant
    FOR EACH ROW
EXECUTE FUNCTION trigger_set_timestamp();

-- Insert default record into public.dinky_tenant
INSERT INTO public.dinky_tenant (id, tenant_code, is_delete, note, create_time, update_time)
VALUES (1, 'DefaultTenant', FALSE, 'DefaultTenant', '2022-12-13 05:27:19', '2022-12-13 05:27:19');


-- Table structure for public.dinky_udf_template
CREATE TABLE IF NOT EXISTS public.dinky_udf_template
(
    id            serial PRIMARY KEY NOT NULL,
    name          varchar(100),
...
COMMENT ON COLUMN public.dinky_udf_template.id IS 'ID';
...
COMMENT ON COLUMN public.dinky_udf_template.enabled IS 'enabled';

-- 创建触发器以在每次更新记录时设置update_time
CREATE OR REPLACE TRIGGER set_update_time_dinky_udf_template
    BEFORE UPDATE
    ON public.dinky_udf_template
    FOR EACH ROW
EXECUTE FUNCTION trigger_set_timestamp();


-- Records of public.dinky_udf_template
INSERT INTO public.dinky_udf_template (id, name, code_type, function_type, template_code, enabled, create_time, update_time,
                                creator, updater)
...
CREATE TABLE IF NOT EXISTS public.dinky_user
(
    id               serial PRIMARY KEY NOT NULL,
    ...
    mobile           varchar(20),
    enabled          boolean            NOT NULL DEFAULT true,
    super_admin_flag SMALLINT                    DEFAULT 0,
    is_delete        boolean            NOT NULL DEFAULT false,
    create_time      timestamp          NOT NULL DEFAULT CURRENT_TIMESTAMP,
    update_time      timestamp          NOT NULL DEFAULT CURRENT_TIMESTAMP
);
...
COMMENT ON COLUMN public.dinky_user.enabled IS 'enabled';
...
-- Records of public.dinky_user
INSERT INTO public.dinky_user (id, username, user_type, password, nickname, worknum, avatar, mobile, enabled, super_admin_flag,
                        is_delete, create_time, update_time)
VALUES (1, 'admin', 0, '21232f297a57a5a743894a0e4a801fc3', 'Admin', 'Dinky-001', null, '17777777777', true, 1, false,
        '2022-12-13 05:27:19', '2023-07-28 23:22:52');

-- Table structure for public.dinky_user_role
CREATE TABLE IF NOT EXISTS public.dinky_user_role
(
    id          serial PRIMARY KEY NOT NULL,
...
CREATE UNIQUE INDEX IF NOT EXISTS  user_role_un_idx1 ON public.dinky_user_role (user_id, role_id);
...
COMMENT ON COLUMN public.dinky_user_role.role_id IS 'role_id';

-- 创建触发器以在每次更新记录时设置update_time
CREATE OR REPLACE TRIGGER set_update_time_dinky_user_role
    BEFORE UPDATE
    ON public.dinky_user_role
    FOR EACH ROW
EXECUTE FUNCTION trigger_set_timestamp();

-- Records of public.dinky_user_role
INSERT INTO public.dinky_user_role (id, user_id, role_id, create_time, update_time)
VALUES (1, 1, 1, '2022-12-13 05:27:19', '2022-12-13 05:27:19');

-- Table structure for public.dinky_user_tenant
CREATE TABLE IF NOT EXISTS public.dinky_user_tenant
(
...
CREATE UNIQUE INDEX IF NOT EXISTS  user_tenant_un_idx1 ON public.dinky_user_tenant (user_id, tenant_id);
...
CREATE OR REPLACE TRIGGER set_update_time_dinky_user_tenant
    BEFORE UPDATE
    ON public.dinky_user_tenant
    FOR EACH ROW
EXECUTE FUNCTION trigger_set_timestamp();


-- Records of public.dinky_user_tenant
INSERT INTO public.dinky_user_tenant (id, user_id, tenant_id, tenant_admin_flag, create_time, update_time)
...
-- 创建触发器以在每次更新记录时设置update_time
CREATE OR REPLACE TRIGGER set_update_time_metadata_column
    BEFORE UPDATE
    ON metadata_column
    FOR EACH ROW
EXECUTE FUNCTION trigger_set_timestamp();
...
-- 创建触发器以在每次更新记录时设置update_time
CREATE OR REPLACE TRIGGER set_update_time_metadata_database
    BEFORE UPDATE
...
-- 创建触发器以在每次更新记录时设置update_time
CREATE OR REPLACE TRIGGER set_update_time_metadata_database_property
    BEFORE UPDATE
...
-- 创建触发器以在每次更新记录时设置update_time
CREATE OR REPLACE TRIGGER set_update_time_metadata_function
    BEFORE UPDATE
...
-- 创建触发器以在每次更新记录时设置update_time
CREATE OR REPLACE TRIGGER set_update_time_metadata_table
    BEFORE UPDATE
    ON metadata_table
    FOR EACH ROW
EXECUTE FUNCTION trigger_set_timestamp();
...
-- 创建触发器以在每次更新记录时设置update_time
CREATE OR REPLACE TRIGGER set_update_time_metadata_table_property
    BEFORE UPDATE
    ON metadata_table_property
    FOR EACH ROW
EXECUTE FUNCTION trigger_set_timestamp();

-- Table structure for public.dinky_row_permissions
CREATE TABLE IF NOT EXISTS public.dinky_row_permissions
(
    id          serial PRIMARY KEY NOT NULL,
    role_id     int                NOT NULL,
...
COMMENT ON TABLE public.dinky_row_permissions IS 'row permissions of select';
...
-- 创建触发器以在每次更新记录时设置update_time
CREATE OR REPLACE TRIGGER set_update_time_dinky_row_permissions
    BEFORE UPDATE
    ON public.dinky_row_permissions
    FOR EACH ROW
EXECUTE FUNCTION trigger_set_timestamp();

-- Table structure for public.dinky_git_project
CREATE TABLE IF NOT EXISTS public.dinky_git_project
(
    id                 SERIAL PRIMARY KEY NOT NULL,
...
CREATE INDEX IF NOT EXISTS  tenant_id_idx ON public.dinky_git_project (tenant_id);

COMMENT ON TABLE public.dinky_git_project IS 'Git project configurations';
...
CREATE OR REPLACE TRIGGER update_dinky_git_project_modtime
    BEFORE UPDATE
    ON public.dinky_git_project
    FOR EACH ROW
EXECUTE FUNCTION trigger_set_timestamp();


-- Records of public.dinky_git_project
INSERT INTO public.dinky_git_project (id, tenant_id, name, url, branch, username, password, private_key, pom, build_args,
...
-- Table structure for public.dinky_metrics
CREATE TABLE IF NOT EXISTS public.dinky_metrics
(
    id          SERIAL PRIMARY KEY          NOT NULL,
    task_id     INT,
...
COMMENT ON COLUMN public.dinky_metrics.id IS 'id';
...
COMMENT ON COLUMN public.dinky_metrics.layout_name IS 'layout_name';
-- public.dinky_git_project
CREATE OR REPLACE TRIGGER update_dinky_dinky_metrics
    BEFORE UPDATE
    ON public.dinky_metrics
    FOR EACH ROW
EXECUTE FUNCTION trigger_set_timestamp();

-- Table structure for public.dinky_resources
CREATE TABLE IF NOT EXISTS public.dinky_resources
(
    id           SERIAL PRIMARY KEY          NOT NULL,
...
CREATE OR REPLACE TRIGGER update_dinky_dinky_resources
    BEFORE UPDATE
    ON public.dinky_resources
    FOR EACH ROW
EXECUTE FUNCTION trigger_set_timestamp();

-- Records of public.dinky_resources
INSERT INTO public.dinky_resources (id, file_name, description, user_id, type, size, pid, full_name, is_directory)
VALUES (0, 'Root', 'main folder', 1, 0, 0, -1, '/', 1);

-- Table structure for public.dinky_sys_login_log
...
COMMENT ON TABLE public.dinky_sys_login_log IS 'system login log record';

COMMENT ON COLUMN public.dinky_sys_login_log.id IS 'key';
COMMENT ON COLUMN public.dinky_sys_login_log.username IS 'username';
COMMENT ON COLUMN public.dinky_sys_login_log.user_id IS 'user id';
COMMENT ON COLUMN public.dinky_sys_login_log.login_type IS 'login type（0:LOCAL,1:LDAP）';
COMMENT ON COLUMN public.dinky_sys_login_log.ip IS 'ip addr';
COMMENT ON COLUMN public.dinky_sys_login_log.status IS 'login status';
COMMENT ON COLUMN public.dinky_sys_login_log.msg IS 'status msg';
COMMENT ON COLUMN public.dinky_sys_login_log.access_time IS 'access time';

-- public.dinky_git_project
CREATE OR REPLACE TRIGGER update_dinky_dinky_sys_login_log
    BEFORE UPDATE
    ON public.dinky_sys_login_log
    FOR EACH ROW
EXECUTE FUNCTION trigger_set_timestamp();

-- Table structure for public.dinky_sys_operate_log
CREATE TABLE IF NOT EXISTS public.dinky_sys_operate_log
(
...
COMMENT ON TABLE public.dinky_sys_operate_log IS 'operate log record';

COMMENT ON COLUMN public.dinky_sys_operate_log.id IS 'key';
...
COMMENT ON COLUMN public.dinky_sys_operate_log.method IS 'method name';
...
COMMENT ON COLUMN public.dinky_sys_operate_log.operate_ip IS 'ip';
COMMENT ON COLUMN public.dinky_sys_operate_log.operate_location IS 'operate location';
COMMENT ON COLUMN public.dinky_sys_operate_log.operate_param IS 'request param';
COMMENT ON COLUMN public.dinky_sys_operate_log.json_result IS 'return json result';
COMMENT ON COLUMN public.dinky_sys_operate_log.status IS 'operate status';
...
-- public.dinky_git_project
CREATE OR REPLACE TRIGGER update_dinky_dinky_sys_operate_log
    BEFORE UPDATE
    ON public.dinky_sys_operate_log
    FOR EACH ROW
EXECUTE FUNCTION trigger_set_timestamp();

-- Table structure for public.dinky_sys_menu
CREATE TABLE IF NOT EXISTS public.dinky_sys_menu
(
    id          BIGSERIAL PRIMARY KEY       not null,
...
COMMENT ON TABLE public.dinky_sys_menu IS 'menu';


COMMENT ON COLUMN public.dinky_sys_menu.id IS 'id';
COMMENT ON COLUMN public.dinky_sys_menu.parent_id IS 'parent menu id';
COMMENT ON COLUMN public.dinky_sys_menu.name IS 'menu button name';
COMMENT ON COLUMN public.dinky_sys_menu.path IS 'routing path';
COMMENT ON COLUMN public.dinky_sys_menu.component IS 'routing component component';
COMMENT ON COLUMN public.dinky_sys_menu.perms IS 'authority id';
COMMENT ON COLUMN public.dinky_sys_menu.icon IS 'icon';
COMMENT ON COLUMN public.dinky_sys_menu.type IS 'type(M:directory C:menu F:button)';
COMMENT ON COLUMN public.dinky_sys_menu.display IS 'whether the menu is displayed';
COMMENT ON COLUMN public.dinky_sys_menu.order_num IS 'sort';

-- public.dinky_git_project
CREATE OR REPLACE TRIGGER update_dinky_dinky_sys_menu
    BEFORE UPDATE
    ON public.dinky_sys_menu
    FOR EACH ROW
EXECUTE FUNCTION trigger_set_timestamp();
...
values (115, 22, '删除', '/auth/menu/delete', null, 'auth:menu:delete', 'DeleteOutlined', 'F', 0, 99,
        '2023-09-22 22:11:41', '2023-09-26 15:12:26', null);
insert into public.dinky_sys_menu values (116, 12, '告警策略', '/registration/alert/rule', './RegCenter/Alert/AlertRule', 'registration:alert:rule', 'AndroidOutlined', 'C', 0, 136, '2023-09-22 23:31:10', '2023-09-26 15:19:52', null);
insert into public.dinky_sys_menu values (117, 116, '添加', '/registration/alert/rule/add', null, 'registration:alert:rule:add', 'PlusOutlined', 'F', 0, 137, '2023-09-22 23:34:51', '2023-09-26 15:20:03', null);
insert into public.dinky_sys_menu values (118, 116, '删除', '/registration/alert/rule/delete', null, 'registration:alert:rule:delete', 'DeleteOutlined', 'F', 0, 139, '2023-09-22 23:35:20', '2023-09-26 15:20:21', null);
insert into public.dinky_sys_menu values (119, 116, '编辑', '/registration/alert/rule/edit', null, 'registration:alert:rule:edit', 'EditOutlined', 'F', 0, 138, '2023-09-22 23:36:32', '2023-09-26 15:20:13', null);
insert into public.dinky_sys_menu
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS public.dinky_sys_role_menu
(
    id          BIGSERIAL PRIMARY KEY       NOT NULL,
...
CREATE UNIQUE INDEX IF NOT EXISTS  un_role_menu_inx ON public.dinky_sys_role_menu (role_id, menu_id);
...
-- public.dinky_git_project
CREATE OR REPLACE TRIGGER update_dinky_sys_role_menu
    BEFORE UPDATE
    ON public.dinky_sys_role_menu
    FOR EACH ROW
EXECUTE FUNCTION trigger_set_timestamp();
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS public.dinky_alert_template
(
    id               SERIAL PRIMARY KEY          NOT NULL,
    name             VARCHAR(20),
...
COMMENT ON COLUMN public.dinky_alert_template.name IS 'emplate name';
...
CREATE OR REPLACE TRIGGER update_dinky_alert_template
    BEFORE UPDATE
    ON public.dinky_alert_template
    FOR EACH ROW
EXECUTE FUNCTION trigger_set_timestamp();
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS public.dinky_alert_rules
(
    id                 SERIAL PRIMARY KEY,
...
CREATE OR REPLACE TRIGGER update_dinky_alert_rules
    BEFORE UPDATE
    ON public.dinky_alert_rules
    FOR EACH ROW
EXECUTE FUNCTION trigger_set_timestamp();

-- ----------------------------
-- Table structure for public.dinky_udf_manage
-- ----------------------------
CREATE TABLE IF NOT EXISTS public.dinky_udf_manage
(
    id           SERIAL PRIMARY KEY          NOT NULL,
    name         VARCHAR(50),
...
CREATE INDEX IF NOT EXISTS  name_resources_id_idx ON public.dinky_udf_manage (name, resources_id);


COMMENT ON COLUMN public.dinky_udf_manage.id IS 'id';
...
COMMENT ON COLUMN public.dinky_udf_manage.task_id IS 'task_id';
COMMENT ON COLUMN public.dinky_udf_manage.resources_id IS 'resources_id';

-- public.dinky_git_project
CREATE OR REPLACE TRIGGER update_dinky_udf_manage
    BEFORE UPDATE
    ON public.dinky_udf_manage
    FOR EACH ROW
EXECUTE FUNCTION trigger_set_timestamp();

-- ----------------------------
-- Table structure for public.dinky_sys_token
-- ----------------------------
CREATE TABLE IF NOT EXISTS public.dinky_sys_token
(
...
CREATE UNIQUE INDEX IF NOT EXISTS  token_value_idx ON public.dinky_sys_token (token_value);
CREATE INDEX IF NOT EXISTS source_idx ON public.dinky_sys_token USING HASH (source);
...
COMMENT ON COLUMN public.dinky_sys_token.source IS '1:login 2:custom';

-- public.dinky_git_project
CREATE OR REPLACE TRIGGER update_dinky_sys_token
    BEFORE UPDATE
    ON public.dinky_sys_token
    FOR EACH ROW
EXECUTE FUNCTION trigger_set_timestamp();
