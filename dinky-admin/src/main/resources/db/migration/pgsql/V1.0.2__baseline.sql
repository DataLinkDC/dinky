...
CREATE UNIQUE INDEX IF NOT EXISTS cluster_un_idx1 ON dinky_cluster (name, tenant_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS cluster_configuration_un_idx1 ON dinky_cluster_configuration (name, tenant_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS  database_un_idx1 ON dinky_database (name, tenant_id);
...
--
-- Data for Name: dinky_flink_document; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
-- Add indexes
CREATE INDEX IF NOT EXISTS  task_index ON dinky_history (task_id);
CREATE INDEX IF NOT EXISTS  cluster_index ON dinky_history (cluster_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS  job_instance_un_idx1 ON dinky_job_instance (tenant_id, name, task_id, history_id);

-- 添加普通索引
CREATE INDEX IF NOT EXISTS  job_instance_task_id_idx1 ON dinky_job_instance (task_id);
...
-- 添加唯一索引
CREATE UNIQUE INDEX IF NOT EXISTS  role_un_idx1 ON dinky_role (role_code);
...
CREATE UNIQUE INDEX IF NOT EXISTS  task_un_idx1 ON dinky_task (name, tenant_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS  task_version_un_idx1 ON dinky_task_version (task_id, tenant_id, version_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS  user_role_un_idx1 ON dinky_user_role (user_id, role_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS  user_tenant_un_idx1 ON dinky_user_tenant (user_id, tenant_id);
...
CREATE INDEX IF NOT EXISTS  tenant_id_idx ON dinky_git_project (tenant_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS  dinky_resources_un ON dinky_resources (full_name, type);
...
CREATE UNIQUE INDEX IF NOT EXISTS  un_role_menu_inx ON dinky_sys_role_menu (role_id, menu_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS  dinky_alert_rules_name ON dinky_alert_rules (name);
...
CREATE INDEX IF NOT EXISTS  name_resources_id_idx ON dinky_udf_manage (name, resources_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS  token_value_idx ON dinky_sys_token (token_value);
CREATE INDEX IF NOT EXISTS source_idx ON dinky_sys_token USING HASH (source);
