...
//                    // 根据路由划分模块，不同模块不同鉴权
//                    SaRouter.match("/api/alertGroup/**", r -> StpUtil.checkPermission("alertGroup"));
//                    SaRouter.match("/api/alertHistory/**", r -> StpUtil.checkPermission("alertHistory"));
//                    SaRouter.match("/api/alertInstance/**", r -> StpUtil.checkPermission("alertInstance"));
//                    SaRouter.match("/api/catalogue/**", r -> StpUtil.checkPermission("catalogue"));
//                    SaRouter.match("/api/clusterConfiguration/**", r -> StpUtil.checkPermission("clusterConfiguration"));
//                    SaRouter.match("/api/cluster/**", r -> StpUtil.checkPermission("clusterInstance"));
//                    SaRouter.match("/api/database/**", r -> StpUtil.checkPermission("database"));
//                    SaRouter.match("/api/document/**", r -> StpUtil.checkPermission("document"));
//                    SaRouter.match("/api/fragment/**", r -> StpUtil.checkPermission("fragment"));
//                    SaRouter.match("/api/git/**", r -> StpUtil.checkPermission("git"));
//                    SaRouter.match("/api/history/**", r -> StpUtil.checkPermission("history"));
//
//                }))
//                .addPathPatterns("/api/**")
