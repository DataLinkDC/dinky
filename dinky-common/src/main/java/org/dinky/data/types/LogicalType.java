...
public abstract class LogicalType implements Serializable {
    ...
    public LogicalType(boolean isNullable, LogicalTypeRoot typeRoot) {
        ...
        this.typeRoot = Asserts.checkNotNull(typeRoot);
    }
    ...
    /**
     * Returns a deep copy of this type with possibly different param.
     *
     * @param param the LogicalTypeParam of the copied type
     * @return a deep copy
     */
    public abstract LogicalType copy(LogicalTypeParam param);
