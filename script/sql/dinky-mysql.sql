...
values (1, 'Variable', '优化参数', 'Batch/Streaming', 'set table.exec.async-lookup.buffer-capacity', '异步查找连接可以触发的最大异步操作的操作数。
...
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`)  values (2, 'Variable', '优化参数', 'Batch/Streaming', 'set table.exec.async-lookup.timeout', '异步操作完成的超时时间。
...
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (3, 'Variable', '优化参数', 'Batch', 'set table.exec.disabled-operators', '禁用指定operators，用逗号分隔
...
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (4, 'Variable', '优化参数', 'Streaming', 'set table.exec.mini-batch.allow-latency', '最大等待时间可用于MiniBatch缓冲输入记录。 MiniBatch是用于缓冲输入记录以减少状态访问的优化。MiniBatch以允许的等待时间间隔以及达到最大缓冲记录数触发。注意：如果将table.exec.mini-batch.enabled设置为true，则其值必须大于零.', 'Set ''table.exec.mini-batch.allow-latency''=''-1 ms'';', '1.14', 0, 1, '2022-01-20 15:00:00', '2022-01-20 15:00:00');
...
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (7, 'Variable', '优化参数', 'Batch/Streaming', 'set table.exec.resource.default-parallelism', '设置所有Operator的默认并行度。
...
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (8, 'Variable', '优化参数', 'Batch/Streaming', 'set table.exec.sink.not-null-enforcer', '对表的NOT NULL列约束强制执行不能将空值插入到表中。Flink支持“error”（默认）和“drop”强制行为
...
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (10, 'Module', '建表语句', 'Other', 'create.table.kafka', 'kafka快速建表格式', 'CREATE TABLE Kafka_Table (
...
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (11, 'Module', '建表语句', 'Other', 'create.table.doris', 'Doris快速建表', 'CREATE TABLE doris_table (
    cid INT,
    sid INT,
    name STRING,
    cls STRING,
...
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (12, 'Module', '建表语句', 'Other', 'create.table.jdbc', 'JDBC建表语句', 'CREATE TABLE JDBC_table (
  id BIGINT,
  name STRING,
  age INT,
  status BOOLEAN,
...
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (13, 'Module', 'CataLog', 'Other', 'create.catalog.hive', '创建HIVE的catalog', 'CREATE CATALOG hive WITH (
    ''type'' = ''hive'',
...
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (14, 'Operator', 'CataLog', 'Other', 'use.catalog.hive', '使用hive的catalog', 'USE CATALOG hive;', '1.14', 0, 1, '2022-01-20 17:22:53', '2022-01-20 17:22:53');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (15, 'Operator', 'CataLog', 'Other', 'use.catalog.default', '使用default的catalog', 'USE CATALOG default_catalog;', '1.14', 0, 1, '2022-01-20 17:23:48', '2022-01-20 17:24:23');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (16, 'Variable', '设置参数', 'Other', 'set dialect.hive', '使用hive方言', 'Set table.sql-dialect=hive;', '1.14', 0, 1, '2022-01-20 17:25:37', '2022-01-20 17:27:23');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (17, 'Variable', '设置参数', 'Other', 'set dialect.default', '使用default方言', 'Set table.sql-dialect=default;', '1.14', 0, 1, '2022-01-20 17:26:19', '2022-01-20 17:27:20');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (18, 'Module', '建表语句', 'Other', 'create.stream.table.hive', '创建流式HIVE表', 'CREATE CATALOG hive WITH ( --创建hive的catalog
    ''type'' = ''hive'',
...
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (19, 'Module', '建表语句', 'Other', 'create.table.mysql_cdc', '创建Mysql_CDC表', 'CREATE TABLE mysql_cdc_table(
    cid INT,
    sid INT,
    cls STRING,
    score INT,
...
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`)  values (20, 'Module', '建表语句', 'Other', 'create.table.hudi', '创建hudi表', 'CREATE TABLE hudi_table
(
...
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (21, 'Function', '内置函数', '比较函数', 'value1 <> value2', '如果value1不等于value2 返回true; 如果value1或value2为NULL，则返回UNKNOWN 。', '${1:} <> ${2:}', '1.12', 4, 1, '2021-02-22 10:05:38', '2021-03-11 09:58:48');
insert into `dinky_flink_document`(`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (22, 'Function', '内置函数', '比较函数', 'value1 > value2', '如果value1大于value2 返回true; 如果value1或value2为NULL，则返回UNKNOWN 。', '${1:} > ${2:}', '1.12', 2, 1, '2021-02-22 14:37:58', '2021-03-10 11:58:06');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (23, 'Function', '内置函数', '比较函数', 'value1 >= value2', '如果value1大于或等于value2 返回true; 如果value1或value2为NULL，则返回UNKNOWN 。', '${1:} >= ${2:}', '1.12', 2, 1, '2021-02-22 14:38:52', '2022-03-29 19:05:54');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (24, 'Function', '内置函数', '比较函数', 'value1 < value2', '如果value1小于value2 返回true; 如果value1或value2为NULL，则返回UNKNOWN 。', '${1:} < ${2:}', '1.12', 0, 1, '2021-02-22 14:39:15', '2022-03-29 19:04:58');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (25, 'Function', '内置函数', '比较函数', 'value1 <= value2', '如果value1小于或等于value2 返回true; 如果value1或value2为NULL，则返回UNKNOWN 。', '${1:} <=   ${2:}', '1.12', 0, 1, '2021-02-22 14:39:40', '2022-03-29 19:05:17');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (26, 'Function', '内置函数', '比较函数', 'value IS NULL', '如果value为NULL，则返回TRUE 。', '${1:} IS NULL', '1.12', 2, 1, '2021-02-22 14:40:39', '2021-03-10 11:57:51');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (27, 'Function', '内置函数', '比较函数', 'value IS NOT NULL', '如果value不为NULL，则返回TRUE 。', '${1:}  IS NOT NULL', '1.12', 0, 1, '2021-02-22 14:41:26', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (28, 'Function', '内置函数', '比较函数', 'value1 IS DISTINCT FROM value2', '如果两个值不相等则返回TRUE。NULL值在这里被视为相同的值。', '${1:} IS DISTINCT FROM ${2:}', '1.12', 0, 1, '2021-02-22 14:42:39', '2021-02-22 15:28:47');
...
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`)  values (36, 'Function', '内置函数', '比较函数', 'value1 IN (value2 [, value3]* )', '如果value1存在于给定列表（value2，value3，...）中，则返回TRUE 。
...
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (37, 'Function', '内置函数', '比较函数', 'value1 NOT IN (value2 [, value3]* )', '如果value1不存在于给定列表（value2，value3，...）中，则返回TRUE 。

当（value2，value3，...）包含NULL，如果可以找到该元素，则返回TRUE，否则返回UNKNOWN。

如果value1为NULL，则始终返回UNKNOWN 。', '${1:} NOT IN (${2:})', '1.12', 0, 1, '2021-02-22 14:44:26', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (38, 'Function', '内置函数', '比较函数', 'EXISTS (sub-query)', '如果value存在于子查询中，则返回TRUE。', 'EXISTS (${1:})', '1.12', 0, 1, '2021-02-22 14:44:26', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (39, 'Function', '内置函数', '比较函数', 'value IN (sub-query)', '如果value存在于子查询中，则返回TRUE。', '${1:} IN (${2:})', '1.12', 0, 1, '2021-02-22 14:44:26', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (40, 'Function', '内置函数', '比较函数', 'value NOT IN (sub-query)', '如果value不存在于子查询中，则返回TRUE。', '${1:} NOT IN (${2:})', '1.12', 0, 1, '2021-02-22 14:44:26', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (41, 'Function', '内置函数', '逻辑函数', 'boolean1 OR boolean2', '如果BOOLEAN1为TRUE或BOOLEAN2为TRUE，则返回TRUE。支持三值逻辑。

例如，true || Null(Types.BOOLEAN)返回TRUE。', '${1:} OR ${2:}', '1.12', 0, 1, '2021-02-22 14:44:26', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (42, 'Function', '内置函数', '逻辑函数', 'boolean1 AND boolean2', '如果BOOLEAN1和BOOLEAN2均为TRUE，则返回TRUE。支持三值逻辑。

例如，true && Null(Types.BOOLEAN)返回未知。', '${1:} AND ${2:}', '1.12', 0, 1, '2021-02-22 14:44:26', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (43, 'Function', '内置函数', '逻辑函数', 'NOT boolean', '如果BOOLEAN为FALSE，则返回TRUE ；如果BOOLEAN为TRUE，则返回FALSE 。

如果BOOLEAN为UNKNOWN，则返回UNKNOWN。', 'NOT ${1:} ', '1.12', 0, 1, '2021-02-22 14:44:26', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (44, 'Function', '内置函数', '逻辑函数', 'boolean IS FALSE', '如果BOOLEAN为FALSE，则返回TRUE ；如果BOOLEAN为TRUE或UNKNOWN，则返回FALSE 。', '${1:}  IS FALSE', '1.12', 0, 1, '2021-02-22 14:44:26', '2021-02-22 15:28:47');
...
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (46, 'Function', '内置函数', '逻辑函数', 'boolean IS TRUE', '如果BOOLEAN为TRUE，则返回TRUE；如果BOOLEAN为FALSE或UNKNOWN，则返回FALSE 。', '${1:}  IS TRUE', '1.12', 0, 1, '2021-02-22 14:44:26', '2021-02-22 15:28:47');
...
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (48, 'Function', '内置函数', '逻辑函数', 'boolean IS UNKNOWN', '如果BOOLEAN为UNKNOWN，则返回TRUE ；如果BOOLEAN为TRUE或FALSE，则返回FALSE 。', '${1:}  IS UNKNOWN', '1.12', 0, 1, '2021-02-22 14:44:26', '2021-02-22 15:28:47');
...
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (50, 'Function', '内置函数', '算术函数', '+ numeric', '返回NUMERIC。', '+ ${1:} ', '1.12', 0, 1, '2021-02-22 14:44:26', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (51, 'Function', '内置函数', '算术函数', '- numeric', '返回负数NUMERIC。', '- ${1:} ', '1.12', 0, 1, '2021-02-22 14:44:26', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (52, 'Function', '内置函数', '算术函数', 'numeric1 + numeric2', '返回NUMERIC1加NUMERIC2。', '${1:}  + ${2:} ', '1.12', 0, 1, '2021-02-22 14:44:26', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (53, 'Function', '内置函数', '算术函数', 'numeric1 - numeric2', '返回NUMERIC1减去NUMERIC2。', '${1:}  - ${2:} ', '1.12', 0, 1, '2021-02-22 14:44:26', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (54, 'Function', '内置函数', '算术函数', 'numeric1 * numeric2', '返回NUMERIC1乘以NUMERIC2。', '${1:} * ${2:} ', '1.12', 0, 1, '2021-02-22 14:44:26', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (55, 'Function', '内置函数', '算术函数', 'numeric1 / numeric2', '返回NUMERIC1除以NUMERIC2。', '${1:}  / ${2:} ', '1.12', 0, 1, '2021-02-22 14:44:26', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (56, 'Function', '内置函数', '算术函数', 'numeric1 % numeric2', '返回NUMERIC1除以NUMERIC2的余数（模）。仅当numeric1为负数时，结果为负数。', '${1:}  % ${2:} ', '1.12', 0, 1, '2021-02-22 14:44:26', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (57, 'Function', '内置函数', '算术函数', 'POWER(numeric1, numeric2)', '返回NUMERIC1的NUMERIC2 次幂。', 'POWER(${1:} , ${2:})', '1.12', 0, 1, '2021-02-22 14:44:26', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (58, 'Function', '内置函数', '算术函数', 'ABS(numeric)', '返回NUMERIC的绝对值。', 'ABS(${1:})', '1.12', 0, 1, '2021-02-22 14:44:26', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (59, 'Function', '内置函数', '算术函数', 'MOD(numeric1, numeric2)', '返回numeric1除以numeric2的余数(模)。只有当numeric1为负数时，结果才为负数', 'MOD(${1:} , ${2:} )', '1.12', 0, 1, '2021-02-22 14:44:26', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (60, 'Function', '内置函数', '算术函数', 'SQRT(numeric)', '返回NUMERIC的平方根。', 'SQRT(${1:})', '1.12', 0, 1, '2021-02-22 14:44:26', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (61, 'Function', '内置函数', '算术函数', 'LN(numeric)', '返回NUMERIC的自然对数（以e为底）。', 'LN(${1:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (62, 'Function', '内置函数', '算术函数', 'LOG10(numeric)', '返回NUMERIC的以10为底的对数。', 'LOG10(${1:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (63, 'Function', '内置函数', '算术函数', 'LOG2(numeric)', '返回NUMERIC的以2为底的对数。', 'LOG2(${1:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (64, 'Function', '内置函数', '算术函数', 'EXP(numeric)', '返回e 的 NUMERIC 次幂。', 'EXP(${1:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (65, 'Function', '内置函数', '算术函数', 'FLOOR(numeric)', '向下舍入NUMERIC，并返回小于或等于NUMERIC的最大整数。', 'FLOOR(${1:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (66, 'Function', '内置函数', '算术函数', 'SIN(numeric)', '返回NUMERIC的正弦值。', 'SIN(${1:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (67, 'Function', '内置函数', '算术函数', 'SINH(numeric)', '返回NUMERIC的双曲正弦值。

返回类型为DOUBLE。', 'SINH(${1:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (68, 'Function', '内置函数', '算术函数', 'COS(numeric)', '返回NUMERIC的余弦值。', 'COS(${1:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (69, 'Function', '内置函数', '算术函数', 'TAN(numeric)', '返回NUMERIC的正切。', 'TAN(${1:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (70, 'Function', '内置函数', '算术函数', 'TANH(numeric)', '返回NUMERIC的双曲正切值。

返回类型为DOUBLE。', 'TANH(${1:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (71, 'Function', '内置函数', '算术函数', 'COT(numeric)', '返回NUMERIC的余切。', 'COT(${1:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (72, 'Function', '内置函数', '算术函数', 'ASIN(numeric)', '返回NUMERIC的反正弦值。', 'ASIN(${1:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (73, 'Function', '内置函数', '算术函数', 'ACOS(numeric)', '返回NUMERIC的反余弦值。', 'ACOS(${1:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (74, 'Function', '内置函数', '算术函数', 'ATAN(numeric)', '返回NUMERIC的反正切。', 'ATAN(${1:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (75, 'Function', '内置函数', '算术函数', 'ATAN2(numeric1, numeric2)', '返回坐标的反正切（NUMERIC1，NUMERIC2）。', 'ATAN2(${1:}, ${2:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (76, 'Function', '内置函数', '算术函数', 'COSH(numeric)', '返回NUMERIC的双曲余弦值。

返回值类型为DOUBLE。', 'COSH(${1:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (77, 'Function', '内置函数', '算术函数', 'DEGREES(numeric)', '返回弧度NUMERIC的度数表示形式', 'DEGREES(${1:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (78, 'Function', '内置函数', '算术函数', 'RADIANS(numeric)', '返回度数NUMERIC的弧度表示。', 'RADIANS(${1:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (79, 'Function', '内置函数', '算术函数', 'SIGN(numeric)', '返回NUMERIC的符号。', 'SIGN(${1:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (80, 'Function', '内置函数', '算术函数', 'ROUND(numeric, integer)', '返回一个数字，四舍五入为NUMERIC的INT小数位。', 'ROUND(${1:} , ${2:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (81, 'Function', '内置函数', '算术函数', 'PI', '返回一个比任何其他值都更接近圆周率的值。', 'PI', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (82, 'Function', '内置函数', '算术函数', 'E()', '返回一个比任何其他值都更接近e的值。', 'E()', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (83, 'Function', '内置函数', '算术函数', 'RAND()', '返回介于0.0（含）和1.0（不含）之间的伪随机双精度值。', 'RAND()', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document`  (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (84, 'Function', '内置函数', '算术函数', 'RAND(integer)', '返回带有初始种子INTEGER的介于0.0（含）和1.0（不含）之间的伪随机双精度值。

如果两个RAND函数具有相同的初始种子，它们将返回相同的数字序列。', 'RAND(${1:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document`  (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (85, 'Function', '内置函数', '算术函数', 'RAND_INTEGER(integer)', '返回介于0（含）和INTEGER（不含）之间的伪随机整数值。', 'RAND_INTEGER(${1:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document`  (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (86, 'Function', '内置函数', '算术函数', 'RAND_INTEGER(integer1, integer2)', '返回介于0（含）和INTEGER2（不含）之间的伪随机整数值，其初始种子为INTEGER1。

如果两个randInteger函数具有相同的初始种子和边界，它们将返回相同的数字序列。', 'RAND_INTEGER(${1:} , ${2:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document`  (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (87, 'Function', '内置函数', '算术函数', 'UUID()', '根据RFC 4122 type 4（伪随机生成）UUID返回UUID（通用唯一标识符）字符串

（例如，“ 3d3c68f7-f608-473f-b60c-b0c44ad4cc4e”）。使用加密强度高的伪随机数生成器生成UUID。', 'UUID()', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document`  (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (88, 'Function', '内置函数', '算术函数', 'BIN(integer)', '以二进制格式返回INTEGER的字符串表示形式。如果INTEGER为NULL，则返回NULL。

例如，4.bin()返回“ 100”并12.bin()返回“ 1100”。', 'BIN(${1:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document`  (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (89, 'Function', '内置函数', '算术函数', 'HEX(numeric)
...
insert into `dinky_flink_document`  (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (90, 'Function', '内置函数', '算术函数', 'TRUNCATE(numeric1, integer2)', '返回一个小数点后被截断为integer2位的数字。', 'TRUNCATE(${1:}, ${2:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document`  (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (91, 'Function', '内置函数', '算术函数', 'PI()', '返回π (pi)的值。仅在blink planner中支持。', 'PI()', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document`  (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (92, 'Function', '内置函数', '算术函数', 'LOG(numeric1)', '如果不带参数调用，则返回NUMERIC1的自然对数。当使用参数调用时，将NUMERIC1的对数返回到基数NUMERIC2。

注意：当前，NUMERIC1必须大于0，而NUMERIC2必须大于1。', 'LOG(${1:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`)  values (93, 'Function', '内置函数', '算术函数', 'LOG(numeric1, numeric2)', '如果不带参数调用，则返回NUMERIC1的自然对数。当使用参数调用时，将NUMERIC1的对数返回到基数NUMERIC2。

注意：当前，NUMERIC1必须大于0，而NUMERIC2必须大于1。', 'LOG(${1:}, ${2:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`)  values (94, 'Function', '内置函数', '算术函数', 'CEIL(numeric)', '将NUMERIC向上舍入，并返回大于或等于NUMERIC的最小整数。', 'CEIL(${1:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document`  (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (95, 'Function', '内置函数', '算术函数', 'CEILING(numeric)', '将NUMERIC向上舍入，并返回大于或等于NUMERIC的最小整数。', 'CEILING(${1:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document`  (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (96, 'Function', '内置函数', '字符串函数', 'string1 || string2', '返回string1和string2的连接。', '${1:} || ${2:}', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document`  (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (97, 'Function', '内置函数', '字符串函数', 'UPPER(string)', '以大写形式返回STRING。', 'UPPER(${1:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document`  (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (98, 'Function', '内置函数', '字符串函数', 'LOWER(string)', '以小写形式返回STRING。', 'LOWER(${1:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document`  (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (99, 'Function', '内置函数', '字符串函数', 'POSITION(string1 IN string2)', '返回STRING1在STRING2中第一次出现的位置（从1开始）；

如果在STRING2中找不到STRING1，则返回0 。', 'POSITION(${1:} IN ${2:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document`  (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (100, 'Function', '内置函数', '字符串函数', 'TRIM([ BOTH | LEADING | TRAILING ] string1 FROM string2)', '返回一个字符串，该字符串从STRING中删除前导和/或结尾字符。', 'TRIM(${1:} FROM ${2:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document`  (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (101, 'Function', '内置函数', '字符串函数', 'LTRIM(string)', '返回一个字符串，该字符串从STRING除去左空格。

例如，" This is a test String.".ltrim()返回“This is a test String.”。', 'LTRIM(${1:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document`  (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (102, 'Function', '内置函数', '字符串函数', 'RTRIM(string)', '返回一个字符串，该字符串从STRING中删除正确的空格。

例如，"This is a test String. ".rtrim()返回“This is a test String.”。', 'RTRIM(${1:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document`  (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (103, 'Function', '内置函数', '字符串函数', 'REPEAT(string, integer)', '返回一个字符串，该字符串重复基本STRING INT次。
...
insert into `dinky_flink_document`  (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (104, 'Function', '内置函数', '字符串函数', 'REGEXP_REPLACE(string1, string2, string3)', '返回字符串STRING1所有匹配正则表达式的子串STRING2连续被替换STRING3。

例如，"foobar".regexpReplace("oo|ar", "")返回“ fb”。', 'REGEXP_REPLACE(${1:} , ${2:} , ${3:} )', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document`  (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (105, 'Function', '内置函数', '字符串函数', 'OVERLAY(string1 PLACING string2 FROM integer1 [ FOR integer2 ])', '从位置INT1返回一个字符串，该字符串将STRING1的INT2（默认为STRING2的长度）字符替换为STRING2', 'OVERLAY(${1:} PLACING ${2:} FROM ${3:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`)  values (106, 'Function', '内置函数', '字符串函数', 'SUBSTRING(string FROM integer1 [ FOR integer2 ])', '返回字符串STRING的子字符串，从位置INT1开始，长度为INT2（默认为结尾）。', 'SUBSTRING${1:} FROM ${2:} )', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`)  values (107, 'Function', '内置函数', '字符串函数', 'REPLACE(string1, string2, string3)', '返回一个新字符串替换其中出现的所有STRING2与STRING3（非重叠）从STRING1。', 'REPLACE(${1:} , ${2:} , ${3:} )', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`)  values (108, 'Function', '内置函数', '字符串函数', 'REGEXP_EXTRACT(string1, string2[, integer])', '从STRING1返回一个字符串，该字符串使用指定的正则表达式STRING2和正则表达式匹配组索引INTEGER1提取。', 'REGEXP_EXTRACT(${1:}, ${2:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document`  (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (109, 'Function', '内置函数', '字符串函数', 'INITCAP(string)', '返回一种新形式的STRING，其中每个单词的第一个字符转换为大写，其余字符转换为小写。', 'INITCAP(${1:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document`  (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (110, 'Function', '内置函数', '字符串函数', 'CONCAT(string1, string2,...)', '返回连接STRING1，STRING2，...的字符串。如果任何参数为NULL，则返回NULL。', 'CONCAT(${1:} , ${2:} , ${3:} )', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (111, 'Function', '内置函数', '字符串函数', 'CONCAT_WS(string1, string2, string3,...)', '返回一个字符串，会连接STRING2，STRING3，......与分离STRING1。', 'CONCAT_WS(${1:} , ${2:} , ${3:} )', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (112, 'Function', '内置函数', '字符串函数', 'LPAD(string1, integer, string2)', '返回一个新字符串，该字符串从STRING1的左侧填充STRING2，长度为INT个字符。', 'LPAD(${1:} , ${2:} , ${3:} )', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (113, 'Function', '内置函数', '字符串函数', 'RPAD(string1, integer, string2)', '返回一个新字符串，该字符串从STRING1右侧填充STRING2，长度为INT个字符。', 'RPAD(${1:} , ${2:} , ${3:} )', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (114, 'Function', '内置函数', '字符串函数', 'FROM_BASE64(string)', '返回来自STRING的base64解码结果；如果STRING为NULL，则返回null 。', 'FROM_BASE64(${1:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (115, 'Function', '内置函数', '字符串函数', 'TO_BASE64(string)', '从STRING返回base64编码的结果；如果STRING为NULL，则返回NULL。', 'TO_BASE64(${1:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (116, 'Function', '内置函数', '字符串函数', 'ASCII(string)', '返回字符串的第一个字符的数值。如果字符串为NULL，则返回NULL。仅在blink planner中支持。', 'ASCII(${1:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (117, 'Function', '内置函数', '字符串函数', 'CHR(integer)', '返回与integer在二进制上等价的ASCII字符。如果integer大于255，我们将首先得到integer的模数除以255，并返回模数的CHR。如果integer为NULL，则返回NULL。仅在blink planner中支持。', 'CHR(${1:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (118, 'Function', '内置函数', '字符串函数', 'DECODE(binary, string)', '使用提供的字符集(''US-ASCII''， ''ISO-8859-1''， ''UTF-8''， ''UTF-16BE''， ''UTF-16LE''， ''UTF-16''之一)将第一个参数解码为字符串。如果任意一个参数为空，结果也将为空。仅在blink planner中支持。', 'DECODE(${1:}, ${2:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (119, 'Function', '内置函数', '字符串函数', 'ENCODE(string1, string2)', '使用提供的string2字符集(''US-ASCII''， ''ISO-8859-1''， ''UTF-8''， ''UTF-16BE''， ''UTF-16LE''， ''UTF-16''之一)将string1编码为二进制。如果任意一个参数为空，结果也将为空。仅在blink planner中支持。', 'ENCODE(${1:}, ${2:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (120, 'Function', '内置函数', '字符串函数', 'INSTR(string1, string2)', '返回string2在string1中第一次出现的位置。如果任何参数为空，则返回NULL。仅在blink planner中支持。', 'INSTR(${1:}, ${2:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (121, 'Function', '内置函数', '字符串函数', 'LEFT(string, integer)', '返回字符串中最左边的整数字符。如果整数为负，则返回空字符串。如果任何参数为NULL，则返回NULL。仅在blink planner中支持。', 'LEFT(${1:}, ${2:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (122, 'Function', '内置函数', '字符串函数', 'RIGHT(string, integer)', '返回字符串中最右边的整数字符。如果整数为负，则返回空字符串。如果任何参数为NULL，则返回NULL。仅在blink planner中支持。', 'RIGHT(${1:}, ${2:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (123, 'Function', '内置函数', '字符串函数', 'LOCATE(string1, string2[, integer])', '返回string1在string2中的位置整数之后第一次出现的位置。如果没有找到，返回0。如果任何参数为NULL，则返回NULL仅在blink planner中支持。', 'LOCATE(${1:}, ${2:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (124, 'Function', '内置函数', '字符串函数', 'PARSE_URL(string1, string2[, string3])', '从URL返回指定的部分。string2的有效值包括''HOST''， ''PATH''， ''QUERY''， ''REF''， ''PROTOCOL''， ''AUTHORITY''， ''FILE''和''USERINFO''。如果任何参数为NULL，则返回NULL。仅在blink planner中支持。', 'PARSE_URL(${1:} , ${2:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (125, 'Function', '内置函数', '字符串函数', 'REGEXP(string1, string2)', '如果string1的任何子字符串(可能为空)与Java正则表达式string2匹配，则返回TRUE，否则返回FALSE。如果任何参数为NULL，则返回NULL。仅在blink planner中支持。', 'REGEXP(${1:}, ${2:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (126, 'Function', '内置函数', '字符串函数', 'REVERSE(string)', '返回反向字符串。如果字符串为NULL，则返回NULL仅在blink planner中支持。', 'REVERSE(${1:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (127, 'Function', '内置函数', '字符串函数', 'SPLIT_INDEX(string1, string2, integer1)', '通过分隔符string2拆分string1，返回拆分字符串的整数(从零开始)字符串。如果整数为负，返回NULL。如果任何参数为NULL，则返回NULL。仅在blink planner中支持。', 'SPLIT_INDEX(${1:}, ${2:} , ${3:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (128, 'Function', '内置函数', '字符串函数', 'STR_TO_MAP(string1[, string2, string3]])', '使用分隔符将string1分割成键/值对后返回一个映射。string2是pair分隔符，默认为''，''。string3是键值分隔符，默认为''=''。仅在blink planner中支持。', 'STR_TO_MAP(${1:})', '1.12', 4, 1, '2021-02-22 15:29:35', '2021-05-20 19:59:50');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (129, 'Function', '内置函数', '字符串函数', 'SUBSTR(string[, integer1[, integer2]])', '返回一个字符串的子字符串，从位置integer1开始，长度为integer2(默认到末尾)。仅在blink planner中支持。', 'SUBSTR(${1:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (130, 'Function', '内置函数', '字符串函数', 'CHAR_LENGTH(string)', '返回STRING中的字符数。', 'CHAR_LENGTH(${1:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (131, 'Function', '内置函数', '字符串函数', 'CHARACTER_LENGTH(string)', '返回STRING中的字符数。', 'CHARACTER_LENGTH(${1:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (132, 'Function', '内置函数', '时间函数', 'DATE string', '返回以“ yyyy-MM-dd”形式从STRING解析的SQL日期。', 'DATE(${1:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (133, 'Function', '内置函数', '时间函数', 'TIME string', '返回以“ HH：mm：ss”的形式从STRING解析的SQL时间。', 'TIME(${1:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (134, 'Function', '内置函数', '时间函数', 'TIMESTAMP string', '返回从STRING解析的SQL时间戳，格式为“ yyyy-MM-dd HH：mm：ss [.SSS]”', 'TIMESTAMP(${1:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (135, 'Function', '内置函数', '时间函数', 'INTERVAL string range', '解析“dd hh:mm:ss”形式的区间字符串。fff表示毫秒间隔，yyyy-mm表示月间隔。间隔范围可以是天、分钟、天到小时或天到秒，以毫秒为间隔;年或年到月的间隔。', 'INTERVAL ${1:} range', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (136, 'Function', '内置函数', '时间函数', 'CURRENT_DATE', '返回UTC时区中的当前SQL日期。', 'CURRENT_DATE', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (137, 'Function', '内置函数', '时间函数', 'CURRENT_TIME', '返回UTC时区的当前SQL时间。', 'CURRENT_TIME', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (138, 'Function', '内置函数', '时间函数', 'CURRENT_TIMESTAMP', '返回UTC时区内的当前SQL时间戳。', 'CURRENT_TIMESTAMP', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (139, 'Function', '内置函数', '时间函数', 'LOCALTIME', '返回本地时区的当前SQL时间。', 'LOCALTIME', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (140, 'Function', '内置函数', '时间函数', 'LOCALTIMESTAMP', '返回本地时区的当前SQL时间戳。', 'LOCALTIMESTAMP', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (141, 'Function', '内置函数', '时间函数', 'EXTRACT(timeintervalunit FROM temporal)', '返回从时域的timeintervalunit部分提取的长值。', 'EXTRACT(${1:} FROM ${2:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (142, 'Function', '内置函数', '时间函数', 'YEAR(date)', '返回SQL date日期的年份。等价于EXTRACT(YEAR FROM date)。', 'YEAR(${1:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (143, 'Function', '内置函数', '时间函数', 'QUARTER(date)', '从SQL date date返回一年中的季度(1到4之间的整数)。相当于EXTRACT(从日期起四分之一)。', 'QUARTER(${1:})', '1.12', 0, 1, '2021-02-22 15:29:35', '2021-02-22 15:28:47');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (144, 'Function', '内置函数', '时间函数', 'MONTH(date)', '返回SQL date date中的某月(1到12之间的整数)。等价于EXTRACT(MONTH FROM date)。', 'MONTH(${1:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (145, 'Function', '内置函数', '时间函数', 'WEEK(date)', '从SQL date date返回一年中的某个星期(1到53之间的整数)。相当于EXTRACT(从日期开始的星期)。', 'WEEK(${1:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (146, 'Function', '内置函数', '时间函数', 'DAYOFYEAR(date)', '返回SQL date date中的某一天(1到366之间的整数)。相当于EXTRACT(DOY FROM date)。', 'DAYOFYEAR(${1:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (147, 'Function', '内置函数', '时间函数', 'DAYOFMONTH(date)', '从SQL date date返回一个月的哪一天(1到31之间的整数)。相当于EXTRACT(DAY FROM date)。', 'DAYOFMONTH(${1:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (148, 'Function', '内置函数', '时间函数', 'DAYOFWEEK(date)', '返回星期几(1到7之间的整数;星期日= 1)从SQL日期日期。相当于提取(道指从日期)。', 'DAYOFWEEK(${1:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (149, 'Function', '内置函数', '时间函数', 'HOUR(timestamp)', '从SQL timestamp timestamp返回一天中的小时(0到23之间的整数)。相当于EXTRACT(HOUR FROM timestamp)。', 'HOUR(${1:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (150, 'Function', '内置函数', '时间函数', 'MINUTE(timestamp)', '从SQL timestamp timestamp返回一小时的分钟(0到59之间的整数)。相当于EXTRACT(分钟从时间戳)。', 'MINUTE(${1:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (151, 'Function', '内置函数', '时间函数', 'SECOND(timestamp)', '从SQL时间戳返回一分钟中的秒(0到59之间的整数)。等价于EXTRACT(从时间戳开始倒数第二)。', 'SECOND(${1:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (152, 'Function', '内置函数', '时间函数', 'FLOOR(timepoint TO timeintervalunit)', '返回一个将timepoint舍入到时间单位timeintervalunit的值。', 'FLOOR(${1:} TO ${2:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (153, 'Function', '内置函数', '时间函数', 'CEIL(timepoint TO timeintervalunit)', '返回一个将timepoint舍入到时间单位timeintervalunit的值。', 'CEIL(${1:} TO ${2:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (154, 'Function', '内置函数', '时间函数', '(timepoint1, temporal1) OVERLAPS (timepoint2, temporal2)', '如果(timepoint1, temporal1)和(timepoint2, temporal2)定义的两个时间间隔重叠，则返回TRUE。时间值可以是时间点或时间间隔。', '(${1:} , ${1:}) OVERLAPS (${2:} , ${2:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (155, 'Function', '内置函数', '时间函数', 'DATE_FORMAT(timestamp, string)', '注意这个功能有严重的错误，现在不应该使用。请实现一个自定义的UDF，或者使用EXTRACT作为解决方案。', 'DATE_FORMAT(${1:}, ''yyyy-MM-dd'')', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (156, 'Function', '内置函数', '时间函数', 'TIMESTAMPADD(timeintervalunit, interval, timepoint)', '返回一个新的时间值，该值将一个(带符号的)整数间隔添加到时间点。间隔的单位由unit参数给出，它应该是以下值之一:秒、分、小时、日、周、月、季度或年。', 'TIMESTAMPADD(${1:} , ${2:} , ${3:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (157, 'Function', '内置函数', '时间函数', 'TIMESTAMPDIFF(timepointunit, timepoint1, timepoint2)', '返回timepointunit在timepoint1和timepoint2之间的(带符号)数。间隔的单位由第一个参数给出，它应该是以下值之一:秒、分、小时、日、月或年。', 'TIMESTAMPDIFF(${1:} , ${2:} , ${3:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
...
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (160, 'Function', '内置函数', '时间函数', 'UNIX_TIMESTAMP()', '获取当前Unix时间戳(以秒为单位)。仅在blink planner中支持。', 'UNIX_TIMESTAMP()', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (161, 'Function', '内置函数', '时间函数', 'UNIX_TIMESTAMP(string1[, string2])', '转换日期时间字符串string1，格式为string2(缺省为yyyy-MM-dd HH:mm:ss，如果没有指定)为Unix时间戳(以秒为单位)，使用表配置中指定的时区。仅在blink planner中支持。', 'UNIX_TIMESTAMP(${1:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (162, 'Function', '内置函数', '时间函数', 'TO_DATE(string1[, string2])', '将格式为string2的日期字符串string1(默认为''yyyy-MM-dd'')转换为日期。仅在blink planner中支持。', 'TO_DATE(${1:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (163, 'Function', '内置函数', '时间函数', 'TO_TIMESTAMP(string1[, string2])', '将会话时区(由TableConfig指定)下的日期时间字符串string1转换为时间戳，格式为string2(默认为''yyyy-MM-dd HH:mm:ss'')。仅在blink planner中支持。', 'TO_TIMESTAMP(${1:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (164, 'Function', '内置函数', '时间函数', 'NOW()', '返回UTC时区内的当前SQL时间戳。仅在blink planner中支持。', 'NOW()', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (165, 'Function', '内置函数', '条件函数', 'CASE value
...
insert into `dinky_flink_document`  (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (166, 'Function', '内置函数', '条件函数', 'CASE
...
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (167, 'Function', '内置函数', '条件函数', 'NULLIF(value1, value2)', '如果value1等于value2，则返回NULL;否则返回value1。', 'NULLIF(${1:}, ${2:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (168, 'Function', '内置函数', '条件函数', 'COALESCE(value1, value2 [, value3 ]* )', '返回value1, value2， ....中的第一个非空值', 'COALESCE(${1:} )', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (169, 'Function', '内置函数', '条件函数', 'IF(condition, true_value, false_value)', '如果条件满足则返回true值，否则返回false值。仅在blink planner中支持。', 'IF((${1:}, ${2:}, ${3:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (170, 'Function', '内置函数', '条件函数', 'IS_ALPHA(string)', '如果字符串中所有字符都是字母则返回true，否则返回false。仅在blink planner中支持。', 'IS_ALPHA(${1:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (171, 'Function', '内置函数', '条件函数', 'IS_DECIMAL(string)', '如果字符串可以被解析为有效的数字则返回true，否则返回false。仅在blink planner中支持。', 'IS_DECIMAL(${1:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (172, 'Function', '内置函数', '条件函数', 'IS_DIGIT(string)', '如果字符串中所有字符都是数字则返回true，否则返回false。仅在blink planner中支持。', 'IS_DIGIT(${1:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (173, 'Function', '内置函数', '类型转换函数功能', 'CAST(value AS type)', '返回一个要转换为type类型的新值。', 'CAST(${1:} AS ${2:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (174, 'Function', '内置函数', 'Collection 函数', 'CARDINALITY(array)', '返回数组中元素的数量。', 'CARDINALITY(${1:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (175, 'Function', '内置函数', 'Collection 函数', 'array ‘[’ integer ‘]’', '返回数组中位于整数位置的元素。索引从1开始。', 'array[${1:}]', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (176, 'Function', '内置函数', 'Collection 函数', 'ELEMENT(array)', '返回数组的唯一元素(其基数应为1);如果数组为空，则返回NULL。如果数组有多个元素，则抛出异常。', 'ELEMENT(${1:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (177, 'Function', '内置函数', 'Collection 函数', 'CARDINALITY(map)', '返回map中的条目数。', 'CARDINALITY(${1:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (178, 'Function', '内置函数', 'Collection 函数', 'map ‘[’ value ‘]’', '返回map中key value指定的值。', 'map[${1:}]', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (179, 'Function', '内置函数', 'Value Construction函数', 'ARRAY ‘[’ value1 [, value2 ]* ‘]’', '返回一个由一系列值(value1, value2，…)创建的数组。', 'ARRAY[ ${1:} ]', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (180, 'Function', '内置函数', 'Value Construction函数', 'MAP ‘[’ value1, value2 [, value3, value4 ]* ‘]’', '返回一个从键值对列表((value1, value2)， (value3, value4)，…)创建的映射。', 'MAP[ ${1:} ]', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (181, 'Function', '内置函数', 'Value Construction函数', 'implicit constructor with parenthesis
(value1 [, value2]*)', '返回从值列表(value1, value2，…)创建的行。', '(${1:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (182, 'Function', '内置函数', 'Value Construction函数', 'explicit ROW constructor
ROW(value1 [, value2]*)', '返回从值列表(value1, value2，…)创建的行。', 'ROW(${1:}) ', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (183, 'Function', '内置函数', 'Value Access函数', 'tableName.compositeType.field', '按名称从Flink复合类型(例如，Tuple, POJO)中返回一个字段的值。', 'tableName.compositeType.field', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (184, 'Function', '内置函数', 'Value Access函数', 'tableName.compositeType.*', '返回Flink复合类型(例如，Tuple, POJO)的平面表示，它将每个直接子类型转换为一个单独的字段。在大多数情况下，平面表示的字段的名称与原始字段类似，但使用了$分隔符(例如，mypojo$mytuple$f0)。', 'tableName.compositeType.*', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (185, 'Function', '内置函数', '分组函数', 'GROUP_ID()', '返回唯一标识分组键组合的整数', 'GROUP_ID()', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (186, 'Function', '内置函数', '分组函数', 'GROUPING(expression1 [, expression2]* )
GROUPING_ID(expression1 [, expression2]* )', '返回给定分组表达式的位向量。', 'GROUPING(${1:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (187, 'Function', '内置函数', 'hash函数', 'MD5(string)', '以32位十六进制数字的字符串形式返回string的MD5哈希值;如果字符串为NULL，则返回NULL。', 'MD5(${1:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (188, 'Function', '内置函数', 'hash函数', 'SHA1(string)', '返回字符串的SHA-1散列，作为一个由40个十六进制数字组成的字符串;如果字符串为NULL，则返回NULL', 'SHA1(${1:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (189, 'Function', '内置函数', 'hash函数', 'SHA224(string)', '以56位十六进制数字的字符串形式返回字符串的SHA-224散列;如果字符串为NULL，则返回NULL。', 'SHA224(${1:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (190, 'Function', '内置函数', 'hash函数', 'SHA256(string)', '以64位十六进制数字的字符串形式返回字符串的SHA-256散列;如果字符串为NULL，则返回NULL。', 'SHA256(${1:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (191, 'Function', '内置函数', 'hash函数', 'SHA384(string)', '以96个十六进制数字的字符串形式返回string的SHA-384散列;如果字符串为NULL，则返回NULL。', 'SHA384(${1:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (192, 'Function', '内置函数', 'hash函数', 'SHA512(string)', '以128位十六进制数字的字符串形式返回字符串的SHA-512散列;如果字符串为NULL，则返回NULL。', 'SHA512(${1:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (193, 'Function', '内置函数', 'hash函数', 'SHA2(string, hashLength)', '使用SHA-2哈希函数族(SHA-224、SHA-256、SHA-384或SHA-512)返回哈希值。第一个参数string是要散列的字符串，第二个参数hashLength是结果的位长度(224、256、384或512)。如果string或hashLength为NULL，则返回NULL。', 'SHA2(${1:}, ${2:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (194, 'Function', '内置函数', '聚合函数', 'COUNT([ ALL ] expression | DISTINCT expression1 [, expression2]*)', '默认情况下或使用ALL时，返回表达式不为空的输入行数。对每个值的唯一实例使用DISTINCT。', 'COUNT( DISTINCT ${1:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document`  (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (195, 'Function', '内置函数', '聚合函数', 'COUNT(*)
COUNT(1)', '返回输入行数。', 'COUNT(${1:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (196, 'Function', '内置函数', '聚合函数', 'AVG([ ALL | DISTINCT ] expression)', '默认情况下，或使用关键字ALL，返回表达式在所有输入行中的平均值(算术平均值)。对每个值的唯一实例使用DISTINCT。', 'AVG(${1:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (197, 'Function', '内置函数', '聚合函数', 'SUM([ ALL | DISTINCT ] expression)', '默认情况下，或使用关键字ALL，返回所有输入行表达式的和。对每个值的唯一实例使用DISTINCT。', 'SUM(${1:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (198, 'Function', '内置函数', '聚合函数', 'MAX([ ALL | DISTINCT ] expression)', '默认情况下或使用关键字ALL，返回表达式在所有输入行中的最大值。对每个值的唯一实例使用DISTINCT。', 'MAX(${1:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (199, 'Function', '内置函数', '聚合函数', 'MIN([ ALL | DISTINCT ] expression)', '默认情况下，或使用关键字ALL，返回表达式在所有输入行中的最小值。对每个值的唯一实例使用DISTINCT。', 'MIN(${1:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (200, 'Function', '内置函数', '聚合函数', 'STDDEV_POP([ ALL | DISTINCT ] expression)', '默认情况下，或使用关键字ALL，返回表达式在所有输入行中的总体标准差。对每个值的唯一实例使用DISTINCT。', 'STDDEV_POP(${1:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (201, 'Function', '内置函数', '聚合函数', 'STDDEV_SAMP([ ALL | DISTINCT ] expression)', '默认情况下或使用关键字ALL时，返回表达式在所有输入行中的样本标准差。对每个值的唯一实例使用DISTINCT。', 'STDDEV_SAMP(${1:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (202, 'Function', '内置函数', '聚合函数', 'VAR_POP([ ALL | DISTINCT ] expression)', '默认情况下，或使用关键字ALL，返回表达式在所有输入行中的总体方差(总体标准差的平方)。对每个值的唯一实例使用DISTINCT。', 'VAR_POP(${1:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (203, 'Function', '内置函数', '聚合函数', 'VAR_SAMP([ ALL | DISTINCT ] expression)', '默认情况下，或使用关键字ALL，返回表达式在所有输入行中的样本方差(样本标准差的平方)。对每个值的唯一实例使用DISTINCT。', 'VAR_SAMP(${1:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (204, 'Function', '内置函数', '聚合函数', 'COLLECT([ ALL | DISTINCT ] expression)', '默认情况下，或使用关键字ALL，跨所有输入行返回表达式的多集。空值将被忽略。对每个值的唯一实例使用DISTINCT。', 'COLLECT(${1:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (205, 'Function', '内置函数', '聚合函数', 'VARIANCE([ ALL | DISTINCT ] expression)', 'VAR_SAMP的同义词。仅在blink planner中支持。', 'VARIANCE(${1:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (206, 'Function', '内置函数', '聚合函数', 'RANK()', '返回值在一组值中的秩。结果是1加上分区顺序中位于当前行之前或等于当前行的行数。这些值将在序列中产生空白。仅在blink planner中支持。', 'RANK()', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (207, 'Function', '内置函数', '聚合函数', 'DENSE_RANK()', '返回值在一组值中的秩。结果是1加上前面分配的秩值。与函数rank不同，dense_rank不会在排序序列中产生空隙。仅在blink planner中支持。', 'DENSE_RANK()', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (208, 'Function', '内置函数', '聚合函数', 'ROW_NUMBER()', '根据窗口分区中的行顺序，为每一行分配一个惟一的连续数字，从1开始。仅在blink planner中支持。', 'ROW_NUMBER()', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (209, 'Function', '内置函数', '聚合函数', 'LEAD(expression [, offset] [, default] )', '返回表达式在窗口中当前行之前的偏移行上的值。offset的默认值是1,default的默认值是NULL。仅在blink planner中支持。', 'LEAD(${1:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (210, 'Function', '内置函数', '聚合函数', 'LAG(expression [, offset] [, default])', '返回表达式的值，该值位于窗口中当前行之后的偏移行。offset的默认值是1,default的默认值是NULL。仅在blink planner中支持。', 'LAG(${1:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (211, 'Function', '内置函数', '聚合函数', 'FIRST_VALUE(expression)', '返回一组有序值中的第一个值。仅在blink planner中支持。', 'FIRST_VALUE(${1:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (212, 'Function', '内置函数', '聚合函数', 'LAST_VALUE(expression)', '返回一组有序值中的最后一个值。仅在blink planner中支持。', 'LAST_VALUE(${1:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (213, 'Function', '内置函数', '聚合函数', 'LISTAGG(expression [, separator])', '连接字符串表达式的值，并在它们之间放置分隔符值。分隔符没有添加在字符串的末尾。分隔符的默认值是''，''。仅在blink planner中支持。', 'LISTAGG(${1:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (214, 'Function', '内置函数', '列函数', 'withColumns(…)', '选择的列', 'withColumns(${1:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (215, 'Function', '内置函数', '列函数', 'withoutColumns(…)', '不选择的列', 'withoutColumns(${1:})', '1.12', 0, 1, '2021-02-22 15:46:48', '2021-02-22 15:47:21');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (216, 'Function', '内置函数', '比较函数', 'value1 = value2', '如果value1等于value2 返回true; 如果value1或value2为NULL，则返回UNKNOWN 。', '${1:} =${2:}', '1.12', 9, 1, '2021-02-22 10:06:49', '2021-02-24 09:40:30');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (217, 'Function', 'UDF', '表值聚合函数', 'TO_MAP(string1,object2[, string3])', '将非规则一维表转化为规则二维表，string1是key。string2是value。string3为非必填项，表示key的值域（维度），用英文逗号分割。', 'TO_MAP(${1:})', '1.12', 8, 1, '2021-05-20 19:59:22', '2021-05-20 20:00:54');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (218, 'Reference', '建表语句', 'Streaming', 'EXECUTE CDCSOURCE print', 'Whole library synchronization print', 'EXECUTE CDCSOURCE demo_print WITH (
  ''connector'' = ''mysql-cdc'',
  ''hostname'' = ''127.0.0.1'',
  ''port'' = ''3306'',
  ''username'' = ''root'',
...
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (219, 'Reference', '建表语句', 'Streaming', 'EXECUTE CDCSOURCE doris', 'Whole library synchronization doris', 'EXECUTE CDCSOURCE demo_print WITH (
  ''connector'' = ''mysql-cdc'',
  ''hostname'' = ''127.0.0.1'',
  ''port'' = ''3306'',
  ''username'' = ''root'',
...
insert into `dinky_flink_document`(`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`)  values (221, 'Reference', '建表语句', 'Batch/Streaming', 'EXECUTE CDCSOURCE StarRocks ', 'The entire library is synchronized to StarRocks
...
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (222, 'Reference', '建表语句', 'Batch/Streaming', 'EXECUTE CDCSOURCE cdc_mysql', 'The entire library is synchronized to mysql', 'EXECUTE CDCSOURCE demo_startrocks WITH (
  ''connector'' = ''mysql-cdc'',
  ''hostname'' = ''127.0.0.1'',
  ''port'' = ''3306'',
  ''username'' = ''root'',
...
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (223, 'Reference', '建表语句', 'Streaming', 'EXECUTE CDCSOURCE demo_doris', 'The entire library is synchronized to mysql', 'EXECUTE CDCSOURCE cdc_mysql WITH (
 ''connector'' = ''mysql-cdc'',
 ''hostname'' = ''127.0.0.1'',
 ''port'' = ''3306'',
 ''username'' = ''root'',
...
insert into `dinky_flink_document`(`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`)  values (224, 'Reference', '建表语句', 'Batch/Streaming', 'EXECUTE CDCSOURCE cdc_oracle', 'The entire library is synchronized to cdc_oracle', 'EXECUTE CDCSOURCE cdc_oracle WITH (
...
insert into `dinky_flink_document`(`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`)  values (225, 'Reference', '建表语句', 'Batch/Streaming', 'EXECUTE CDCSOURCE cdc_kafka_one', 'The entire library is synchronized to a topic in kafka', 'EXECUTE CDCSOURCE cdc_kafka_one WITH (
 ''connector'' = ''mysql-cdc'',
 ''hostname'' = ''127.0.0.1'',
 ''port'' = ''3306'',
 ''username'' = ''root'',
...
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (227, 'Reference', '建表语句', 'Batch/Streaming', 'EXECUTE CDCSOURCE cdc_upsert_kafka', 'The entire library is synchronized to kafka primary key mode', 'EXECUTE CDCSOURCE cdc_upsert_kafka WITH (
 ''connector'' = ''mysql-cdc'',
 ''hostname'' = ''127.0.0.1'',
 ''port'' = ''3306'',
 ''username'' = ''root'',
...
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (228, 'Reference', '建表语句', 'Batch/Streaming', 'EXECUTE CDCSOURCE cdc_postgresql ', 'The entire library is synchronized to postgresql', 'EXECUTE CDCSOURCE cdc_postgresql WITH (
 ''connector'' = ''mysql-cdc'',
 ''hostname'' = ''127.0.0.1'',
 ''port'' = ''3306'',
 ''username'' = ''root'',
...
insert into `dinky_flink_document`(`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`)  values (229, 'Reference', '建表语句', 'Batch/Streaming', 'EXECUTE CDCSOURCE cdc_clickhouse', 'Sync the entire library to clickhouse', 'EXECUTE CDCSOURCE cdc_clickhouse WITH (
 ''connector'' = ''mysql-cdc'',
 ''hostname'' = ''127.0.0.1'',
 ''port'' = ''3306'',
 ''username'' = ''root'',
...
insert into `dinky_flink_document`(`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`)  values (230, 'Reference', '建表语句', 'Batch/Streaming', 'EXECUTE CDCSOURCE mysql2hive', 'The entire library is synchronized to the sql-catalog of hive', 'EXECUTE CDCSOURCE mysql2hive WITH (
  ''connector'' = ''mysql-cdc'',
  ''hostname'' = ''127.0.0.1'',
  ''port'' = ''3306'',
  ''username'' = ''root'',
...
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (231, 'Reference', '建表语句', 'Batch/Streaming', 'EXECUTE CDCSOURCE  mysql2paimon', 'The entire library is synchronized to paimon', 'EXECUTE CDCSOURCE mysql2paimon WITH (
  ''connector'' = ''mysql-cdc'',
  ''hostname'' = ''127.0.0.1'',
  ''port'' = ''3306'',
  ''username'' = ''root'',
...
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (234, 'Reference', '建表语句', 'Batch/Streaming', 'ADD JAR', 'ADD JAR', 'ADD JAR ${1:}; -- str path ', 'All Versions', 0, 1, '2023-10-31 16:19:52', '2023-10-31 16:23:16');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (235, 'Function', 'Other', 'Batch/Streaming', 'SHOW FRAGMENTS', 'SHOW FRAGMENTS', 'SHOW FRAGMENTS;', 'All Versions', 0, 1, '2023-10-31 16:20:30', '2023-10-31 16:20:30');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (236, 'Function', 'Other', 'Batch/Streaming', 'SHOW FRAGMENT var1', 'SHOW FRAGMENT var1', 'SHOW FRAGMENT ${1:};', 'All Versions', 0, 1, '2023-10-31 16:21:23', '2023-10-31 16:21:23');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (237, 'Reference', '建表语句', 'Batch/Streaming', 'EXECUTE CDCSOURCE demo_hudi', 'The entire library is synchronized to hudi', 'EXECUTE CDCSOURCE demo_hudi WITH (
 ''connector'' = ''mysql-cdc'',
 ''hostname'' = ''127.0.0.1'',
 ''port'' = ''3306'',
 ''username'' = ''root'',
...
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (238, 'Reference', 'Other', 'Batch/Streaming', 'EXECUTE JAR ', 'EXECUTE JAR use sql', 'EXECUTE JAR WITH (
...
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (239, 'Reference', '内置函数', 'Streaming', 'PRINT tablename', 'PRINT table data', 'PRINT ${1:}', 'All Versions', 0, 1, '2023-10-31 16:30:22', '2023-10-31 16:30:22');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (240, 'Reference', '建表语句', 'Batch/Streaming', 'CREATE TABLE Like', 'CREATE TABLE Like source table', 'DROP TABLE IF EXISTS sink_table;
CREATE TABLE IF not EXISTS sink_table
WITH (
    ''topic'' = ''motor_vehicle_error''
)
LIKE source_table;', 'All Versions', 0, 1, '2023-10-31 16:33:38', '2023-10-31 16:33:38');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (241, 'Reference', '建表语句', 'Batch/Streaming', 'CREATE TABLE like source_table EXCLUDING', 'CREATE TABLE like source_table EXCLUDING', 'DROP TABLE IF EXISTS sink_table;
CREATE TABLE IF not EXISTS sink_table(
...
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (242, 'Reference', '建表语句', 'Batch/Streaming', 'CREATE TABLE ctas_kafka', 'CREATE TABLE ctas_kafka', 'CREATE TABLE my_ctas_table
WITH (
    ''connector'' = ''kafka''
)
AS SELECT id, name, age FROM source_table WHERE mod(id, 10) = 0;', 'All Versions', 0, 1, '2023-10-31 16:37:33', '2023-10-31 16:47:17');
insert into `dinky_flink_document` (`id`, `category`, `type`, `subtype`, `name`, `description`, `fill_value`, `version`, `like_num`, `enabled`, `create_time`, `update_time`) values (243, 'Reference', '建表语句', 'Batch/Streaming', 'CREATE TABLE rtas_kafka', 'CREATE TABLE rtas_kafka', 'CREATE OR REPLACE TABLE my_ctas_table
WITH (
    ''connector'' = ''kafka''
)
