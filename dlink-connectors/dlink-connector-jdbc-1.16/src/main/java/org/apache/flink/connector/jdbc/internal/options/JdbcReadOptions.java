...
public class JdbcReadOptions implements Serializable {
    ...
    public Optional<String> getDataFilter() {
    ...
    public boolean equals(Object o) {
        if (o instanceof JdbcReadOptions) {
            ...
            return Objects.equals(query, options.query)
                    && Objects.equals(dataFilter, options.dataFilter)
    ...
    public static class Builder {
        ...
        /** optional, the SQL filter query statement of this table for this JDBC source. */
        public Builder setDataFilter(String dataFilter) {
            this.dataFilter = dataFilter;
            return this;
        }
